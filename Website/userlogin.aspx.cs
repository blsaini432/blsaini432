...
public partial class userlogin : System.Web.UI.Page
{
    ...
    protected void btn_sendforgetpin_Click(object sender, EventArgs e)
    {
        ...
        if (dt.Rows.Count > 0)
        {
            ...
            string sms = "Dear Member, Welcome to our Company, Your password reset link is: " + bb + " thanks,";
            HttpContext.Current.Response.Cache.SetCacheability(HttpCacheability.NoCache);
            WebClient client = new WebClient();
            string baseurl = "http://api.msg91.com/api/sendhttp.php?authkey=361199AfyLWFFRdx60a9f533P1&route=4&sender=Aepspy&DLT_TE_ID=1207162255215266229&mobiles=" + mobile + "&message=" + sms + "";
    ...
    protected void btn_forgot_Click(object sender, EventArgs e)
    {
        ...
        if (dt.Rows.Count > 0)
        {
            ...
            string bb = ShrinkURL(aa);
            string sms = "Dear Member, Welcome to our Company, Your password reset link is: " + bb + " Thanks PayMaster Digital Services";
            HttpContext.Current.Response.Cache.SetCacheability(HttpCacheability.NoCache);
            WebClient client = new WebClient();
            string baseurl = "http://api.msg91.com/api/sendhttp.php?authkey=349678AzMGs1chj5fdc6473P1&route=4&sender=PYMSTR&DLT_TE_ID=1207162245863756540&mobiles=" + mobile + "&message=" + sms + "";
            Stream data = client.OpenRead(baseurl);
            StreamReader reader = new StreamReader(data);
            string s = reader.ReadToEnd();
            data.Close();
