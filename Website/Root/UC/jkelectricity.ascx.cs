...
public partial class Root_UC_jk : System.Web.UI.UserControl
{
    #region [Properties]
    ...
    private void fillEmployee()
    {
        ...
        List<ParmList> _list = new List<ParmList>();
         ...
         _list.Add(new ParmList() { name = "@Action", value = "R" });
        ...
        if (dtEmployee.Rows.Count > 0)
        {
            ...
            gvBookedBus.DataSource = dtEmployee;
            gvBookedBus.DataBind();
            if (dtEmployee.Rows.Count > 0)
            {
                litrecordcount.Text = gvBookedBus.Rows.Count.ToString();
