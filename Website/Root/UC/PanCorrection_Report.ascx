<%@ Control Language="C#" AutoEventWireup="true" CodeFile="PanCorrection_Report.ascx.cs" Inherits="Root_UC_PanCorrection_Report" %>
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="cc1" %>

<div class="content-wrapper">
    <div class="page-header">
        <h3 class="page-title">Pan Correction Form Report
        </h3>
    </div>
                                                ...
                                                <div class="box-content">
                                                    <asp:GridView ID="gvBookedBusList" runat="server" CssClass="table table-striped table-bordered bootstrap-datatable datatable responsive SmallText"
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:BoundField HeaderText="PanNo" DataField="PanNo" SortExpression="PanNo" />
                                                            ...
                                                            <asp:TemplateField HeaderStyle-Width="30px" HeaderText="Admin Remarks">
                                                             ...
                                                             <asp:BoundField HeaderText="Ack" DataField="RefNo" SortExpression="RefNo" />
                                                            <asp:TemplateField HeaderText="Receipt">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lbl" Visible='<%# Convert.ToBoolean(Eval("recenable")) %>' runat="server">
