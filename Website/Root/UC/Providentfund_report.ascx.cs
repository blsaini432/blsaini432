...
public partial class Root_UC_Providentfund_report : System.Web.UI.UserControl
{
    #region [Properties]
    ...
    private void fillEmployee()
    {
        ...
        List<ParmList> _list = new List<ParmList>();
          ...
          _list.Add(new ParmList() { name = "@Action", value = "MRP" });
        _list.Add(new ParmList() { name = "@RequestBymsrno", value = MsrNo });
        dtEmployee = cls.select_data_dtNew("Proc_voteridcard_Correction", _list);
