<%@ Control Language="C#" AutoEventWireup="true" CodeFile="NPansionyojanareport.ascx.cs" Inherits="Root_UC_NPansionyojanareport" %>
...
<div class="content-wrapper">
    <div class="page-header">
        <h3 class="page-title">Pansion Yojana Report
        </h3>
    </div>
                                                ...
                                                <div class="box-content">
                                                    <asp:GridView ID="gvBookedBusList" runat="server" CssClass="table table-striped table-bordered bootstrap-datatable datatable responsive SmallText"
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:BoundField HeaderText="Name" DataField="NameOnPAN" SortExpression="NameOnPAN" />
                                                             <asp:BoundField HeaderText="Mobile." DataField="mobile" SortExpression="Acknowledgement_No" />
                                                            <asp:BoundField HeaderText="Aadhar no." DataField="aadharno" SortExpression="Acknowledgement_No" />
                                                                 <asp:BoundField HeaderText="Bank details" DataField="bankdetails" SortExpression="Acknowledgement_No" />
                                                             <asp:BoundField HeaderText="Txn_No." DataField="Acknowledgement_No" SortExpression="Acknowledgement_No" />
                                                            <asp:TemplateField HeaderText="Date" SortExpression="AddDate">
                                                                <ItemTemplate>
                                                                    <%#String.Format("{0:dd-MMM-yyyy}", Convert.ToDateTime(Eval("AddDate")))%>
