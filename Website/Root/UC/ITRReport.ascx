<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ITRReport.ascx.cs" Inherits="Root_UC_ITRReport" %>
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="cc1" %>

<div class="content-wrapper">
    <div class="page-header">
        <h3 class="page-title">ITR Report
        </h3>
    </div>
                                                ...
                                                <div class="box-content">
                                                    <asp:GridView ID="gvBookedBusList" runat="server" CssClass="table table-striped table-bordered bootstrap-datatable datatable responsive SmallText"
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <a href="../../Uploads/Servicesimage/Actual/<%# Eval("ReciptImg2") %>" target="_blank">
                                                                Download                                                                
