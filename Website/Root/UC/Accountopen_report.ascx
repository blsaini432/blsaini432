<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Accountopen_report.ascx.cs" Inherits="Root_UC_Accountopen_report" %>
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="cc1" %>
<div class="content-wrapper">
    <div class="page-header">
        <h3 class="page-title">Account Open Report
        </h3>
    </div>
                                                        ...
                                                        <Columns>
                                                           ...
                                                           <asp:BoundField HeaderText="Pan" DataField="pan" SortExpression="Remarks" />
                                                             <asp:BoundField HeaderText="Aadhar" DataField="aadhar" SortExpression="Remarks" />
                                                               <asp:BoundField HeaderText="Admin Remark" DataField="Remarks" SortExpression="Remarks" />
