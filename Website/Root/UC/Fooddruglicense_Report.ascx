<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Fooddruglicense_Report.ascx.cs" Inherits="Root_UC_Fooddruglicense_Report" %>
                    ...
                    <div class="box-content">
                        <asp:GridView ID="gvBookedBusList" runat="server" CssClass="table table-striped table-bordered bootstrap-datatable datatable responsive SmallText"
                            ...
                            <Columns>
                                ...
                                <%-- <asp:BoundField HeaderText="type" DataField="foodlictype" SortExpression="foodlictype" />--%>
                               <asp:BoundField HeaderText="Name" DataField="Name_of_company" SortExpression="applicantname" />
