<%@ Control Language="C#" AutoEventWireup="true" CodeFile="PanForm_old.ascx.cs" Inherits="Root_UC_PanForm" %>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-8">
                                    <asp:TextBox ID="txt_pincode" runat="server" MaxLength="6"
                          ...
                          <div class="form-group row">
                                ...
                                <div class="col-lg-3">
                                    <strong><span>*</span>Download Pan Form </strong>
                                </div>
                                <div class="col-lg-8">
                                    <a href="../../Uploads/Servicesimage/Actual/49A%20Form%20For%20New%20Application.pdf" target="_blank" class="btn btn-primary">Click here</a>
                                  
                                </div>
                            </div>
                         <%-- <div class="form-group row">
                                <div class="col-lg-3">
                                    <label class="col-form-label">AO CODE<code>*</code></label>
                                </div>
                                <div class="col-lg-8">
                                    <asp:TextBox ID="TXT_AOCODE" runat="server" MaxLength="100"
                                        CssClass="form-control"></asp:TextBox>
                                </div>
                            </div>--%>
