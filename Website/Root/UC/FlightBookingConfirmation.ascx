<%@ Control Language="C#" AutoEventWireup="true" CodeFile="FlightBookingConfirmation.ascx.cs" Inherits="Root_UC_FlightBookingConfirmation" %>
...
<div class="content-wrapper">
    ...
    <div class="content-header sty-one">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="../FlightReviewBooking.aspx"><i class="fa fa-angle-right"></i>Review Booking</a></li>
            <li><a href="#" style="color: green"><i class="fa fa-angle-right"></i>Booking Confirmation</a></li>
        </ol>
    </div>
    <div class="content">
            ...
            <div class="col-lg-8">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <asp:LinkButton ID="Lnk_InFlight" runat="server" Text="Click to process (in booking) If Appiled For Return" OnClick="Lnk_InFlight_Click" Style="padding-left: 15px"></asp:LinkButton>
                        </div>
                        <div class="form-horizontal" style="border: 1px solid rgba(0,0,0,.125); padding: 5px;">
                            <div class="form-horizontal" style="border: 1px solid rgba(0,0,0,.125); padding: 5px;">
                                ...
                                <div class="form-group row">
                                    <asp:Label ID="lbl_PNR" runat="server" class="col-sm-2 control-label" Text=""></asp:Label>
                                    <asp:Label ID="lbl_Bookingid" runat="server" class="col-sm-2 control-label" Text=""></asp:Label>
                                </div>
                            </div>
                        </div>
                        <div class="form-horizontal" style="border: 1px solid rgba(0,0,0,.125); padding: 5px;">
                        ...
                        <div class="form-group" style="padding: 5px;">
                            <div class="row">
                               <%-- <div class="col-md-4">
                                    <asp:Button ID="btn_downloadInvoice" runat="server" Text="Download Invoice" class="btn btn-success" UseSubmitBehavior="true" OnClick="btn_downloadInvoice_Click" />
                                </div>--%>
                                  <div class="col-md-4" style="visibility: hidden;">
                                    <asp:Button ID="btn_cancelTicket" runat="server" Text="Cancel Ticket" class="btn btn-success" UseSubmitBehavior="true" OnClick="btn_cancelTicket_Click" />
                                </div>
                            </div>
                        </div>
                    </div>
