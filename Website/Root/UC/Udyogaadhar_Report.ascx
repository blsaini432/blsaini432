<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Udyogaadhar_Report.ascx.cs" Inherits="Root_UC_Udyogaadhar_Report" %>
                        ...
                        <asp:GridView ID="gvBookedBusList" runat="server" CssClass="table table-striped table-bordered bootstrap-datatable datatable responsive SmallText"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField HeaderText="Request By" DataField="MemberName" SortExpression="MemberName" />
                                 ...
                                 <asp:BoundField HeaderText="Full name" DataField="Full_name" SortExpression="Full_name" />
                                  <asp:BoundField HeaderText="Aadhar no " DataField="Aadhar_no" SortExpression="Aadhar_no" />
