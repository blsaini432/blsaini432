<%@ Control Language="C#" AutoEventWireup="true" CodeFile="jkelectricity.ascx.cs" Inherits="Root_UC_jk" %>
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="cc1" %>


<div class="content-wrapper">
    <div class="page-header">
        <h3 class="page-title">J&K/Electricity bill Report
        </h3>
    </div>
                                                ...
                                                <div class="box-content">
                                                    <asp:GridView ID="gvBookedBus" runat="server" CssClass="table table-striped table-bordered bootstrap-datatable datatable responsive SmallText"
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:BoundField HeaderText="Consumer." DataField="Consumer" SortExpression="Acknowledgement_No" />
                                                            ...
                                                            <asp:BoundField HeaderText="Status" DataField="RequestStatus" SortExpression="RequestStatus" />
                                                             <asp:BoundField HeaderText="remarks" DataField="remarks" SortExpression="RequestStatus" />
                                                             <asp:BoundField HeaderText="txnno" DataField="txnno" SortExpression="RequestStatus" />
