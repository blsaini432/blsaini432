<%@ Control Language="C#" AutoEventWireup="true" CodeFile="FirmmsmeRegistration.ascx.cs" Inherits="Root_UC_FirmmsmeRegistration" %>
...
<div class="content-wrapper">
    <div class="page-header">
        <h3 class="page-title">Firm/Msme Registration Registration  Form
        </h3>
    </div>
    <div class="col-12">
        <div class="row">
