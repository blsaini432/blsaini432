<%@ Control Language="C#" AutoEventWireup="true" CodeFile="PanForm.ascx.cs" Inherits="Root_UC_PanForm" %>
                    ...
                    <div class="card">
                        <div class="card-body">
                          ...
                          <div class="form-group row">
                                ...
                                <div class="col-lg-8">
                                    <a href="../../Uploads/Servicesimage/Actual/NewApplication.pdf" target="_blank" class="btn btn-primary">Click here</a>
