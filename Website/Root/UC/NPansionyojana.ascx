<%@ Control Language="C#" AutoEventWireup="true" CodeFile="NPansionyojana.ascx.cs" Inherits="Root_UC_NPansionyojana" %>
...
<div class="content-wrapper">
    <div class="page-header">
        <h3 class="page-title">Namdhan Pansion Yojana Form
        </h3>
    </div>
                    ...
                    <div class="card-body">
                        <asp:Label ID="lbl_Status" runat="server" Visible="false" Style="color: Red"></asp:Label>
                         <div class="form-group row">
                            <div class="col-lg-3">
                                 <label class="col-form-label" style ="color:green">Amount For NPansionyojna (In Rs):-</label>
