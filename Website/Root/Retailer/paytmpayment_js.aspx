...
<head>
  ...
  function onScriptLoad(){
    ...
    <script type="application/javascript" src="https://securegw.paytm.in/merchantpgpui/checkoutjs/merchants/Fritwa43748969852592.js" onload="onScriptLoad()" crossorigin="anonymous"></script>
</head>
<body>
<%--<script type="application/javascript" src="{HOST}/merchantpgpui/checkoutjs/merchants/{MID}.js" onload="onScriptLoad();" crossorigin="anonymous"></script>--%>
    ...
    <br />
    <br />
     <a href="Dashboard.aspx"  style="margin:600px;font-size:30px">&laquo; Back to Dashboard</a>
   </body></html>