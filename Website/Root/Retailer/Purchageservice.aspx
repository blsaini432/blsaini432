<%@ Page Title="" Language="C#" MasterPageFile="~/Root/Retailer/MemberMaster.master" AutoEventWireup="true" CodeFile="Purchageservice.aspx.cs" Inherits="Root_Retailer_Purchageservice " %>
                                    ...
                                    <div class="col-lg-2">
                                        ...
                                        <div class="col-lg-3">
                                            <asp:DropDownList ID="ddlservice" runat="server" Height="35px" CssClass="form-control" AutoPostBack="true" OnSelectedIndexChanged="ddl_Eboard_SelectedIndexChanged">
                                                ...
                                                <asp:ListItem>ICIC AEPS</asp:ListItem>
                                            </asp:DropDownList>
