<%@ Page Title="" Language="C#" MasterPageFile="~/Root/Retailer/MemberMaster.master" AutoEventWireup="true" CodeFile="Institute_Request.aspx.cs" Inherits="Root_Retailer_Institute_Request" %>
    ...
    <script>
        ...
        app.controller("distributorCntrl", function ($scope, $http, $timeout) {
            ...
            $scope.filldmrreport = function () {
                ...
                var httpreq = {
                    method: 'POST',
                    url: '../Retailer/Institute_Request.aspx/Institute_Request',
                    headers: {
            ...
            $scope.filldmrreportbydate = function (fdate, tdate) {
                ...
                var httpreq = {
                    method: 'POST',
                    url: '../Retailer/Institute_Request.aspx/Institute_Requestbydate',
                    headers: {
                        'Content-Type': 'application/json; charset=utf-8',
                        'dataType': 'json'
                    },
            ...
            function instantdmrreceipt(id) {
                ...
                var ID = id;
                $http({
                    url: '../Retailer/EMIPayment_report.aspx/loaddmrreceipt',
                    method: "POST",
                    data: { txnid: id }
