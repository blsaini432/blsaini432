<%@ Page Title="" Language="C#" MasterPageFile="~/Root/Retailer/MemberMaster.master" AutoEventWireup="true" CodeFile="UPI_Payment_Report.aspx.cs" Inherits="Root_Retailer_UPI_Payment_Report" %>
    ...
    <script>
        ...
        app.controller("distributorCntrl", function ($scope, $http, $timeout) {
            ...
            $scope.filldmrnewreport = function () {
                ...
                var httpreq = {
                    method: 'POST',
                    url: '../Retailer/UPI_Payment_Report.aspx/fillreport',
                    headers: {
            ...
            $scope.filldmrnewreportbydate = function (fdate, tdate) {
                ...
                var httpreq = {
                    method: 'POST',
                    url: '../Retailer/UPI_Payment_Report.aspx/fillreportbydate',
                    headers: {
                        'Content-Type': 'application/json; charset=utf-8',
                        'dataType': 'json'
                    },
            ...
            function dmrreceipt(id) {
                var ID = id;
                $http({
                    url: '../Retailer/UPI_Payment_Report.aspx/loadreceipt',
                    method: "POST",
                    data: { txnid: id }
