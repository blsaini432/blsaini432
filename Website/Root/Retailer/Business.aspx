<%@ Page Title="" Language="C#" MasterPageFile="~/Root/Retailer/MemberMaster.master" AutoEventWireup="true" CodeFile="Business.aspx.cs" Inherits="Root_Retailer_Business" %>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    <div class="col-lg-3">
                                        <label class="col-form-label">Invest Rent  <code>*</code></label>
                                    </div>
                                    <div class="col-lg-8">
