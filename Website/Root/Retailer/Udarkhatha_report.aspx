<%@ Page Title="" Language="C#" MasterPageFile="~/Root/Retailer/MemberMaster.master" AutoEventWireup="true" CodeFile="Udarkhatha_report.aspx.cs" Inherits="Root_Retailer_Udarkhatha_report" %>
    ...
    <script>
        ...
        app.controller("distributorCntrl", function ($scope, $http, $timeout) {
            ...
            $scope.fillreport = function () {
                ...
                var httpreq = {
                    method: 'POST',
                    url: '../Retailer/Udarkhatha_report.aspx/fillreport',
                    headers: {
            ...
            $scope.fillreportbydate = function (fdate, tdate) {
                ...
                var httpreq = {
                    method: 'POST',
                    url: '../Retailer/Udarkhatha_report.aspx/fillreportbydate',
                    headers: {
                        'Content-Type': 'application/json; charset=utf-8',
                        'dataType': 'json'
                    },
            ...
            function instantdmrreceipt(id) {
                ...
                var ID = id;
                $http({
                    url: '../Retailer/Udarkhatha_report.aspx/loaddmrreceipt',
                    method: "POST",
                    data: { txnid: id }
            ...
            function apdateamount(id) {
                ...
                var ID = id;
                $http({
                    url: '../Retailer/Udarkhatha_report.aspx/deletedata',
                    method: "POST",
                    data: { txnid: id }
                }).success(function (response) {
                    $("#loader").hide();
