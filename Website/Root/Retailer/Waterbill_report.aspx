<%@ Page Title="" Language="C#" MasterPageFile="~/Root/Retailer/MemberMaster.master"
    AutoEventWireup="true" CodeFile="Waterbill_report.aspx.cs" Inherits="Root_Retailer_Waterbill_report" %>
    ...
    <script>
        ...
        app.controller("distributorCntrl", function ($scope, $http, $timeout) {
            ...
            $scope.fillelectricityreport = function () {
                var httpreq = {
                    method: 'POST',
                    url: '../Retailer/Waterbill_report.aspx/waterreport',
                    headers: {
            ...
            $scope.fillelectricityreportbydate = function (fdate, tdate) {
                ...
                var httpreq = {
                    method: 'POST',
                    url: '../Retailer/Waterbill_report.aspx/waterreportbydate',
                    headers: {
                        'Content-Type': 'application/json; charset=utf-8',
                        'dataType': 'json'
                    },
            ...
            function ReadRecord(id) {
                ...
                var ID = id;
                $http({
                    url: '../Retailer/Waterbill_report.aspx/loadreceipt',
                    method: "POST",
                    data: { txnid: id }
