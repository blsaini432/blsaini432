...
<link rel='stylesheet prefetch' href='https://cdnjs.cloudflare.com/ajax/libs/chosen/1.8.2/chosen.min.css'>
...
height: 100%;
z-index: 1000;
background: url('../../bus-loader.gif') no-repeat center center;
}
...
<body style="background:#F4F4F4;">
    ...
    <div id="pageloaddiv"></div>
        ...
        <div align="center">
                  ...
                  <div class="profile_details">
                                    ...
                                    <button type="button" class="balance-button"></i><asp:Label ID="lblmemberid" runat="server"  Font-Bold="true">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br /></asp:Label></button>
    
            <button type="button" class="balance-button">Main Wallet,<i class="fa-rupee-sign"></i> <asp:Label ID="lblBalance" runat="server"></asp:Label></button>
            

      </div>
    <asp:Panel ID="pnlsearchbus" runat="server" CssClass="modal-content" >
    <table width="100%"  style="background-color:#124680;">
    <tr><td align="center">
        <table width="60%" style="background-color:#124680;">
            <tr>
                <td>
                    <asp:Label ID="Label1" runat="server" Font-Bold="True" Text="From " 
                        ForeColor="White"></asp:Label>
                </td>
                <td>
                    <asp:Label ID="Label8" runat="server" Font-Bold="True" Text="To" 
                        ForeColor="White"></asp:Label>
                </td>
                <td>
                    <asp:Label ID="Label3" runat="server" Font-Bold="True" 
                        Text="Departure(dd-mm-yyyy)" ForeColor="White"></asp:Label>
                </td>
                <td>&nbsp;</td>
            </tr>
            <tr>
                <td class="auto-style5">
                    <asp:DropDownList ID="ddl_leavingfrom" runat="server" CssClass="chzn-select"  style="border:0px;" TabIndex="2" Width="313px">
                ...
                <td class="auto-style5">
                    <asp:DropDownList ID="ddl_goingto" runat="server" CssClass="chzn-select"  style="border:0px;" TabIndex="2" Width="313px">
                       
                    </asp:DropDownList>
                </td>
                <td>
                    <asp:TextBox ID="TextBox1" runat="server"  style="border:0px;margin-bottom:0px;padding:4px 10px;"></asp:TextBox>
                    <ajaxToolkit:CalendarExtender ID="TextBox1_CalendarExtender" runat="server" behaviorid="TextBox1_CalendarExtender" CssClass="cal_Theme1" targetcontrolid="TextBox1" Format="yyyy-MM-dd" />
                </td>
                <td class="auto-style5">
                    <asp:Button ID="Button1" runat="server" BackColor="#cb3904" Font-Bold="True" 
                        ForeColor="White" Height="37px" Text="Search" Width="147px" 
  ...
  <div class="container">
      <div class="row">
        <div class="col-md-12" style="background:#e8e7e4;">
          <div class="_panel">
               <div class="clearfix"></div>
            <div class="panel-body_" style="min-height:100px;">
                    ...
                    <asp:Panel ID="bussearches" runat="server">
                         ...
                         <table width="100%"  cellspacing="0" >
                            <tr id="t1" runat="server" visible="false" style="padding-top:30px;">
                                ...
                                <td align="right">
                                    &nbsp;&nbsp;
                                    <asp:Button ID="Button3" runat="server" BackColor="White" BorderColor="Black" 
                                        BorderStyle="Solid" Height="31px" Text="Modify Search ↓"  CssClass="btn btn-default"
...
<%--                     
                                        <HeaderTemplate>
                                        <table width="100%"  CssClass="table table-striped table-bordered bootstrap-datatable datatable responsive SmallText table-responsive">
                                       
                                         <thead>
                                                    <tr>
                                                    <th>
<asp:Label ID="travlername" runat="server"  CssClass="hrefclass">Traveler Name</asp:Label></th>
                                                    <th>
<asp:Label ID="Departure" runat="server" CssClass="hrefclass">Departure</asp:Label></th>
                                                                    <th>
<asp:Label ID="Duration" runat="server"  CssClass="hrefclass">Duration</asp:Label></th>
                                                     <th>
<asp:Label ID="Arival" runat="server" CssClass="hrefclass">Arival</asp:Label></th>
                          <th>
<asp:LinkButton ID="Seats" runat="server" CommandName="availableSeats" CssClass="hrefclass">Seats</asp:LinkButton></th>
                       <th>
<asp:Label ID="Fare" runat="server" CssClass="hrefclass">Fare</asp:Label></th>
                                        ...
                                        <table width="100%" border="0" style="border-color:White;background-color:White;" CssClass="modal-content">
                                       <tr>       
                      ...
                      <asp:Label ID="lbltravelsname" runat="server"
                                                                     ForeColor="#424F63"  Text='<%# DataBinder.Eval(Container.DataItem, "travels")%>'></asp:Label></strong><br>
                       <br /> 
                                                         <strong>  <asp:Label ID="lblbustype" runat="server" 
                                                                    Text='<%# Eval("bustype") %>' ForeColor="#cb3904"></asp:Label></strong>
                                                                    <br />
<asp:LinkButton ID="linkbtncancelpolicy" runat="server" 
                                                                    CommandArgument='<%# Eval("data_Id") %>' ForeColor="#385dab" OnCommand="linkbtncancelpolicy_Click">Cancellaion Policy</asp:LinkButton>
                                               
                                                </td>
                                        <td>
                        
                        <span><asp:Label ID="lbldeparturedate" runat="server" 
                                                                    ForeColor="#424F63" Text='<%# Eval("doj")%>'></asp:Label><br>
                       <asp:Label ID="lbldeparturetime" runat="server" 
                                                                    ForeColor="#424F63" Text='<%# Eval("departureTime") %>'></asp:Label><br>
                        <br>
                        <asp:LinkButton ID="linkbtnboardingpoints" runat="server" 
                                                                    BackgroundCssClass="modalBackground" CommandArgument='<%# Eval("data_Id") %>' 
                                                                     ForeColor="#385dab" OnCommand="linkbtnboardingpoints_Click">Boarding Points</asp:LinkButton>
                       </span></td>
                                                         <td>
                      ...
                      <strong>
                        <center>
                         ...
                         <asp:Label ID="lblduration" runat="server"  ForeColor="#424F63" 
                                                       ...
                                                       <td>
                      <span><asp:Label ID="lblarivaldate" runat="server" 
                                                                    ForeColor="#424F63" Text='<%# Eval("doj")%>'></asp:Label><br>
                        <asp:Label ID="lblarivaltime" runat="server" 
                                                                    ForeColor="#424F63" Text='<%# Eval("arrivalTime") %>'></asp:Label><br>
                        <br>
                         <asp:LinkButton ID="linkbtndroppingpoints" runat="server" 
                                                                    CommandArgument='<%# Eval("data_Id") %>'  ForeColor="#385dab" 
                                                                    OnCommand="linkbtndroppingpoints_Click">Dropping Points</asp:LinkButton></span></td>
                                                                   <td>
                      <strong>
                                                    <asp:Label ID="lblavaibleseats" runat="server" 
                                                        ForeColor="#424F63" Text='<%#Eval("availableSeats") + " " + "Seats"  %>'></asp:Label>
                      </strong></td>
                                           <td  style="width:80px;Color:#cb3904;"><small><i>Starting from </i></small><br>
                        <strong><asp:Label ID="lblprice" runat="server" Font-Bold="True" ForeColor="#cb3904" ToolTip='<%# Eval("data_Id") %>'>&gt;</asp:Label> </strong><br>
                        <br>
                        <asp:Button ID="btnviewseats" runat="server" BackColor="#cb3904"                                                                     CommandArgument='<%#Eval("id") + "-" + Eval("data_Id") + "-" + Eval("travels") %>' ForeColor="White" 
...
<ajaxToolkit:ModalPopupExtender ID="ModalPopupExtender1"  runat="server"
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
        <asp:Panel ID="pnlseatlayout" runat="server" Visible="true" Width="70%" Height="670px" CssClass="modal-content" style="display:none;">
           <table align="center">
                <tr>
                    <td>
              
                       <asp:DropDownList ID="ddboardingpoint" runat="server" CssClass="chzn-select"
                            TabIndex="2" Width="313px">
                    </asp:DropDownList>
                    ...
                    <td>  <asp:DropDownList ID="dddroppingpoint" runat="server" CssClass="chzn-select" 
                            TabIndex="2" Width="313px">
               ...
               <div id="container">
                    ...
                    <div style="float:right;"></div>
                          <div style="float:right;">
                                    <asp:Button ID="btnnextseat" runat="server" BackColor="#374152" Font-Bold="True" ForeColor="White" Height="37px" Text="Next" Width="90px" ValidationGroup="b" OnClick="btnnextseat_Click"/>

                                </div> </div>
                                   <script type="text/javascript" src="../js/bus.js">
...
<asp:UpdatePanel ID="upboarding" runat="server">
<ContentTemplate>
                            ...
                            <tr>
                                <td align=center colspan="2">
                                    <asp:Repeater ID="Repeater2" runat="server"  OnItemDataBound="Repeater2_ItemDataBound">
                                        <HeaderTemplate>
                                            <table  class="table table-striped table-bordered bootstrap-datatable datatable responsive SmallText" 
...
<ajaxToolkit:ModalPopupExtender ID="mpcancelpopup" runat="server"
    PopupControlID="pnlcancelayout" TargetControlID="linkcancelid" BackgroundCssClass="modalBackground">
        ...
        <asp:Panel ID="pnlcancelayout" runat="server" Visible="true" Width="40%" 
...
<ajaxToolkit:ModalPopupExtender ID="mppassanger" runat="server"
    PopupControlID="pnlpassangerlist" TargetControlID="LinkButton4" BackgroundCssClass="modalBackground">
        ...
        <asp:Panel ID="pnlpassangerlist" runat="server" Visible="true" 
                        CssClass="modal-content" style="display:none;padding:10px 20px 10px 20px;" ><div style="max-height: 650px;overflow-y: scroll;">
<asp:Panel id="pnlmain" runat="server" Visible="false">
       ...
       <table class="border-dottet">
            ...
            <tr>
                ...
                <td class="auto-style3"><asp:Label ID="Label2" runat="server" BackColor="Gray" Font-Bold="True" 
        ...
        <table class="border-dottet">
            ...
            <tr>
                ...
                <td> <asp:Label ID="Label6" runat="server" BackColor="Gray" Font-Bold="True" 
                        ForeColor="White" Text="Seat Name:"></asp:Label>
        ...
        <table class="border-dottet">
            ...
            <tr>
                ...
                <td> <asp:Label ID="Label10" runat="server" BackColor="Gray" Font-Bold="True" 
                        ForeColor="White" Text="Seat Name:"></asp:Label>
        ...
        <table class="border-dottet">
            ...
            <tr>
                ...
                <td> <asp:Label ID="Label14" runat="server" BackColor="Gray" Font-Bold="True" 
                        ForeColor="White" Text="Seat Name:"></asp:Label>
      ...
      <table class="border-dottet">
            <tr>
                ...
                <td><asp:Label ID="Label18" runat="server" BackColor="Gray" Font-Bold="True" 
                        ForeColor="White" Text="Seat Name:"></asp:Label>
        ...
        <table class="border-dottet">
            ...
            <tr>
                ...
                <td> <asp:Label ID="Label22" runat="server" BackColor="Gray" Font-Bold="True" 
                        ForeColor="White" Text="Seat Name:"></asp:Label>
  ...
  <asp:Panel id="Panel1" runat="server">
    <table class="border-dottet">
            ...
            <tr>
                <td >&nbsp;</td>
                <td  align="right"><asp:Button ID="btnnextprocess" runat="server" ValidationGroup="vvv"
