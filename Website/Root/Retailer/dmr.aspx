<%@ Page Title="" Language="C#" MasterPageFile="~/Root/Retailer/MemberMaster.master" AutoEventWireup="true" CodeFile="dmr.aspx.cs" Inherits="Root_Retailer_dmr" %>
    ...
    <script type="text/javascript">
        ...
        app.controller("distributorCntrl", function ($scope, $http, $timeout, $filter) {
            ...
            function GetBeniDetail(id) {
                $http({
                    url: '../Retailer/dmr.aspx/GetBeniDetail',
                    method: "POST",
                    data: { Id: id }
            ...
            function GetBeniDeleteDetail(id) {
                $http({
                    url: '../Retailer/dmr.aspx/GetBeniDeleteDetail',
                    method: "POST",
                    data: { Id: id }
                }).success(function (response) {
                    alert(response.d);
           ...
           <div class="row" id="divhome" runat="server">
                    <div class="col-4">
                      <ul class="nav nav-tabs nav-tabs-vertical" role="tablist">
                        <li class="nav-item">
                            <asp:LinkButton ID="link1" runat="server" CssClass="nav-link" OnClick="link1_Click" Text="New Remitter Register"></asp:LinkButton>
                         
                        </li>
                        <li class="nav-item">
                             <asp:LinkButton ID="link2"  runat="server" CssClass="nav-link active show" OnClick="link2_Click" Text="Remitter Login"></asp:LinkButton>
                        </li>
                      </ul>
                    </div>
                    <div class="col-8">
                      <div class="tab-content tab-content-vertical">
                        <div class="tab-pane fade" id="home2"   runat="server">
            ...
            <div class="col-12">
                ...
                <div class="card">
                    ...
                    <Triggers>
                        ...
                        <div class="tab-pane fade active show" id="profile2" role="tabpanel" runat="server">
