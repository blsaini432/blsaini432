...
public partial class Root_Retailer_BBPS_FetchBill_New : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            if (Session["ref_id"] != null && Session["field_namelbl"] != null && Session["dtRetailer"] != null && Session["field_namevalue"] != null && Session["jwt_token"] != null)
            {
    ...
    {
        if (Session["ref_id"] != null && Session["field_namelbl"] != null && Session["dtRetailer"] != null && Session["field_namevalue"] != null && Session["amount"] != null && Session["billerid"] != null && Session["jwt_token"] != null && Session["customername"]!=null && Session["duedate"]!=null)
        {
