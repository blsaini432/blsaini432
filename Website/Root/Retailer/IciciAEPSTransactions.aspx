<%@ Page Title="" Language="C#" MasterPageFile="~/Root/Retailer/MemberMaster.master" AutoEventWireup="true" CodeFile="IciciAEPSTransactions.aspx.cs" Inherits="Root_Retailer_IciciAEPSTransactions" %>
      ...
      app.controller("distributorCntrl", function ($scope, $http, $timeout) {
          ...
          //pagination end
               ...
               function instantdmrreceipt(id) {
                   ...
                   var ID = id;
                   $http({
                       url: '../Retailer/IciciAEPSTransactions.aspx/loadreceipt',
                       method: "POST",
                       data: { txnid: id }
               ...
               $scope.fillaepstransaction = function () {
                   ...
                   var httpreq = {
                       method: 'POST',
                       url: '../Retailer/IciciAEPSTransactions.aspx/fillaepstransactions',
                       headers: {
               ...
               $scope.fillaepstransactionbydate = function (fdate, tdate) {
                   ...
                   var httpreq = {
                       method: 'POST',
                       url: '../Retailer/IciciAEPSTransactions.aspx/fillaepstransactionsbydate',
                       headers: {
                           'Content-Type': 'application/json; charset=utf-8',
                           'dataType': 'json'
                       },
