<%@ Page Title="" Language="C#" MasterPageFile="~/Root/Retailer/MemberMaster.master" AutoEventWireup="true" CodeFile="Payoutnew_report.aspx.cs" Inherits="Root_Retailer_Payoutnew_report" %>
    ...
    <script>
        ...
        app.controller("distributorCntrl", function ($scope, $http, $timeout) {
            ...
            $scope.filldmrnewreport = function () {
                ...
                var httpreq = {
                    method: 'POST',
                    url: '../Retailer/Payoutnew_report.aspx/filldmrnewreport',
                    headers: {
            ...
            $scope.filldmrnewreportbydate = function (fdate, tdate) {
                ...
                var httpreq = {
                    method: 'POST',
                    url: '../Retailer/Payoutnew_report.aspx/filldmrnewreportbydate',
                    headers: {
                        'Content-Type': 'application/json; charset=utf-8',
                        'dataType': 'json'
                    },
            ...
            function dmrreceipt(id) {
                var ID = id;
                $http({
                    url: '../Retailer/Payoutnew_report.aspx/loaddmrreceipt',
                    method: "POST",
                    data: { txnid: id }
