<%@ Page Title="" Language="C#" MasterPageFile="~/Root/Retailer/MemberMaster.master" AutoEventWireup="true" CodeFile="Dashboard_new.aspx.cs" Inherits="Root_Admin_Dashboard" %>
                    ...
                    <div class="card-body">
                        <div class="d-md-flex justify-content-between align-items-center">
                            <div class="d-flex align-items-center mb-2 mb-md-0">
                                ...
                                <img src="../../Design/newimg/punjab bank.png" alt="No Image Available" height="100" width="100" />
                            ...
                            <div class="d-flex align-items-center mb-2 mb-md-0">
                                ...
                                <img src="../../Design/newimg/sbi bank.png" alt="No Image Available" height="100" width="100" />


                            </div>
                            <div class="d-flex align-items-center mb-2 mb-md-0">
                                <a href="https://www.unionbankofindia.co.in/english/saving-account.aspx" target="_blank" />
                                <img src="../../Design/newimg/union bank.png" alt="No Image Available" height="100" width="100" />
