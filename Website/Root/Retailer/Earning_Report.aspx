<%@ Page Title="" Language="C#" MasterPageFile="~/Root/Retailer/MemberMaster.master" AutoEventWireup="true" CodeFile="Earning_Report.aspx.cs" Inherits="Root_Retailer_Earning_Report" %>
    ...
    <script>
        ...
        app.controller("DistributorCntrl", function ($scope, $http, $timeout) {
            ...
            $scope.filldmrnewreport = function () {
                ...
                var httpreq = {
                    method: 'POST',
                    url: '../Retailer/Earning_Report.aspx/filldmrnewreport',
                    headers: {
            ...
            $scope.filldmrnewreportbydate = function (fdate, tdate) {
                ...
                var httpreq = {
                    method: 'POST',
                    url: '../Retailer/Earning_Report.aspx/filldmrnewreportbydate',
                    headers: {
                        'Content-Type': 'application/json; charset=utf-8',
                        'dataType': 'json'
                    },
            ...
            function dmrreceipt(id) {
                var ID = id;
                $http({
                    url: '../Retailer/Earning_Report.aspx/loaddmrreceipt',
                    method: "POST",
                    data: { txnid: id }
