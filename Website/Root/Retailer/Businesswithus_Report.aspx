<%@ Page Title="" Language="C#" MasterPageFile="~/Root/Retailer/MemberMaster.master" AutoEventWireup="true" CodeFile="Businesswithus_Report.aspx.cs" Inherits="Root_Retailer_Businesswithus_Report" %>
    ...
    <script>
        ...
        app.controller("distributorCntrl", function ($scope, $http, $timeout) {
            ...
            $scope.filldmrreport = function () {
                ...
                var httpreq = {
                    method: 'POST',
                    url: '../Retailer/Businesswithus_Report.aspx/Businesswithus_Report',
                    headers: {
            ...
            $scope.filldmrreportbydate = function (fdate, tdate) {
                ...
                var httpreq = {
                    method: 'POST',
                    url: '../Retailer/Businesswithus_Report.aspx/Businesswithus_Reportbydate',
                    headers: {
                        'Content-Type': 'application/json; charset=utf-8',
                        'dataType': 'json'
                    },
