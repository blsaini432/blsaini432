<%@ Page Title="" Language="C#" MasterPageFile="~/Root/Retailer/MemberMaster.master" AutoEventWireup="true" CodeFile="Solarenergy_Report.aspx.cs" Inherits="Root_Retailer_Solarenergy_Report" %>
       ...
       <script>
           ...
           app.controller("retailerCntrl", function ($scope, $http, $timeout) {
               ...
               $scope.fillaepstransaction = function () {
                   ...
                   var httpreq = {
                       method: 'POST',
                       url: '../Retailer/Solarenergy_Report.aspx/fillaepstransactions',
                       headers: {
               ...
               $scope.fillaepstransactionbydate = function (fdate, tdate) {
                   ...
                   var httpreq = {
                       method: 'POST',
                       url: '../Retailer/Solarenergy_Report.aspx/fillaepstransactionsbydate',
                       headers: {
                           'Content-Type': 'application/json; charset=utf-8',
                           'dataType': 'json'
                       },
