<%@ Page Title="" Language="C#" MasterPageFile="~/Root/Retailer/MemberMaster.master" AutoEventWireup="true"
    CodeFile="Insprepaidcardtranscation.aspx.cs" Inherits="Root_Retailer_Insprepaidcardtranscation" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script src="../Angularjsapp/retailerapp.js"></script>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="content-wrapper">
        <div class="page-header">
            <h3 class="page-title">Prepaid Card Transactions
            </h3>
        </div>
                        ...
                        <div class="container" ng-app="retailerApp" ng-controller="retailerCntrl">
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group row">
                                        <div class="col-sm-6">
                                            <a href="#" ng-click="fillPrepaidTransreportbydate(from_date,to_date)" class="btn btn-primary">Search &gt;&gt;</a>
                                ...
                                <div class="table-responsive">
                                    <table id="tblEwalletsummary" class="table table-bordered table-hover">
                                        <thead>
                                            ...
                                            <tr ng-show="PreapicardtransReport.length!=0" dir-paginate="x in PreapicardtransReport|filter:search|itemsPerPage:pageSize">
                                                <td>{{$index + 1}}</td>
                                                <td>{{x.MemberID}}</td>
                                                <td>{{x.Txnid}}</td>
                                                <td>{{x.Amount}}</td>
                                            ...
                                            <tr>
                                                <td ng-show="PreapicardtransReport.length==0" colspan="7">
