<%@ Page Title="" Language="C#" MasterPageFile="~/Root/Retailer/MemberMaster.master" AutoEventWireup="true" CodeFile="bbpsoffline.aspx.cs" Inherits="Root_Retailer_bbpsoffline" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="content-wrapper">
        <div class="page-header">
            <h3 class="page-title"> Bill Payment
            </h3>
        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6 grid-margin stretch-card">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <%-- <img src="../../Uploads/Company/actual/bbps.png" />--%>
