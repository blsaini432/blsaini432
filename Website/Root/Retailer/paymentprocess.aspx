<%@ Page Title="" Language="C#" MasterPageFile="~/Root/Retailer/MemberMaster.master" AutoEventWireup="true" CodeFile="paymentprocess.aspx.cs" Inherits="Root_Retailer_paymentprocess" %>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-8">
                                       <label class="col-form-label">Maximum Amount 12 and minimum Amount 1.60%<code></code></label>
