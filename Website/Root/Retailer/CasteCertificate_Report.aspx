    ...
    <script>
        ...
        app.controller("distributorCntrl", function ($scope, $http, $timeout) {
            ...
            $scope.fillelectricityreport = function () {
                var httpreq = {
                    method: 'POST',
                    url: '../Retailer/CasteCertificate_Report.aspx/panreport',
                    headers: {
            ...
            $scope.fillelectricityreportbydate = function (fdate, tdate) {
                ...
                var httpreq = {
                    method: 'POST',
                    url: '../Retailer/CasteCertificate_Report.aspx/panreportbydate',
                    headers: {
                        'Content-Type': 'application/json; charset=utf-8',
                        'dataType': 'json'
                    },
            ...
            function ReadRecord(id) {
                ...
                var ID = id;
                $http({
                    url: '../Retailer/CasteCertificate_Report.aspx/loadreceipt',
                    method: "POST",
                    data: { txnid: id }
