<%@ Page Title="" Language="C#" MasterPageFile="~/Root/Retailer/MemberMaster.master" AutoEventWireup="true" CodeFile="EMIPayment_report.aspx.cs" Inherits="Root_Retailer_EMIPayment_report" %>
    ...
    <script> 
        ...
        app.controller("distributorCntrl", function ($scope, $http, $timeout) {
             ...
             $scope.filldmrreport = function () {
                 ...
                 var httpreq = {
                     method: 'POST',
                     url: '../Retailer/EMIPayment_report.aspx/filldmrreport',
                     headers: {
             ...
             $scope.filldmrreportbydate = function (fdate, tdate) {
                 ...
                 var httpreq = {
                     method: 'POST',
                     url: '../Retailer/EMIPayment_report.aspx/filldmrreportbydate',
                     headers: {
                         'Content-Type': 'application/json; charset=utf-8',
                         'dataType': 'json'
                     },
