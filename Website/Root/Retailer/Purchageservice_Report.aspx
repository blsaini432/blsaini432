<%@ Page Title="" Language="C#" MasterPageFile="~/Root/Retailer/MemberMaster.master" AutoEventWireup="true" CodeFile="Purchageservice_Report.aspx.cs" Inherits="Root_Retailer_Purchageservice_Report" %>
    ...
    <script>
        ...
        app.controller("distributorCntrl", function ($scope, $http, $timeout) {
            ...
            $scope.filldmrreport = function () {
                ...
                var httpreq = {
                    method: 'POST',
                    url: '../Retailer/Purchageservice_Report.aspx/filldmrreport',
                    headers: {
            ...
            $scope.filldmrreportbydate = function (fdate, tdate) {
                ...
                var httpreq = {
                    method: 'POST',
                    url: '../Retailer/Purchageservice_Report.aspx/filldmrreportbydate',
                    headers: {
                        'Content-Type': 'application/json; charset=utf-8',
                        'dataType': 'json'
                    },
            ...
            function instantdmrreceipt(id) {
                ...
                var ID = id;
                $http({
                    url: '../Retailer/Purchageservice_Report.aspx/loaddmrreceipt',
                    method: "POST",
                    data: { txnid: id }
