<%@ Page Title="" Language="C#" MasterPageFile="~/Root/Retailer/MemberMaster.master" AutoEventWireup="true"
    CodeFile="OfflineSerivceReport.aspx.cs" Inherits="Root_Retailer_OfflineSerivceReport" %>
    ...
    <script>
        ...
        app.controller("RetailerCntrl", function ($scope, $http, $timeout) {
            ...
            $scope.fillofflinereport = function () {
                ...
                var httpreq = {
                    method: 'POST',
                    url: '../Retailer/OfflineSerivceReport.aspx/fillofflinereport',
                    headers: {
            ...
            $scope.fillofflinereportbydate = function (fdate, tdate) {
                ...
                var httpreq = {
                    method: 'POST',
                    url: '../Retailer/OfflineSerivceReport.aspx/fillofflinereportbydate',
                    headers: {
                        'Content-Type': 'application/json; charset=utf-8',
                        'dataType': 'json'
                    },
            ...
            function offlinereceipt(id) {
                ...
                var ID = id;
                $http({
                    url: '../Retailer/OfflineSerivceReport.aspx/loadofflinereceipt',
                    method: "POST",
                    data: { txnid: id }
