    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Session["userid"] != null && Session["Amount"] != null)
        {
            try
            {
                ...
                body.Add("callbackUrl", "https://www.fritware.com/Root/retailer/Paytmcallback.aspx");
                string paytmChecksum = Checksum.generateSignature(JsonConvert.SerializeObject(body), "%o621mn%#j#9D@L#");
                head.Add("signature", paytmChecksum);
                requestBody.Add("body", body);
                requestBody.Add("head", head);
                string post_data = JsonConvert.SerializeObject(requestBody);
                //For  Staging
              //  string url = "https://securegw-stage.paytm.in/theia/api/v1/initiateTransaction?mid=Fritwa09114227065125&orderId=" + orderid + "";
