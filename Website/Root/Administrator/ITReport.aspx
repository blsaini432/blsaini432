...
<%@ Page Title="" Language="C#" MasterPageFile="~/Root/Administrator/adminmaster.master" AutoEventWireup="true"
    CodeFile="ITReport.aspx.cs" Inherits="Root_Administrator_ITReport" %>
    ...
    <script>
        ...
        app.controller("myCntrl", function ($scope, $http, $timeout, $filter) {
            ...
            $scope.fillfundrequest = function () {
                ...
                var httpreq = {
                    method: 'POST',
                    url: '../Administrator/ITReport.aspx/fillposrequest',
                    headers: {
            ...
            $scope.fillfundrequestbydate = function (fdate, tdate) {
                ...
                var httpreq = {
                    method: 'POST',
                    url: '../Administrator/ITReport.aspx/fillposrequestbydate',
                    headers: {
                        'Content-Type': 'application/json; charset=utf-8',
                        'dataType': 'json'
                    },
            ...
            function ApproveRequest(id) {
                var ID = id;
                $http({
                    url: '../Administrator/ITReport.aspx/ApproveRequest',
                    method: "POST",
                    headers: {
                        'Content-Type': 'application/json; charset=utf-8',
                        'dataType': 'json'
            ...
            function clentdata(id) {
                var ID = id;
                $http({
                    url: '../Administrator/ITReport.aspx/clientdata',
                    method: "POST",
                    headers: {
                        'Content-Type': 'application/json; charset=utf-8',
                        'dataType': 'json'
            ...
            function RejectRequest(id) {
                var ID = id;
                $http({
                    url: '../Administrator/ITReport.aspx/RejectRequest',
                    method: "POST",
                    headers: {
                        'Content-Type': 'application/json; charset=utf-8',
                        'dataType': 'json'
            ...
            function FundImage(id) {
                var ID = id;
                $http({
                    url: '../Administrator/ITReport.aspx/ShowFundImage',
                    method: "POST",
                    headers: {
                        'Content-Type': 'application/json; charset=utf-8',
                        'dataType': 'json'
...
<asp:Content ID="Content4" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="content-wrapper">
        <div class="page-header">
            <h3 class="page-title">ITR  Request
            </h3>
        </div>
                                    ...
                                    <div class="modal-body">
                                        <div class="card">
                                            <div class="card-body" ng-repeat="y in fundimage">
                                                <div class="form-group row">
                                                    <div class="col-lg-4">
                                                        <label style="color:green">Aadhar Card</label>
                                                ...
                                                <div class="form-group row">                                    
                                                    <div class="col-lg-4">
                                                         <label style="color:green">Bank Statement</label>
                                                        <a href="../../Uploads/Servicesimage/Actual/{{y.file}}" target="_blank" />
                                                        <img src="../../Uploads/Servicesimage/Actual/{{y.file}}" alt="Download" height="200" width="200" />
                                                    </div>
                                                      <div class="col-lg-4">
                                                          <label style="color:green">Form 16 </label>
                                                        <a href="../../Uploads/Servicesimage/Actual/{{y.file2}}" target="_blank" />
                                                        <img src="../../Uploads/Servicesimage/Actual/{{y.file2}}" alt="Download" height="200" width="200" />
                                                    </div>
                                                   <%-- <div class="col-lg-4">
                                        ...
                                        <div class="card">
                                            <div class="card-body" ng-repeat="y in fundimage">
                                                <table class="table table-responsive ps--scrolling-y">
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <asp:Button ID="Button1" runat="server" Visible="true" Text="Success" OnClick="btnSubmit_Click" />
