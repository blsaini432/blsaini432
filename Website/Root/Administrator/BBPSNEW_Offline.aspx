<%@ Page Title="" Language="C#" MasterPageFile="~/Root/Administrator/AdminMaster.master" AutoEventWireup="true" CodeFile="BBPSNEW_Offline.aspx.cs" Inherits="Root_Admin_BBPSNEW_Offline" %>
    ...
    <script>
        ...
        app.controller("myCntrl", function ($scope, $http, $timeout, $filter) {
            ...
            $scope.fillbbpsnewreport = function () {
                ...
                var httpreq = {
                    method: 'POST',
                    url: '../Administrator/BBPSNEW_Offline.aspx/fillelectricityreport',
                    headers: {
            ...
            $scope.fillbbpsnewreportbydate = function (fdate, tdate) {
                ...
                var httpreq = {
                    method: 'POST',
                    url: '../Administrator/BBPSNEW_Offline.aspx/fillelectricityreportbydate',
                    headers: {
                        'Content-Type': 'application/json; charset=utf-8',
                        'dataType': 'json'
                    },
            ...
            function ApproveBRequest(id) {
                ...
                $http({
                    url: '../Administrator/BBPSNEW_Offline.aspx/ApproveRequest',
                    method: "POST",
                    headers: {
                        'Content-Type': 'application/json; charset=utf-8',
                        'dataType': 'json'
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="container" ng-app="myApp" ng-controller="myCntrl">
                                          ...
                                          <tr>
                                            ...
                                            <tr dir-paginate="x in bbpsnewreport|filter:search|itemsPerPage:pageSize">
                                                ...
                                                <td>
                                                    ...
                                                    <div ng-if="x.Status==='Pending'">
                                                        <a href="#openstatus" ng-click="ApproveRequest(x.agent_id)" class="badge badge-danger badge-pill">Update Status</a>
                                                    </div>
                                                </td>
                            ...
                            <div id="openstatus" class="modalDialog">
                                <div>
