<%@ Page Title="" Language="C#" MasterPageFile="~/Root/Administrator/AdminMaster.master" AutoEventWireup="true"
    CodeFile="Emitra_Request.aspx.cs" Inherits="Root_Admin_Emitra_Request" %>
    ...
    <script>
        ...
        app.controller("myCntrl", function ($scope, $http, $timeout, $filter) {
            ...
            $scope.fillfundrequest = function () {
                ...
                var httpreq = {
                    method: 'POST',
                    url: '../Administrator/Emitra_Request.aspx/fillrequest',
                    headers: {
            ...
            $scope.fillfundrequestbydate = function (fdate, tdate) {
                ...
                var httpreq = {
                    method: 'POST',
                    url: '../Administrator/Emitra_Request.aspx/fillrequestbydate',
                    headers: {
                        'Content-Type': 'application/json; charset=utf-8',
                        'dataType': 'json'
                    },
            ...
            function ApprovebRequest(id) {
                var ID = id;
                $http({
                    url: '../Administrator/Emitra_Request.aspx/ApproveRequest',
                    method: "POST",
                    headers: {
                        'Content-Type': 'application/json; charset=utf-8',
                        'dataType': 'json'
            ...
            function RejectRequest(id) {
                var ID = id;
                $http({
                    url: '../Administrator/Emitra_Request.aspx/RejectRequest',
                    method: "POST",
                    headers: {
                        'Content-Type': 'application/json; charset=utf-8',
                        'dataType': 'json'
            ...
            function FundImage(id) {
                var ID = id;
                $http({
                    url: '../Administrator/Emitra_Request.aspx/ShowFundImage',
                    method: "POST",
                    headers: {
                        'Content-Type': 'application/json; charset=utf-8',
                        'dataType': 'json'
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="content-wrapper">
        <div class="page-header">
            <h3 class="page-title">Emitra Request List
            </h3>
        </div>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="container" ng-app="myApp" ng-controller="myCntrl">
                                                ...
                                                <div class="form-group row">
                                                    <div class="col-lg-3">
                                                      <label style="color: green">photo</label>
                                                        ...
                                                        <img src="../../Uploads/servicesimage/Actual/{{y.photo}}" alt="Downliad" height="200" width="200" />
                                                    </div>
                                                    <div class="col-lg-3">
                                                        <label style="color: green">aadhar</label>
                                                        <a href="../../Uploads/servicesimage/Actual/{{y.aadhar}}" target="_blank" />
                                                        <img src="../../Uploads/servicesimage/Actual/{{y.aadhar}}" alt="Downliad" height="200" width="200" />
                                                    </div>
                                                    <div class="col-lg-3">
                                                        <label style="color: green">Pan Card</label>
                                                        <a href="../../Uploads/servicesimage/Actual/{{y.pancard}}" target="_blank" />
                                                        <img src="../../Uploads/servicesimage/Actual/{{y.pancard}}" alt="Downliad" height="200" width="200" />
                                                    </div>
                                                    <div class="col-lg-3">
                                                        <label style="color: green">police_verification/ </label>
                                                        <a href="../../Uploads/servicesimage/Actual/{{y.police_verification}}" target="_blank" />
                                                        <img src="../../Uploads/servicesimage/Actual/{{y.police_verification}}" alt="Downliad" height="200" width="200" />
                                                    </div>
                                                </div>
                                                <div class="form-group row">

                                                    <div class="col-lg-4">
                                                        <label style="color: green">Bank details</label>
                                                        <a href="../../Uploads/servicesimage/Actual/{{y.Bank_details}}" target="_blank" />
                                                        <img src="../../Uploads/servicesimage/Actual/{{y.Bank_details}}" alt="Downliad" height="200" width="200" />
                                                    </div>
                                                    <div class="col-lg-4">
                                                        <label style="color: green">jan aadhar /</label>
                                                        <a href="../../Uploads/servicesimage/Actual/{{y.jan_aadhar}}" target="_blank" />
                                                        <img src="../../Uploads/servicesimage/Actual/{{y.jan_aadhar}}" alt="Downliad" height="200" width="200" />
                                                    </div>
                            ...
                            <div id="openModalid" class="modalDialog">
                              
                                    <a href="#close" title="Close" class="close">X</a>
                                    <div class="modal-body">
                                        <div class="card">
                                            <div class="card-body" ng-repeat="y in approve">
