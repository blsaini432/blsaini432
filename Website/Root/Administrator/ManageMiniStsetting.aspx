<%@ Page Title="" Language="C#" MasterPageFile="AdminMaster.master" AutoEventWireup="true" CodeFile="ManageMiniStsetting.aspx.cs" Inherits="Portals_Admin_ManageMiniStsetting" %>
                ...
                <div class="card">
                    <div class="card-body">
                         <div class="form-group row">
                            ...
                            <div class="form-group row">
                            <div class="col-lg-3">
                                <label class="col-form-label">Commission<code>*</code></label>
                            </div>
                            <div class="col-lg-8">
