<%@ Page Title="" Language="C#" MasterPageFile="~/Root/Administrator/AdminMaster.master" AutoEventWireup="true" CodeFile="viewplanrequest.aspx.cs" Inherits="root_Admin_viewplanrequest" %>
     ...
     <script>
          ...
          app.controller("myCntrl", function ($scope, $http, $timeout, $filter) {
              ...
              $scope.fillplanrequest = function () {
                  ...
                  var httpreq = {
                      method: 'POST',
                      url: '../Administrator/viewplanrequest.aspx/fillplanrequest',
                      headers: {
              ...
              $scope.fillplanrequestbydate = function (fdate, tdate) {
                  ...
                  var httpreq = {
                      method: 'POST',
                      url: '../Administrator/viewplanrequest.aspx/fillplanrequestbydate',
                      headers: {
                          'Content-Type': 'application/json; charset=utf-8',
                          'dataType': 'json'
                      },
              ...
              function ApproveBRequest(id, inputVal, beztxnid, vremainingcount, bpric) {
                  ...
                  var ID = id;
                  $http({
                      url: '../Administrator/viewplanrequest.aspx/ApproveRequest',
                      method: "POST",
                      headers: {
                          'Content-Type': 'application/json; charset=utf-8',
                          'dataType': 'json'
                                    ...
                                    <table id="tblEwalletsummary" class="table table-bordered table-hover">
                                        <thead>
                                            ...
                                            <tr dir-paginate="x in planreport|filter:search|itemsPerPage:pageSize">
                                               ...
                                               <%--  <td>{{x.ActiveDate}}</td>--%>
                                               <%-- <td>
                                                    <div ng-if="x.ActiveStatus!=='Pending'">
                                                        {{x.ActiveStatus}}
                                                    </div>
                                                    <div ng-if="x.ActiveStatus==='Pending'">
                                                        <a href="#" ng-click="ApproveRequest(x.requestbymsrno,x.mm,x.TranId,x.idpurchase,x.amount)" class="badge badge-danger badge-pill">Approve</a>
                                                    </div>
                                                     <div ng-if="x.ActiveStatus==='Pending'">
                                                        <a href="#" ng-click="ApproveRequest(x.requestbymsrno,x.mm,x.TranId,x.idpurchase,x.amount)" class="badge badge-danger badge-pill">Approve</a>
                                                    </div>
