<%@ Page Title="" Language="C#" MasterPageFile="AdminMaster.master" AutoEventWireup="true" CodeFile="Viewallmember.aspx.cs" Inherits="Root_Administrator_Viewallmember" %>
    ...
    <script>
        ...
        app.controller("myCntrl", function ($scope, $http, $timeout, $filter) {
            ...
            $scope.ServiceBBPS = function (id, actions) {
                ReadServiceBBPS(id, actions);
            }
            function ReadServiceBBPS(id, actions) {
                var ID = id;
                $http({
                    url: '../Administrator/Viewallmember.aspx/ServiceBBPS',
                    method: "POST",
                    data: { msrno: id, action: actions }
                }).success(function (response) {
                    showSwal('success-message');
                                    ...
                                    <table id="example1" class="table table-bordered table-hover" class="jsgrid-table">
                                        <thead>
                                            ...
                                            <tr dir-paginate="x in Employees|filter:search|itemsPerPage:pageSize">
                                                ...
                                                <td><a href="#" ng-click="ServiceBBPS(x.MsrNo,x.New_BBPS)" class="badge badge-danger badge-pill">{{x.New_BBPS}}</a></td>
                                                            ...
                                                            <tr>
                                                                <td colspan="3">
                                                                    <table class="table table-bordered" style="width: 100%;">
                                                                        ...
                                                                        <tr>
                                                                            <td>{{y.O_documentnumber}}
                                                                            </td>
                                                                            <td colspan="2">{{y.D_documentnumber}}
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td class="auto-style1">
                                                                        ...
                                                                        <tr>
                                                                            <td class="auto-style1">{{y.O_Name}}
                                                                            </td>
                                                                            <td class="auto-style1" colspan="2">{{y.D_Name}}
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td class="auto-style1">
                                                                        ...
                                                                        <tr>
                                                                            <td class="auto-style1">{{y.O_FatherName}}
                                                                            </td>
                                                                            <td class="auto-style1" colspan="2">{{y.D_FatherName}}
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td>
                                                                        ...
                                                                        <tr>
                                                                            <td class="auto-style1">{{y.Address}}
                                                                            </td>
                                                                            <td colspan="2" class="auto-style1">{{y.address1}}
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td>
