<%@ Page Title="" Language="C#" MasterPageFile="AdminMaster.master" AutoEventWireup="true" CodeFile="Manageservicesettings.aspx.cs" Inherits="Portals_Admin_Manageservicesettings" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="content-wrapper">
        <div class="page-header">
            <h3 class="page-title">Manage service Fees
            </h3>
        </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-8">
                                        <asp:DropDownList ID="ddlservice" runat="server" Height="35px" CssClass="form-control" AutoPostBack="true">
                                            ...
                                            <asp:ListItem>Emitra</asp:ListItem>
                                           <%-- <asp:ListItem>Residential Certificate</asp:ListItem>
                                            <asp:ListItem>Caste Certificate</asp:ListItem>
                                            <asp:ListItem>Passport services</asp:ListItem>--%>
                                        </asp:DropDownList>
