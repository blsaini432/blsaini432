<%@ Page Title="" Language="C#" MasterPageFile="AdminMaster.master" AutoEventWireup="true" CodeFile="Aeps_ManageCommission.aspx.cs" Inherits="Root_Admin_Aeps_ManageCommission" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="content-wrapper">
        <div class="page-header">
            <h3 class="page-title">Manage AEPS Commission
            </h3>
        </div>
                                    ...
                                    <asp:GridView ID="gvOperator" runat="server"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Edit">
                                                <ItemTemplate>
                                                    <asp:Button ID="btnedit" runat="server" Text="Edit" CssClass="btn btn-primary btn-icon-text" CommandName="medit" CommandArgument='<%#Container.DataItemIndex+1 %>' />
                                                    <asp:Button ID="btndelete" runat="server" Text="Delete" CssClass="btn btn-warning btn-icon-text"  CommandName="mdelete" CommandArgument='<%#Container.DataItemIndex+1 %>' />
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                        </Columns>
                                        <EmptyDataTemplate>
