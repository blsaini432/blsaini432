...
public partial class Root_Admin_panreport : System.Web.UI.Page
{
    ...
    public void fillpanreportbydate(string fromdate, string todate)
    {
        ...
        if (TxnID.Text != "")
        {
            _lstparm.Add(new ParmList() { name = "@action", value = "adminftrtxnid" });
        ...
        {
            _lstparm.Add(new ParmList() { name = "@action", value = "adminftrname" });
            _lstparm.Add(new ParmList() { name = "@status", value = ddl_stauts.SelectedItem.ToString() });
            _lstparm.Add(new ParmList() { name = "@MemberName", value = txt_name.Text.ToString() });
