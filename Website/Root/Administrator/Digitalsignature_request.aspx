<%@ Page Title="" Language="C#" MasterPageFile="~/Root/Administrator/adminmaster.master" AutoEventWireup="true"
    CodeFile="Digitalsignature_request.aspx.cs" Inherits="Portal_Administrator_Digitalsignature_request" %>
    ...
    <script>
        ...
        app.controller("myCntrl", function ($scope, $http, $timeout, $filter) {
            ...
            $scope.fillfundrequest = function () {
                ...
                var httpreq = {
                    method: 'POST',
                    url: '../Administrator/Digitalsignature_request.aspx/fillposrequest',
                    headers: {
            ...
            $scope.fillfundrequestbydate = function (fdate, tdate) {
                ...
                var httpreq = {
                    method: 'POST',
                    url: '../Administrator/Digitalsignature_request.aspx/fillposrequestbydate',
                    headers: {
                        'Content-Type': 'application/json; charset=utf-8',
                        'dataType': 'json'
                    },
            ...
            function ApproveRequest(id) {
                var ID = id;
                $http({
                    url: '../Administrator/Digitalsignature_request.aspx/ApproveRequest',
                    method: "POST",
                    headers: {
                        'Content-Type': 'application/json; charset=utf-8',
                        'dataType': 'json'
           ...
           $scope.clentdata = function (id) {
            ...
            function clentdata(id) {
                var ID = id;
                $http({
                    url: '../Administrator/Digitalsignature_request.aspx/clientdata',
                    method: "POST",
                    headers: {
                        'Content-Type': 'application/json; charset=utf-8',
                        'dataType': 'json'
            ...
            function RejectRequest(id) {
                var ID = id;
                $http({
                    url: '../Administrator/Digitalsignature_request.aspx/RejectRequest',
                    method: "POST",
                    headers: {
                        'Content-Type': 'application/json; charset=utf-8',
                        'dataType': 'json'
            ...
            function FundImage(id) {
                var ID = id;
                $http({
                    url: '../Administrator/Digitalsignature_request.aspx/ShowFundImage',
                    method: "POST",
                    headers: {
                        'Content-Type': 'application/json; charset=utf-8',
                        'dataType': 'json'
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="content-wrapper">
        <div class="page-header">
            <h3 class="page-title">Digital signature Request List
            </h3>
        </div>
                                        ...
                                        <div class="card">
                                            <div class="card-body" ng-repeat="y in fundimage">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-3">
                                                         <label style="color:green">AddressProof </label>
                                                        <a href="../Upload/PanCardRequest/Actual/{{y.AddressProof}}" target="_blank" />
                                                        <img src="../Upload/PanCardRequest/Actual/{{y.AddressProof}}" alt="No Image Available" height="200" width="200" />
                                                    </div>
                                                    <div class="col-lg-3">
                                                         <label style="color:green">ageProof</label>
