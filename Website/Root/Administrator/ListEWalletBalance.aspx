                                ...
                                <div class="table-responsive">
                                    ...
                                    <table id="example1" class="table table-bordered table-hover" class="jsgrid-table">
                                        <thead>
                                            ...
                                            <tr dir-paginate="x in EBalance|filter:search|itemsPerPage:pageSize">
                                                <td>{{$index + 1}}</td>
                                                <td>{{x.MemberID}}</td>
                                                <td>{{x.MemberName}}</td>
                                                ...
                                                <td>{{x.Balance}}</td>
                                                <td><a href="ListEWalletTransaction.aspx?id={{x.MsrNo}}" class="badge badge-success badge-pill" title="click to view member detail">View</a></td>
                                            </tr>
                                             <tr>
                                                <td ng-show="EBalance.length==0" colspan="14">
