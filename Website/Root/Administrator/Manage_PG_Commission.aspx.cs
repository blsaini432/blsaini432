...
public partial class Root_Admin_Manage_PG_Commission : System.Web.UI.Page
{
    #region [Properties]
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            objconnection.select_data_dtNew("sp_set_PG_Commission ", _lstparm);
            ...
            for (int j = 0; j < dt.Rows.Count; j++)
            {
                ...
                objconnection.select_data_dtNew("sp_set_PG_Commission ", _lstparmS);
            }
    ...
    protected void ddlPackage_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        {
            dtOperator = objconnection.select_data_dt("Exec MM_PG_commision 0,'" + ddlPackage.SelectedValue + "','0',0");
