<%@ Page Language="C#" MasterPageFile="~/Root/Administrator/AdminMaster.master" AutoEventWireup="true" CodeFile="Add_linkedit.aspx.cs" Inherits="Root_Administrator_Add_linkedit" %>
                                ...
                                <asp:GridView ID="gvImage" runat="server" CssClass="table table-bordered table-responsive"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField HeaderText="Title" DataField="Title" SortExpression="id" />
                                          <asp:BoundField HeaderText="Link" DataField="Link" SortExpression="id" />
