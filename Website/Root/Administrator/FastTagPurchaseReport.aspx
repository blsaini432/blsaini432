<%@ Page Title="" Language="C#" MasterPageFile="~/Root/Administrator/adminmaster.master" AutoEventWireup="true" CodeFile="FastTagPurchaseReport.aspx.cs" Inherits="Root_Administrator_FastTagPurchaseReport" %>
...
<div id="toPopup">
    ...
    <div class="content-header">
        <h1>
            List FastTagPurchase Request <small>Admin Panel</small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i>Admin</a></li>
            <li class="active">List FastTagPurchase Request</li>
        </ol>
    </div>
                                            ...
                                            <Columns>
                                                ...
                                                <asp:BoundField HeaderText="ezulixtranid" DataField="EzulixTranid" SortExpression="ezulixtranid" />
                                                 <asp:BoundField HeaderText="Amount" DataField="Amount" SortExpression="Amount" />
                                                  <asp:BoundField HeaderText="Nooffasttag" DataField="Nooffasttag" SortExpression="Nooffasttag" />
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="content-wrapper">
        <div class="page-header">
            <h3 class="page-title">List FastTagPurchase Request 
            </h3>
        </div>
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            <ContentTemplate>
