<%@ Page Title="" Language="C#" MasterPageFile="AdminMaster.master" AutoEventWireup="true" CodeFile="Viewallmember_mysun.aspx.cs" Inherits="Root_Administrator_Viewallmember" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script>
        ...
        app.controller("myCntrl", function ($scope, $http, $timeout, $filter) {
            ...
            $scope.ServiceBanknew = function (id, actions) {

                ReadInstantBsServicexp(id, actions);
            }
            function ReadInstantBsServicexp(id, actions) {
                var ID = id;
                $http({
                    url:'../Administrator/Viewallmember.aspx/updatebankdetailsnew',
                    method: "POST",
                    data: { msrno: id, action: actions }
                }).success(function (response) {
                    showSwal('success-message');
            ...
            $scope.service247payout = function (id, actions) {

                ReadI24Servicexp(id, actions);
            }
            function ReadI24Servicexp(id, actions) {
                var ID = id;
                $http({
                    url: '../Administrator/Viewallmember.aspx/update24payout',
                    method: "POST",
                    data: { msrno: id, action: actions }
                }).success(function (response) {
                    showSwal('success-message');
            ...
            $scope.serviceutigateway = function (id, actions) {

                Readutigateway(id, actions);
            }
            function Readutigateway(id, actions) {
                var ID = id;
                $http({
                    url: '../Administrator/Viewallmember.aspx/updateutigateway',
                    method: "POST",
                    data: { msrno: id, action: actions }
                }).success(function (response) {
                    showSwal('success-message');
            ...
            $scope.Servicebbps = function (id, actions) {

                ReadInstantServic(id, actions);
            }
            function ReadInstantServic(id, actions) {
                var ID = id;
                $http({
                    url: '../Administrator/Viewallmember.aspx/updatebbps',
                    method: "POST",
                    data: { msrno: id, action: actions }
                }).success(function (response) {
                    showSwal('success-message');
                                ...
                                <div class="table-responsive">
                                       <div id="loader" style='display: none;'>
                                        <img src='../../Design/images/pageloader.gif' width='32px' height='32px'>
                                          ...
                                          <div ng-if="!loaded" align="center"><img src="../../Design/images/pageloader.gif" /></div>
                                    <div ng-if="loaded">
                                    <table id="example1" class="table table-bordered table-hover" class="jsgrid-table">
                                        <thead>
                                            ...
                                            <tr dir-paginate="x in Employees|filter:search|itemsPerPage:pageSize">
                                               ...
                                               <%--  <td><a href="#" ng-click="service247payout(x.MsrNo,x.instantpayout)" class="badge badge-danger badge-pill">{{x.instantpayout}}</a></td>
                                                 <td><a href="#" ng-click="serviceutigateway(x.MsrNo,x.utigateway)" class="badge badge-danger badge-pill">{{x.utigateway}}</a></td>--%>
                                               <td><a href="#" ng-click="Servicebbps(x.MsrNo,x.isbbps)" class="badge badge-danger badge-pill">{{x.isbbps}}</a></td>
                                               <%-- 
                                                 <td>
                                                ...
                                                <td><a href="#openModalbank" ng-click="Read(x.MsrNo)" class="badge badge-success badge-pill" title="click to view member detail">View BankDetail</a></td>
                                                  <td><a href="#" ng-click="ServiceBanknew(x.MsrNo,x.isbankps)" class="badge badge-danger badge-pill">{{x.isbankps}}</a></td>
                                ...
                                <div>
                                    ...
                                    <div class="modal-body">
                                                ...
                                                <div class="form-group row">
                                                   ...
                                                   <div class="form-group row">
                                                    <div class="col-lg-3">
                                                        <label class="col-form-label">PassBookImage<code>*</code></label>
                                                    </div>
                                                    <div class="col-lg-8">
                                                        <a href="{{y.bankps}}" target="_blank"><img src="{{y.bankps}}" height="300px" width="300px"/></a>
                                                        <label class="col-form-label">{{y.bankps}}</label>
                                                    </div>
                                                </div>
