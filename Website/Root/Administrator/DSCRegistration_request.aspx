<%@ Page Title="" Language="C#" MasterPageFile="~/Root/Administrator/Adminmaster.master" AutoEventWireup="true"
    CodeFile="DSCRegistration_request.aspx.cs" Inherits="Root_Admin_DSCRegistration_request" %>
    ...
    <script>
        ...
        app.controller("myCntrl", function ($scope, $http, $timeout, $filter) {
            ...
            $scope.fillfundrequest = function () {
                ...
                var httpreq = {
                    method: 'POST',
                    url: '../Administrator/DSCRegistration_request.aspx/fillposrequest',
                    headers: {
            ...
            $scope.fillfundrequestbydate = function (fdate, tdate) {
                ...
                var httpreq = {
                    method: 'POST',
                    url: '../Administrator/DSCRegistration_request.aspx/fillposrequestbydate',
                    headers: {
                        'Content-Type': 'application/json; charset=utf-8',
                        'dataType': 'json'
                    },
            ...
            function ApproveRequest(id) {
                var ID = id;
                $http({
                    url: '../Administrator/DSCRegistration_request.aspx/ApproveRequest',
                    method: "POST",
                    headers: {
                        'Content-Type': 'application/json; charset=utf-8',
                        'dataType': 'json'
            ...
            function clentdata(id) {
                var ID = id;
                $http({
                    url: '../Administrator/DSCRegistration_request.aspx/clientdata',
                    method: "POST",
                    headers: {
                        'Content-Type': 'application/json; charset=utf-8',
                        'dataType': 'json'
            ...
            function RejectRequest(id) {
                var ID = id;
                $http({
                    url: '../Administrator/DSCRegistration_request.aspx/RejectRequest',
                    method: "POST",
                    headers: {
                        'Content-Type': 'application/json; charset=utf-8',
                        'dataType': 'json'
            ...
            function FundImage(id) {
                var ID = id;
                $http({
                    url: '../Administrator/DSCRegistration_request.aspx/ShowFundImage',
                    method: "POST",
                    headers: {
                        'Content-Type': 'application/json; charset=utf-8',
                        'dataType': 'json'
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="content-wrapper">
        <div class="page-header">
            <h3 class="page-title">DSC Registration Request List
            </h3>
        </div>
                                    ...
                                    <div class="modal-body">
                                        <div class="card">
                                                ...
                                                <div class="form-group row">
                                                   ...
                                                   <%-- <div class="col-lg-3">
                                                    ...
                                                    <div class="col-lg-3">
                                                        ...
                                                        <a href="../../Uploads/Servicesimage/Actual/{{y.actphoto}}" target="_blank" />
                                                        <img src="../../Uploads/Servicesimage/Actual/{{y.actphoto}}" alt="click" height="200" width="200" />
                                                    </div>
                                                    <%-- <div class="col-lg-3">
                                                         <label style="color:green">Files</label>
                                                        <a href="../Uploads/Servicesimage/Actual/{{y.sign}}" target="_blank" />
                                                        <img src="../Uploads/Servicesimage/Actual/{{y.sign}}" alt="click" height="200" width="200" />
                                                    </div>--%>
                                            ...
                                            <%--    <div class="form-group row">
                                                  ...
                                                  <div class="col-lg-3">
                                                         <label style="color:green">Declaration form</label>
