...
public partial class Root_Admin_panreport : System.Web.UI.Page
{
    ...
    public void fillpanreportbydate(string fromdate, string todate,string txnid)
    {
        ...
        if (TxnID.Text != "")
        {
            _lstparm.Add(new ParmList() { name = "@action", value = "admintranid" });
    ...
    protected void gvBookedBusList_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        if (e.CommandName == "downloadmerge")
        {
            ...
            string path1 = "http://atempay.com/Uploads/Servicesimage/Actual/" + array[0];
            string path2 = "http://atempay.com/Uploads/Servicesimage/Actual/" + array[1];
