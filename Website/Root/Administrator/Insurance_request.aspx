<%@ Page Title="" Language="C#" MasterPageFile="~/Root/Administrator/AdminMaster.master" AutoEventWireup="true" CodeFile="Insurance_request.aspx.cs" Inherits="Root_Administrator_Insurance_request" %>
                                        ...
                                        <asp:GridView ID="gvBookedBusList" runat="server" CssClass="table table-bordered table-hover"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderStyle-Width="30px">
                                                    ...
                                                    <asp:TemplateField HeaderText="RCImagefront">
                                                        <ItemTemplate>
                                                            <a href="../../Uploads/InsuranceRequest/Actual/<%# Eval("RCImagefront") %>" target="_blank">Download</a>
                   
                                                        </ItemTemplate>
                                                    </asp:TemplateField>  
                                                <asp:TemplateField HeaderText="RCImageback">
                                                        <ItemTemplate>
                                                            <a href="../../Uploads/InsuranceRequest/Actual/<%# Eval("RCImageback") %>" target="_blank">Download</a>
                   
                                                        </ItemTemplate>
                                                    </asp:TemplateField>   
                                                 <asp:TemplateField HeaderText="LastInsurance">
                                                        <ItemTemplate>
                                                            <a href="../../Uploads/InsuranceRequest/Actual/<%# Eval("LastInsurance") %>" target="_blank">Download</a>
