<%@ Page Title="" Language="C#" MasterPageFile="~/Root/Administrator/AdminMaster.master" AutoEventWireup="true" CodeFile="DmrNewTranscation.aspx.cs" Inherits="Root_Admin_DmrNewTranscation" %>
    ...
    <script>
        ...
        app.controller("myCntrl", function ($scope, $http, $timeout, $filter) {
            ...
            function CheckBStatus(id)
            {
                ...
                $http({
                    url: '../Administrator/DmrNewTranscation.aspx/CheckStatus',
                    method: "POST",
                    headers: {
                        'Content-Type':'application/json; charset=utf-8',
                        'dataType': 'json'
            ...
            $scope.FailStatus = function (id) {
                $("#loader").show();
                FailBStatus(id);
            }
            function FailBStatus(id) {
                var ID = id;
                debugger;
                $scope.dataList = [];
                ...
                $http({
                    url: '../Administrator/DmrNewTranscation.aspx/FailStatus',
                    method: "POST",
                    headers: {
                        'Content-Type': 'application/json; charset=utf-8',
                        'dataType': 'json'
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
     <div class="content-wrapper">
        <div class="page-header">
            <h3 class="page-title">X-Press DMR Transactions
            </h3>
        </div>
                                        ...
                                        <thead>
                                            ...
                                            <tr dir-paginate="x in dmrnewreport|filter:search|itemsPerPage:pageSize">
                                               ...
                                               <td>{{x.ApiTxnID}}</td>
                                                ...
                                                <td>{{x.Createdate}}</td>
                                                   <td>
                                                    <div ng-if="x.Status!=='ACCEPTED'">
                                                        {{x.Status}}
                                                    </div>
                                                    <div ng-if="x.Status==='ACCEPTED'">
                                                        <a href="#" ng-click="CheckStatus(x.TxnID)" class="badge badge-danger badge-pill">CheckStatus</a>
                                                    </div>
                                                </td>
                                                 ...
                                                 <td>
                                                    ...
                                                    <div ng-if="x.Status==='Pending'">
                                                        <a href="#" ng-click="FailStatus(x.TxnID)" class="badge badge-danger badge-pill">Fail</a>
                                                    </div>
                                                </td>
                                            </tr>
                                             <tr>
