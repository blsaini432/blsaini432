<%@ Page Title="" Language="C#" MasterPageFile="~/Root/Administrator/AdminMaster.master" AutoEventWireup="true" CodeFile="LICPremium_Report.aspx.cs" Inherits="Root_Admin_LICPremium_Report" %>
    ...
    <script>
        ...
        app.controller("myCntrl", function ($scope, $http, $timeout, $filter) {
            ...
            $scope.filldmrnewreport = function () {
                ...
                var httpreq = {
                    method: 'POST',
                    url: '../Administrator/LICPremium_Report.aspx/fillnewdmrreport',
                    headers: {
            ...
            $scope.filldmrnewreportbydate = function (fdate, tdate) {
                ...
                var httpreq = {
                    method: 'POST',
                    url: '../Administrator/LICPremium_Report.aspx/fillnewdmrreportbydate',
                    headers: {
                        'Content-Type': 'application/json; charset=utf-8',
                        'dataType': 'json'
                    },
            ...
            function ApproveBRequest(id) {
                var ID = id;
                $http({
                    url: '../Administrator/LICPremium_Report.aspx/ApproveRequest',
                    method: "POST",
                    headers: {
                        'Content-Type': 'application/json; charset=utf-8',
                        'dataType': 'json'
            ...
            function RejectBRequest(id) {
                var ID = id;
                $http({
                    url: '../Administrator/LICPremium_Report.aspx/RejectRequest',
                    method: "POST",
                    headers: {
                        'Content-Type': 'application/json; charset=utf-8',
                        'dataType': 'json'
                                    ...
                                    <table id="tblEwalletsummary" class="table table-bordered table-hover">
                                        <thead>
                                            ...
                                            <%--   <td>{{x.policy_paylastdate}}</td>--%>
                                                ...
                                                <td>{{x.Createdate}}</td>
                                                <td>
                                                    <div ng-if="x.adminstatus==='pending'">
                                                        <a href="#openModalstatus" ng-click="ApproveRequest(x.TxnID)" class="badge badge-success badge-pill">Approve</a>
