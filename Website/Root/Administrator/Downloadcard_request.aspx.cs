...
public partial class Root_Administrator_Downloadcard_request : System.Web.UI.Page
{
    #region [Properties]
    ...
    private void fillEmployee()
    {
        ...
        dtEmployee = cls.select_data_dtNew("Proc_downloadcard", _list);
    ...
    //            cls.update_data("update ITR_new set RequestStatus='Success',RefNo='" + txt_refno.Text + "', Remarks='" + txtadminRemark.Text.Trim() + "',ModifiedDate=getdate() where ITRkid=" + Convert.ToInt32(hdnid.Value) + "");
    ...
    protected void btnFail_Click(object sender, EventArgs e)
    {
        ...
        DataTable dt = new DataTable();
        dt = cls.select_data_dt("select * from tbl_downloads  where id='" + hdnid.Value + "'");
        if (dt.Rows.Count > 0)
        {
            ...
            {
                cls.update_data("update tbl_downloads set files='" + Photo + "' where id=" + Convert.ToInt32(hdnid.Value) + "");
