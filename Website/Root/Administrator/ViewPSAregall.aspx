<%@ Page Title="" Language="C#" MasterPageFile="~/Root/Administrator/AdminMaster.master" AutoEventWireup="true" CodeFile="ViewPSAregall.aspx.cs" Inherits="Portals_Admin_ViewPSAregall" %>
    ...
    <script>
        ...
        app.controller("myCntrl", function ($scope, $http, $timeout, $filter) {
            ...
            $scope.fillpsareport = function () {
                ...
                var httpreq = {
                    method: 'POST',
                    url: '../Administrator/ViewPSAregall.aspx/fillpsareport',
                    headers: {
            ...
            $scope.fillpsareportbydate = function (fdate, tdate) {
                ...
                var httpreq = {
                    method: 'POST',
                    url: '../Administrator/ViewPSAregall.aspx/fillpsareportbydate',
                    headers: {
                        'Content-Type': 'application/json; charset=utf-8',
                        'dataType': 'json'
                    },
            ...
            function ApproveBRequest(id) {
                ...
                $http({
                    url: '../Administrator/ViewPSAregall.aspx/ApprovePSARequest',
                    method: "POST",
                    headers: {
                        'Content-Type': 'application/json; charset=utf-8',
                        'dataType': 'json'
            ...
            function RejectBRequest(id) {
                ...
                $http({
                    url: '../Administrator/ViewPSAregall.aspx/RejectPSARequest',
                    method: "POST",
                    headers: {
                        'Content-Type': 'application/json; charset=utf-8',
                        'dataType': 'json'
