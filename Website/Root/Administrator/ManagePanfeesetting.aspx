<%@ Page Title="" Language="C#" MasterPageFile="AdminMaster.master" AutoEventWireup="true" CodeFile="ManagePanfeesetting.aspx.cs" Inherits="Portals_Admin_ManagePanfeesetting" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="content-wrapper">
        <div class="page-header">
            <h3 class="page-title">Manage Pan Fees Setting
            </h3>
        </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    <div class="col-lg-3">
                                        <label class="col-form-label">Pan Amount<code>*</code></label>
                                    </div>
                                    <div class="col-lg-8">
