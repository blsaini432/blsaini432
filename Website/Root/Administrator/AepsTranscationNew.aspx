<%@ Page Title="" Language="C#" MasterPageFile="~/Root/Administrator/AdminMaster.master" AutoEventWireup="true" CodeFile="AepsTranscationNew.aspx.cs" Inherits="Root_Admin_AepsTranscationNew" %>
                        ...
                        <div class="container" ng-app="myApp" ng-controller="myCntrl">
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group row">
                                        <div class="col-sm-6">
                                            <a href="#" ng-click="fillaepsbanktransactionbydate(from_date,to_date)" class="btn btn-primary">Search &gt;&gt;</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="table-responsive">
                                    <table id="tblEwalletsummary" class="table table-bordered table-hover">
                                        <thead>
                                            ...
                                            <tr dir-paginate="x in aepstransactionreport|filter:search|itemsPerPage:pageSize">
                                                <td>{{$index + 1}}</td>
                                                <td>{{x.memberid}}</td>
                                                <td>{{x.Member_Name}}</td>
                                             ...
                                             <tr>
                                                <td ng-show="aepstransactionreport.length==0" colspan="13">
