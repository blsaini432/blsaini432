<%@ Page Title="" Language="C#" MasterPageFile="~/Root/Administrator/Adminmaster.master" AutoEventWireup="true"
    CodeFile="Account_Report.aspx.cs" Inherits="Portal_Admin_Account_Report" %>
    ...
    <script>
        ...
        app.controller("myCntrl", function ($scope, $http, $timeout, $filter) {
            ...
            $scope.fillfundrequest = function () {
                ...
                var httpreq = {
                    method: 'POST',
                    url: '../Administrator/Account_Report.aspx/fillposrequest',
                    headers: {
            ...
            $scope.fillfundrequestbydate = function (fdate, tdate) {
                ...
                var httpreq = {
                    method: 'POST',
                    url: '../Administrator/Account_Report.aspx/fillposrequestbydate',
                    headers: {
                        'Content-Type': 'application/json; charset=utf-8',
                        'dataType': 'json'
                    },
            ...
            function ApproveRequest(id) {
                var ID = id;
                $http({
                    url: '../Administrator/Account_Report.aspx/ApproveRequest',
                    method: "POST",
                    headers: {
                        'Content-Type': 'application/json; charset=utf-8',
                        'dataType': 'json'
            ...
            function clentdata(id) {
                var ID = id;
                $http({
                    url: '../Administrator/Account_Report.aspx/clientdata',
                    method: "POST",
                    headers: {
                        'Content-Type': 'application/json; charset=utf-8',
                        'dataType': 'json'
            ...
            function RejectRequest(id) {
                var ID = id;
                $http({
                    url: '../Administrator/Account_Report.aspx/RejectRequest',
                    method: "POST",
                    headers: {
                        'Content-Type': 'application/json; charset=utf-8',
                        'dataType': 'json'
            ...
            function FundImage(id) {
                var ID = id;
                $http({
                    url: '../Administrator/Account_Report.aspx/ShowFundImage',
                    method: "POST",
                    headers: {
                        'Content-Type': 'application/json; charset=utf-8',
                        'dataType': 'json'
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="content-wrapper">
        <div class="page-header">
            <h3 class="page-title">Account Open  Request List
            </h3>
        </div>
                                            ...
                                            <div class="card-body" ng-repeat="y in fundimage">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <a href="../../Uploads/Servicesimage/Actual/{{y.pan_image}}" target="_blank" />
                                                        <img src="../../Uploads/Servicesimage/Actual/{{y.pan_image}}" alt="No Image Available" height="200" width="200" />
                                                    </div>
                                                    <div class="col-lg-4">
                                                         <label style="color:green">aadharcard</label>
                                                        <a href="../../Uploads/Servicesimage/Actual/{{y.aadhar_image}}" target="_blank" />
                                                        <img src="../../Uploads/Servicesimage/Actual/{{y.aadhar_image}}" alt="No Image Available" height="200" width="200" />
                                                    </div>
