...
public partial class Root_Admin_Aeps_ManageCommission : System.Web.UI.Page
{
    #region [Properties]
    ...
    protected void ddlPackage_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        {
            dtOperator = objconnection.select_data_dt("Exec MM_AEPScommision 0,'" + ddlPackage.SelectedValue + "','0',0");
