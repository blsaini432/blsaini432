...
public partial class Root_Admin_AEPSTransactionss : System.Web.UI.Page
{
    ...
    public static List<Customer> fillaepstransactions()
    {
        ...
        HttpContext.Current.Session["totalamount"] = dtEWalletTransaction.Compute("sum(Amount)", "").ToString();
        foreach (DataRow dtrow in dtEWalletTransaction.Rows)
        {
           ...
           // HttpContext.Current.Session["datetotalyesaeps"] = dtrow["total"].ToString();
