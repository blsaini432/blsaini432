...
using BLL;
using System.IO;
public partial class Portals_Admin_ManagePanfeesetting : System.Web.UI.Page
{
    #region [PageLoad]
    ...
    public void package()
    {
        ...
        dd = cls.select_data_dtNew("Sp_ManagensdlpanSetting ", _lstparm);
        if (dd.Rows.Count > 0)
        {
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            cls_connection cls = new cls_connection();
            dt = cls.select_data_dtNew("Sp_ManagensdlpanSetting ", _lstparm);
            if (dt.Rows.Count > 0)
            {
                if (Convert.ToDecimal(txtcomission.Text) > 0)
                {
                    ...
                    cls.select_data_dtNew("Sp_ManagensdlpanSetting ", _lstparms);
