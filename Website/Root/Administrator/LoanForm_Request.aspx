<%@ Page Title="" Language="C#" MasterPageFile="~/Root/Administrator/AdminMaster.master" AutoEventWireup="true"
    CodeFile="LoanForm_Request.aspx.cs" Inherits="Portal_Admin_Voteridrequest" %>
        ...
        <ContentTemplate>
            <div class="content-wrapper">
                <div class="page-header">
                    <h3 class="page-title">List Loan Request
                    </h3>
                </div>
                                                                ...
                                                                <asp:Panel ID="Panel1" runat="server" ScrollBars="Both" Width="100%">
                                                                    <asp:GridView ID="gvBookedBusList" runat="server" CssClass="table table-striped table-bordered bootstrap-datatable datatable responsive SmallText table-responsive"
                                                                        ...
                                                                        <Columns>
                                                                            ...
                                                                            <asp:BoundField HeaderText="Txn_id" DataField="Acknowledgement_No" SortExpression="Acknowledgement_No" />
                                                                            <asp:BoundField HeaderText="Date" DataField="addDate" SortExpression="addDate" />
                                                                            ...
                                                                            <asp:TemplateField HeaderText="aadhar Card">
                                                                                <ItemTemplate>
                                                                                    <a href="../Upload/PanCardRequest/Actual/<%# Eval("aadharcard") %>" target="_blank">
                                                                                        DOWNLOAD
                                                                            ...
                                                                            <asp:TemplateField HeaderText="Pan Card  ">
                                                                                <ItemTemplate>
                                                                                    <a href="../Upload/PanCardRequest/Actual/<%# Eval("ageProof") %>" target="_blank">
                                                                                        DOWNLOAD
                                                                            ...
                                                                            <asp:TemplateField HeaderText="ITR">
                                                                                <ItemTemplate>
                                                                                    <a href="../Upload/PanCardRequest/Actual/<%# Eval("mothername") %>" target="_blank">
                                                                                        DOWNLOAD
                                                                            ...
                                                                            <asp:TemplateField HeaderText="Bank Statement">
                                                                                <ItemTemplate>
                                                                                    <a href="../Upload/PanCardRequest/Actual/<%# Eval("fathername") %>" target="_blank">
                                                                                        DOWNLOAD
                                                                            ...
                                                                            <asp:TemplateField HeaderText="Approve.">
                                                                                <ItemTemplate>
                                                                                    <asp:Button ID="Approve" runat="server" Text="Approve" CommandArgument='<%#Eval("passport_id") %>'
                                                                            ...
                                                                            <asp:TemplateField HeaderText="Reject.">
                                                                                <ItemTemplate>
                                                                                    <asp:Button ID="Reject" runat="server" Text="Reject" CommandArgument='<%#Eval("passport_id") %>'
