<%@ Page Title="" Language="C#" MasterPageFile="~/Root/Administrator/AdminMaster.master" AutoEventWireup="true"
    CodeFile="ListEWalletTransaction.aspx.cs" Inherits="Root_Admin_ListEWalletTransaction" %>
                                ...
                                <div class="table-responsive">
                                    ...
                                    <table id="tblEwalletsummary" class="table table-bordered table-hover">
                                        <thead>
                                            ...
                                            <tr dir-paginate="x in EBalanceSummary|filter:search|itemsPerPage:pageSize">
                                                <td>{{$index + 1}}</td>
                                                <td>{{x.MemberID}}</td>
                                                <td>{{x.date}}</td>
                                                <td>{{x.narration}}</td>
                                               ...
                                               <tr>
                                                <td ng-show="EBalanceSummary.length==0" colspan="14">
