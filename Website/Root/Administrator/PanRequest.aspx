<%@ Page Title="" Language="C#" MasterPageFile="~/Root/Administrator/AdminMaster.master" AutoEventWireup="true" CodeFile="PanRequest.aspx.cs" Inherits="Root_Admin_panreport" %>
                    ...
                    <div class="card-body">
                        <div class="container">
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group row">
                                        <label class="col-sm-2 col-form-label">Name<code>*</code></label>
                                        <div class="col-sm-6">
                                        ...
                                        <div class="box-content">
                                            <asp:GridView ID="gvBookedBusList" runat="server" CssClass="table table-responsive"
                                                ...
                                                <Columns>
                                                   ...
                                                   <%-- <asp:TemplateField HeaderText="Form A">
                                                        <ItemTemplate>
                                                            <a href="../../Uploads/Servicesimage/Actual/<%# Eval("formA") %>" target="_blank" class="btn btn-info">Download
                                                            </a>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>--%>
                                                    <asp:TemplateField HeaderText=" Final PDF">
                                                        <ItemTemplate>
                                                            <asp:Button ID="btndownloadmerge" runat="server" Text='Download' CssClass="btn btn-dark" Visible='<%# Convert.ToString(Eval("ReciptImg"))!=""?true:false %>' CommandName="downloadmerge" CommandArgument='<%# Eval("ReciptImg")+ "|" + Eval("AddProof") + "|" + Eval("RefNo") %>' />
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                    <asp:TemplateField HeaderText="Client Data">
                                                        <ItemTemplate>
                                                            <asp:Button ID="btnWord" runat="server" Text="Download" CommandArgument='<%#Eval("Pankid") %>'
                                                                CommandName="WordDownload" ToolTip="Download Excal File" CssClass="btn btn-dark" />
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                    ...
                                                    <asp:TemplateField HeaderText="Remarks">
                                                        <ItemTemplate>
                                                            <asp:TextBox ID="txt_remarks" runat="server" TextMode="MultiLine" style="height:66px" Text='<%#Eval("Remarks") %>' Enabled='<%#Eval("Status").ToString() == "Pending" ? true :false %>'></asp:TextBox>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
