<%@ Page Title="" Language="C#" MasterPageFile="~/Root/Administrator/AdminMaster.master" AutoEventWireup="true" CodeFile="Passportservices_Request.aspx.cs" Inherits="Root_Admin_Passportservices_Request" %>
    ...
    <script>
        ...
        app.controller("myCntrl", function ($scope, $http, $timeout, $filter) {
            ...
            $scope.fillbbpsnewreport = function () {
                ...
                var httpreq = {
                    method: 'POST',
                    url: '../Administrator/Passportservices_Request.aspx/pancardreport',
                    headers: {
            ...
            $scope.fillbbpsnewreportbydate = function (fdate, tdate) {
                ...
                var httpreq = {
                    method: 'POST',
                    url: '../Administrator/Passportservices_Request.aspx/pancardreporttbydate',
                    headers: {
                        'Content-Type': 'application/json; charset=utf-8',
                        'dataType': 'json'
                    },
            ...
            function ApproveBRequest(id) {
                ...
                $http({
                    url: '../Administrator/Passportservices_Request.aspx/ApproveRequest',
                    method: "POST",
                    headers: {
                        'Content-Type': 'application/json; charset=utf-8',
                        'dataType': 'json'
            ...
            function RejectBRequest(id) {
                var ID = id;
                $http({
                    url: '../Administrator/Passportservices_Request.aspx/RejectRequest',
                    method: "POST",
                    headers: {
                        'Content-Type': 'application/json; charset=utf-8',
                        'dataType': 'json'
