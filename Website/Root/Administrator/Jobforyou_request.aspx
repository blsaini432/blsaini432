<%@ Page Title="" Language="C#" MasterPageFile="~/Root/Administrator/AdminMaster.master" AutoEventWireup="true" CodeFile="Jobforyou_request.aspx.cs" Inherits="Root_Admin_Jobforyou_request" %>
    ...
    <script>
        ...
        app.controller("myCntrl", function ($scope, $http, $timeout, $filter) {
            ...
            $scope.filldmrnewreport = function () {
                ...
                var httpreq = {
                    method: 'POST',
                    url: '../Administrator/Jobforyou_request.aspx/Jobforyou_request',
                    headers: {
            ...
            $scope.filldmrnewreportbydate = function (fdate, tdate) {
                ...
                var httpreq = {
                    method: 'POST',
                    url: '../Administrator/Jobforyou_request.aspx/Jobforyou_requestbydate',
                    headers: {
                        'Content-Type': 'application/json; charset=utf-8',
                        'dataType': 'json'
                    },
            ...
            function ApproveBRequest(id) {
              ...
              //  var inputVal = $scope.Name;
               // var inputVal = $(event.target).closest('tr').find('#myInpust').val();
                $http({
                    url: '../Administrator/Jobforyou_request.aspx/ApproveRequest',
                    method: "POST",
                    headers: {
                        'Content-Type': 'application/json; charset=utf-8',
                        'dataType': 'json'
            ...
            function RejectBRequest(id, mobile, date,amount) {
                ...
                var amount = amount;
                $http({
                    url: '../Administrator/Institute_Request.aspx/RejectRequest',
                    method: "POST",
                    headers: {
                        'Content-Type': 'application/json; charset=utf-8',
                        'dataType': 'json'
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
     <div class="content-wrapper">
        <div class="page-header">
            <h3 class="page-title">Job for you Request
            </h3>
        </div>
                                        ...
                                        <thead>
                                            ...
                                            <tr dir-paginate="x in dmrnewreport|filter:search|itemsPerPage:pageSize">
                                                ...
                                                <td>{{x.full_address}}</td>
                                                 <td>
                                                 <a href="../../Uploads/Servicesimage/Actual/{{x.Photo}}"  target="_blank"><img alt="{{x.Photo}}" ng-src="../../Uploads/Servicesimage/Actual/{{x.Photo}}"  style="height:100px;width:100px" /></a> 
