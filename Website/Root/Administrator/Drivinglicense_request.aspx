<%@ Page Title="" Language="C#" MasterPageFile="~/Root/Administrator/AdminMaster.master" AutoEventWireup="true"
    CodeFile="Drivinglicense_request.aspx.cs" Inherits="Root_Admin_Drivinglicense_request" %>
    ...
    <script>
        ...
        app.controller("myCntrl", function ($scope, $http, $timeout, $filter) {
            ...
            $scope.fillfundrequest = function () {
                ...
                var httpreq = {
                    method: 'POST',
                    url: '../Administrator/Drivinglicense_request.aspx/fillfundrequest',
                    headers: {
            ...
            $scope.fillfundrequestbydate = function (fdate, tdate) {
                ...
                var httpreq = {
                    method: 'POST',
                    url: '../Administrator/Drivinglicense_request.aspx/fillfundrequestbydate',
                    headers: {
                        'Content-Type': 'application/json; charset=utf-8',
                        'dataType': 'json'
                    },
            ...
            function ApproveRequest(id) {
                var ID = id;
                $http({
                    url: '../Administrator/Drivinglicense_request.aspx/approve',
                    method: "POST",
                    headers: {
                        'Content-Type': 'application/json; charset=utf-8',
                        'dataType': 'json'
            ...
            function RejectRequest(id) {
                var ID = id;
                $http({
                    url: '../Administrator/Drivinglicense_request.aspx/faild',
                    method: "POST",
                    headers: {
                        'Content-Type': 'application/json; charset=utf-8',
                        'dataType': 'json'
            ...
            function FundImage(id) {
                var ID = id;
                $http({
                    url: '../Administrator/Drivinglicense_request.aspx/ShowFundImage',
                    method: "POST",
                    headers: {
                        'Content-Type': 'application/json; charset=utf-8',
                        'dataType': 'json'
                                            ...
                                            <div class="card-body" ng-repeat="y in fundimage">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-4">
                                                      ...
                                                      <div class="col-lg-4">
                                                        <img src="../../Uploads/Servicesimage/Actual/{{y.pan}}" alt="No Image Available" height="200" width="200" />
                                                    </div>
                                                      <div class="col-lg-4">
