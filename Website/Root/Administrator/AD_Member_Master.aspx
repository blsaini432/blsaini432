<%@ Page Title="" Language="C#" MasterPageFile="AdminMaster.master" AutoEventWireup="true" 
    CodeFile="AD_Member_Master.aspx.cs" Inherits="Root_Admin_AD_Member_New" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="content-wrapper">
        ...
        <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <asp:DropDownList ID="ddlMemberType" runat="server" CssClass="form-control" AutoPostBack="true" OnSelectedIndexChanged="ddlMemberType_SelectedIndexChanged1">
                                        <asp:ListItem Value="0">Select Member Type</asp:ListItem>
                                    </asp:DropDownList>
                                    <asp:RequiredFieldValidator ID="rfvMemberType" runat="server" ErrorMessage="Please Select Member Type !"
                                        ControlToValidate="ddlMemberType" Display="Dynamic" SetFocusOnError="True" ValidationGroup="v"
                            ...
                            <div class="card-body">
                                <h4 class="card-title">Member Information</h4>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group row">
                                                <label class="col-sm-3 col-form-label">Date of Birth<code>*</code></label>
                                                <div class="col-sm-9">
                                                    <asp:TextBox ID="txtMsignupdob" autcomplete="off" runat="server" class="form-control" placeholder="dd-MM-yyyy"></asp:TextBox>
                                                    
                                                    <cc1:CalendarExtender runat="server" ID="txtMsignupdobaa_c" Format="dd/MM/yyyy" Animated="False" PopupButtonID="txtMsignupdob" TargetControlID="txtMsignupdob" PopupPosition="TopLeft"></cc1:CalendarExtender>
                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ErrorMessage="Please Enter Date Of Birth !" ControlToValidate="txtMsignupdob" Display="Dynamic" SetFocusOnError="True" ValidationGroup="v"></asp:RequiredFieldValidator>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
            ...
            <Triggers>
                <asp:AsyncPostBackTrigger ControlID="ddlMemberType" EventName="SelectedIndexChanged" />
                <asp:AsyncPostBackTrigger ControlID="ddlStateName" EventName="SelectedIndexChanged" />
