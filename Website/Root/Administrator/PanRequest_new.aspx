<%@ Page Title="" Language="C#" MasterPageFile="~/Root/Administrator/AdminMaster.master" AutoEventWireup="true" CodeFile="PanRequest_new.aspx.cs" Inherits="Root_Admin_PanRequest_new" %>
    ...
    <script>
        ...
        app.controller("myCntrl", function ($scope, $http, $timeout, $filter) {
            ...
            function Request(id) {
                var ID = id;
                $http({
                    url: '../Administrator/PanRequest_new.aspx/clientdata',
                    method: "POST",
                    headers: {
                        'Content-Type': 'application/json; charset=utf-8',
                        'dataType': 'json'
                        ...
                        <div class="container" ng-app="myApp" ng-controller="myCntrl">
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group row">
                                        <div class="col-sm-6">
                                            <a href="#" ng-click="fillreportbydate(from_date,to_date,ddl_stauts)" class="btn btn-primary">Search &gt;&gt;</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    ...
                                    <table id="tblEwalletsummary" class="table table-bordered table-hover">
                                        <thead>
                                            ...
                                            <tr dir-paginate="x in bbpsnewreport|filter:search|itemsPerPage:pageSize">
                                                ...
                                                <td>
                                                    <a href="#openModaldownload" ng-click="clientdata(x.Pankid)" class="badge badge-success badge-pill">Client Data</a>
                                                </td>
                                                <td>
                            ...
                            <div id="openModaldownload" class="modalDialog">
                                <div>
                                    ...
                                    <div class="modal-body">
                                        <div class="card">
                                            <div class="card-body" ng-repeat="y in clientdata">
                                                <table class="table table-responsive ps--scrolling-y">
                                                    <tr>
                                                        <td>
                                                            <%-- <asp:Button ID="submitButton" runat="server" Visible="true" Text="ClientDataDownload" OnClick="btnSubmit_data" />--%>
                                                            <asp:Button ID="submitButton" runat="server" Text="Client Data Download"  OnClick="btnSubmit_dataa" CausesValidation="True" UseSubmitBehavior="False"  />                       
                                                              </td>
                                                    </tr>
                                                </table>
                                            </div>
