...
public partial class Root_Administrator_Viewallmember : System.Web.UI.Page
{
    ...
    public static List<Customer> BindCustomers()
    {
        ...
        foreach (DataRow dtrow in dt.Rows)
        {
          ...
          //  cust.isbbps = dtrow["setbbps"].ToString();
           cust.isxpresspayout = dtrow["isxpresspayout"].ToString();
          //  cust.utigateway = dtrow["utigateway"].ToString();
           // cust.instantpayout = dtrow["instantpayout"].ToString();
            //cust.isbankps = dtrow["isbankps"].ToString();
            custList.Add(cust);
        }
        return custList;
    }
    ...
    public static List<Customer> BindCustomersByMsrno(string msrno)
    {
        ...
        foreach (DataRow dtrow in dt.Rows)
        {
            ...
            cust.MsrNo = dtrow["MsrNo"].ToString();
            cust.bankps = dtrow["bankps"].ToString();
            custLists.Add(cust);
        }
        return custLists;
    }
    ...
    [WebMethod]
    [ScriptMethod(ResponseFormat = ResponseFormat.Json)]
    public static string update24payout(string msrno, string action)
    {
        DataTable dt = new DataTable();
        cls_connection cls = new cls_connection();
        string actions = "";
        ...
        {
            List<ParmList> _lstparm = new List<ParmList>();
            _lstparm.Add(new ParmList() { name = "@Action", value = "24*7payout" });
            _lstparm.Add(new ParmList() { name = "@ID", value = Convert.ToInt32(msrno) });
            _lstparm.Add(new ParmList() { name = "@act", value = Convert.ToInt32(1) });
            dt = cls.select_data_dtNew("ProcMLM_ManageMemberMaster ", _lstparm);
            actions = "success";
    ...
    [WebMethod]
    [ScriptMethod(ResponseFormat = ResponseFormat.Json)]
    public static string updateutigateway(string msrno, string action)
    {
        DataTable dt = new DataTable();
        cls_connection cls = new cls_connection();
        string actions = "";
        ...
        {
            List<ParmList> _lstparm = new List<ParmList>();
            _lstparm.Add(new ParmList() { name = "@Action", value = "upigateway" });
            _lstparm.Add(new ParmList() { name = "@ID", value = Convert.ToInt32(msrno) });
            _lstparm.Add(new ParmList() { name = "@act", value = Convert.ToInt32(1) });
            dt = cls.select_data_dtNew("ProcMLM_ManageMemberMaster ", _lstparm);
            actions = "success";
    ...
    [WebMethod]
    [ScriptMethod(ResponseFormat = ResponseFormat.Json)]
    public static string updatebbps(string msrno, string action)
    {
        DataTable dt = new DataTable();
        cls_connection cls = new cls_connection();
        string actions = "";
    ...
    [WebMethod]
    [ScriptMethod(ResponseFormat = ResponseFormat.Json)]
    public static string updatebankdetails(string msrno, string action)
    {
        DataTable dt = new DataTable();
        cls_connection cls = new cls_connection();
        string actions = "";
        ...
        {
            List<ParmList> _lstparm = new List<ParmList>();
            _lstparm.Add(new ParmList() { name = "@Action", value = "bankverified" });
            _lstparm.Add(new ParmList() { name = "@ID", value = Convert.ToInt32(msrno) });
            _lstparm.Add(new ParmList() { name = "@act", value = Convert.ToInt32(1) });
            dt = cls.select_data_dtNew("ProcMLM_ManageMemberMaster", _lstparm);
            actions = "success";
    ...
    [WebMethod]
    [ScriptMethod(ResponseFormat = ResponseFormat.Json)]
    public static string updatebankdetailsnew(string msrno, string action)
    {
        DataTable dt = new DataTable();
        cls_connection cls = new cls_connection();
        string actions = "";
    ...
    public class Customer
    {
        ...
        public string bankps { get; set; }
        public string isbankps { get; set; }
        ...
        public string utigateway { get; set; }
        public string instantpayout { get; set; }
