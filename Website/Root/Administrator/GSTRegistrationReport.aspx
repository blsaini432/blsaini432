<%@ Page Title="" Language="C#" MasterPageFile="~/Root/Administrator/adminmaster.master" AutoEventWireup="true"
    CodeFile="GSTRegistrationReport.aspx.cs" Inherits="Root_Administrator_GSTRegistrationReport" %>
    ...
    <script>
        ...
        app.controller("myCntrl", function ($scope, $http, $timeout, $filter) {
            ...
            $scope.fillfundrequest = function () {
                ...
                var httpreq = {
                    method: 'POST',
                    url: '../Administrator/GSTRegistrationReport.aspx/fillposrequest',
                    headers: {
            ...
            $scope.fillfundrequestbydate = function (fdate, tdate) {
                ...
                var httpreq = {
                    method: 'POST',
                    url: '../Administrator/GSTRegistrationReport.aspx/fillposrequestbydate',
                    headers: {
                        'Content-Type': 'application/json; charset=utf-8',
                        'dataType': 'json'
                    },
            ...
            function ApproveRequest(id) {
                var ID = id;
                $http({
                    url: '../Administrator/GSTRegistrationReport.aspx/ApproveRequest',
                    method: "POST",
                    headers: {
                        'Content-Type': 'application/json; charset=utf-8',
                        'dataType': 'json'
            ...
            function clentdata(id) {
                var ID = id;
                $http({
                    url: '../Administrator/GSTRegistrationReport.aspx/clientdata',
                    method: "POST",
                    headers: {
                        'Content-Type': 'application/json; charset=utf-8',
                        'dataType': 'json'
            ...
            function RejectRequest(id) {
                var ID = id;
                $http({
                    url: '../Administrator/GSTRegistrationReport.aspx/RejectRequest',
                    method: "POST",
                    headers: {
                        'Content-Type': 'application/json; charset=utf-8',
                        'dataType': 'json'
            ...
            function FundImage(id) {
                var ID = id;
                $http({
                    url: '../Administrator/GSTRegistrationReport.aspx/ShowFundImage',
                    method: "POST",
                    headers: {
                        'Content-Type': 'application/json; charset=utf-8',
                        'dataType': 'json'
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="content-wrapper">
        <div class="page-header">
            <h3 class="page-title">GST Registration Request
            </h3>
        </div>
                                        ...
                                        <div class="card">
                                            <div class="card-body" ng-repeat="y in fundimage">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-4">
                                                         <label style="color:green">Sale Purchase </label>
                                                        <a href="../../Uploads/Servicesimage/Actual/{{y.pancard}}" target="_blank" />
                                                        <img src="../../Uploads/Servicesimage/Actual/{{y.pancard}}" alt="click" height="200" width="200" />
                                                    </div>
                                                    <div class="col-lg-4">
                                                         <label style="color:green">Photo Image</label>
                                                        <a href="../../Uploads/Servicesimage/Actual/{{y.passbook}}" target="_blank" />
                                                        <img src="../../Uploads/Servicesimage/Actual/{{y.passbook}}" alt="click" height="200" width="200" />
                                                    </div>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-4">
                                                         <label style="color:green">PanCardImage</label>
                                                        <a href="../../Uploads/Servicesimage/Actual/{{y.file2}}" target="_blank" />
                                                        <img src="../../Uploads/Servicesimage/Actual/{{y.file2}}" alt="No Image Available" height="200" width="200" />
                                                    </div>
                                                      <div class="col-lg-4">
                                                          <label style="color:green">Copy Of Gst </label>
                                                        <a href="../../Uploads/Servicesimage/Actual/{{y.file}}" target="_blank" />
                                                        <img src="../../Uploads/Servicesimage/Actual/{{y.file}}" alt="Click" height="200" width="200" />
                                                    </div>
                                                   <%-- <div class="col-lg-4">
                                                         <label style="color:green">file3 </label>
                                                        <a href="../Upload/PanCardRequest/Actual/{{y.file3}}" target="_blank" />
                                                        <img src="../Upload/PanCardRequest/Actual/{{y.file3}}" alt="No Image Available" height="200" width="200" />
                                                    </div>
                                                     <div class="col-lg-4">
                                                          <label style="color:green">file4</label>
                                                        <a href="../Upload/PanCardRequest/Actual/{{y.file4}}" target="_blank" />
                                                        <img src="../Upload/PanCardRequest/Actual/{{y.file4}}" alt="No Image Available" height="200" width="200" />
                                                    </div>--%>
                                                </div>
