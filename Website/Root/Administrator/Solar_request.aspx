<%@ Page Title="" Language="C#" MasterPageFile="~/Root/Administrator/AdminMaster.master" AutoEventWireup="true"
    CodeFile="Solar_request.aspx.cs" Inherits="Root_Admin_Solar_request" %>
    ...
    <script>
        ...
        app.controller("myCntrl", function ($scope, $http, $timeout, $filter) {
            ...
            $scope.fillfundrequest = function () {
                ...
                var httpreq = {
                    method: 'POST',
                    url: '../Administrator/Solar_request.aspx/fillfundrequest',
                    headers: {
            ...
            $scope.fillfundrequestbydate = function (fdate, tdate) {
                ...
                var httpreq = {
                    method: 'POST',
                    url: '../Administrator/Solar_request.aspx/fillfundrequestbydate',
                    headers: {
                        'Content-Type': 'application/json; charset=utf-8',
                        'dataType': 'json'
                    },
            ...
            function ApproveRequest(id) {
                var ID = id;
                $http({
                    url: '../Administrator/Solar_request.aspx/approve',
                    method: "POST",
                    headers: {
                        'Content-Type': 'application/json; charset=utf-8',
                        'dataType': 'json'
            ...
            function RejectRequest(id) {
                var ID = id;
                $http({
                    url: '../Administrator/Solar_request.aspx/faild',
                    method: "POST",
                    headers: {
                        'Content-Type': 'application/json; charset=utf-8',
                        'dataType': 'json'
            ...
            function FundImage(id) {
                var ID = id;
                $http({
                    url: '../Administrator/Solar_request.aspx/ShowFundImage',
                    method: "POST",
                    headers: {
                        'Content-Type': 'application/json; charset=utf-8',
                        'dataType': 'json'
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="content-wrapper">
        <div class="page-header">
            <h3 class="page-title">Solar energy Request List
            </h3>
        </div>
