<%@ Page Language="C#" MasterPageFile="~/Root/Administrator/AdminMaster.master" AutoEventWireup="true" CodeFile="VedioList.aspx.cs" Inherits="Root_Administrator_VedioList" %>
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Vedio">
                                            <ItemTemplate>
                                                ...
                                                <video width="320" height="240"  controls='controls' data-setup='{}'>
