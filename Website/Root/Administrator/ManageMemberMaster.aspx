<%@ Page Title="" Language="C#" MasterPageFile="~/Root/Administrator/AdminMaster.master" AutoEventWireup="true"
    CodeFile="ManageMemberMaster.aspx.cs" Inherits="Root_Admin_ManageMemberMaster" %>
            ...
            <div class="col-12 grid-margin">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            <label for="exampleInputName1">Bank Name<code>*</code></label>
 <asp:TextBox ID="txt_BankName" runat="server" MaxLength="50" CssClass="form-control" autcomplete="off"></asp:TextBox>
                        </div>
                        <div class="form-group">
                            <label for="exampleInputEmail3">Bank IFSC</label>
                      <asp:TextBox ID="txt_BankIFSC" runat="server" MaxLength="50" CssClass="form-control" autcomplete="off"></asp:TextBox>
                        </div>
                        <div class="form-group">
                            <label for="exampleInputEmail3">Bank AccountNumber </label>
                             <asp:TextBox ID="txt_BankAccountnumber" runat="server" MaxLength="50" CssClass="form-control" autcomplete="off"></asp:TextBox>
                        </div>
                    </div>
                </div>
            </div>
