<%@ Page Title="" Language="C#" MasterPageFile="AdminMaster.master" AutoEventWireup="true" CodeFile="Accountopenfeesetting.aspx.cs" Inherits="Portals_Admin_Accountopenfeesetting" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="content-wrapper">
        <div class="page-header">
            <h3 class="page-title">Manage Account Fees
            </h3>
        </div>
                            ...
                            <div class="card-body">
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-8">
                                        ...
                                        <asp:ListItem>Account Open</asp:ListItem>
                                    </asp:DropDownList>
