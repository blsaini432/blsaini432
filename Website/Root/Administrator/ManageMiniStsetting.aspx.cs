...
public partial class Portals_Admin_ManageMiniStsetting : System.Web.UI.Page
{
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            cls_connection cls = new cls_connection();
            dt = cls.select_data_dtNew("Sp_ministatementfeesettings ", _lstparm);
            if (dt.Rows.Count > 0)
            {
                if (Convert.ToDecimal(txtcomission.Text) > 0)
                {
                    ...
                    cls.select_data_dtNew("Sp_ministatementfeesettings ", _lstparms);
