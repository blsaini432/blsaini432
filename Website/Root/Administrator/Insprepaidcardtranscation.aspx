<%@ Page Title="" Language="C#" MasterPageFile="~/Root/Administrator/AdminMaster.master" AutoEventWireup="true"
    CodeFile="Insprepaidcardtranscation.aspx.cs" Inherits="Root_Admin_Insprepaidcardtranscation" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div class="content-wrapper">
        <div class="page-header">
            <h3 class="page-title">Prepaidcard Transaction
            </h3>
        </div>
                        ...
                        <div class="container" ng-app="myApp" ng-controller="myCntrl">
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group row">
                                        <div class="col-sm-6">
                                            <a href="#" ng-click="fillprepaidcardtxnbydate(from_date,to_date)" class="btn btn-primary">Search &gt;&gt;</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="table-responsive">
                                    <table id="tblEwalletsummary" class="table table-bordered table-hover">
                                        <thead>
                                            ...
                                            <tr dir-paginate="x in PrepaidcardtxnReport|filter:search|itemsPerPage:pageSize">
                                                <td>{{$index + 1}}</td>
                                                     <td>{{x.MemberID}}</td>
                                                <td>{{x.Txnid}}</td>
                                                <td>{{x.Amount}}</td>
                                             ...
                                             <tr>
                                                <td ng-show="PrepaidcardtxnReport.length==0" colspan="12">
