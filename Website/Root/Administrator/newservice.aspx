<%@ Page Title="" Language="C#" MasterPageFile="~/Root/Administrator/AdminMaster.master" AutoEventWireup="true" CodeFile="newservice.aspx.cs" Inherits="Root_Administrator_newservice" %>
                                            ...
                                            <Columns>
                                                <asp:TemplateField HeaderText="BILL DETAILS" HeaderStyle-HorizontalAlign="Center">
                                                    <ItemTemplate>
                                                        <div class="col-lg-6">
                                                            <p class="clearfix">
                                                                <span class="float-left"><label class="col-form-label">BILL NUMBER:</label>
                                                                </span>
                                                            ...
                                                            <p class="clearfix">
                                                                <span class="float-left"><label class="col-form-label">BILL DATE</label>
                                                                </span>
                                                                <span class="float-right text-muted">
                                                            ...
                                                            <p class="clearfix">
                                                                <span class="float-left"><label class="col-form-label">PERIOD</label>
                                                                </span>
                                                                <span class="float-right text-muted">
                                                            ...
                                                            <p class="clearfix">
                                                                <span class="float-left"><label class="col-form-label">NAME</label>
                                                                </span>
                                                                <span class="float-right text-muted">
                                                            ...
                                                            <p class="clearfix">
                                                                <span class="float-left"><label class="col-form-label">DUE AMOUNT</label>
                                                                </span>
                                                                <span class="float-right text-muted">
                                                            ...
                                                            <p class="clearfix">
                                                                <span class="float-left"><label class="col-form-label">DUE DATE</label>
                                                                </span>
                                                                <span class="float-right text-muted">
