<%@ Page Title="" Language="C#" MasterPageFile="~/Root/Administrator/AdminMaster.master" AutoEventWireup="true"
    CodeFile="Udyogaadhar_request.aspx.cs" Inherits="Portal_Admin_Voteridrequest" %>
    ...
    <script>
        ...
        app.controller("myCntrl", function ($scope, $http, $timeout, $filter) {
            ...
            $scope.fillfundrequest = function () {
                ...
                var httpreq = {
                    method: 'POST',
                    url: '../Administrator/Udyogaadhar_request.aspx/fillposrequest',
                    headers: {
            ...
            $scope.fillfundrequestbydate = function (fdate, tdate) {
                ...
                var httpreq = {
                    method: 'POST',
                    url: '../Administrator/Udyogaadhar_request.aspx/fillposrequestbydate',
                    headers: {
                        'Content-Type': 'application/json; charset=utf-8',
                        'dataType': 'json'
                    },
            ...
            function ApproveRequest(id) {
                var ID = id;
                $http({
                    url: '../Administrator/Udyogaadhar_request.aspx/ApproveRequest',
                    method: "POST",
                    headers: {
                        'Content-Type': 'application/json; charset=utf-8',
                        'dataType': 'json'
            ...
            function clentdata(id) {
                var ID = id;
                $http({
                    url: '../Administrator/Udyogaadhar_request.aspx/clientdata',
                    method: "POST",
                    headers: {
                        'Content-Type': 'application/json; charset=utf-8',
                        'dataType': 'json'
            ...
            function RejectRequest(id) {
                var ID = id;
                $http({
                    url: '../Administrator/Udyogaadhar_request.aspx/RejectRequest',
                    method: "POST",
                    headers: {
                        'Content-Type': 'application/json; charset=utf-8',
                        'dataType': 'json'
            ...
            function FundImage(id) {
                var ID = id;
                $http({
                    url: '../Administrator/Udyogaadhar_request.aspx/ShowFundImage',
                    method: "POST",
                    headers: {
                        'Content-Type': 'application/json; charset=utf-8',
                        'dataType': 'json'
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="content-wrapper">
        <div class="page-header">
            <h3 class="page-title">Udayog aadhar Request List
            </h3>
        </div>
                                            ...
                                            <div class="card-body" ng-repeat="y in fundimage">
                                                <div class="form-group row">
                                                    <div class="col-lg-3">
                                                        ...
                                                        <a href="../Upload/PanCardRequest/Actual/{{y.adharback}}" target="_blank" />
                                                        <img src="../Upload/PanCardRequest/Actual/{{y.adharback}}" alt="No Image Available" height="200" width="200" />
                                                    </div>
                                                 
                                                    <div class="col-lg-3">
                                                         <label style="color:green">pancard </label>
                                                    ...
                                                    <div class="col-lg-3">
                                                         <label style="color:green">Bank Passbook</label>
                                                        <a href="../Upload/PanCardRequest/Actual/{{y.passbook}}" target="_blank" />
                                                        <img src="../Upload/PanCardRequest/Actual/{{y.passbook}}" alt="No Image Available" height="200" width="200" />
                                                    </div>
                                                     <div class="col-lg-3">
                                                          <label style="color:green">file1 </label>
                                                        <a href="../Upload/PanCardRequest/Actual/{{y.file}}" target="_blank" />
                                                        <img src="../Upload/PanCardRequest/Actual/{{y.file}}" alt="No Image Available" height="200" width="200" />
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <img src="../Upload/PanCardRequest/Actual/{{y.file2}}" alt="No Image Available" height="200" width="200" />
                                                    </div>
                                                    <div class="col-lg-4">
