...
public partial class Root_Administrator_payout_report : System.Web.UI.Page
{
    ...
    protected void btn_export_Click(object sender, EventArgs e)
    {
        ...
        if (fromdate != "" && todate != "")
        {
            ...
            dtExport = cls.select_data_dtNew("MM_transactionREport_PayOut", _lstparm);
    ...
    public static List<Customer> fillnewdmrreport()
    {
        ...
        dtEWalletTransaction = cls.select_data_dtNew("MM_transactionREport_PayOut", _lstparm);
        ...
        foreach (DataRow dtrow in dtEWalletTransaction.Rows)
        {
            ...
            cust.TxnID = dtrow["merchant_ref_id"].ToString();
            cust.BankOrderId = dtrow["mobile_number"].ToString();
            cust.email_id = dtrow["email_id"].ToString();
            cust.ApiTxnID = dtrow["recepient_name"].ToString();
            cust.bank_response = dtrow["bank_response"].ToString();
            cust.Status = dtrow["Status"].ToString();
            cust.AdminCost = dtrow["Txnstatus"].ToString();
            cust.Createdate = dtrow["Createdate"].ToString();
            cust.msg = dtrow["mobile_number"].ToString();
            cust.transaction_types_id = dtrow["transaction_types_id"].ToString();
            cust.SurchargeTaken = dtrow["SurchargeTaken"].ToString();
            cust.open_transaction_ref_id = dtrow["open_transaction_ref_id"].ToString();
            custList.Add(cust);
        }
        return custList;
    }
