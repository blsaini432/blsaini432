<%@ Page Title="" Language="C#" MasterPageFile="~/Root/Administrator/AdminMaster.master" AutoEventWireup="true"
    CodeFile="servicetListBanner.aspx.cs" Inherits="Root_Admin_servicetListBanner" %>
                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            AutoGenerateColumns="false"
                                ...
                                <Columns>
                                    <asp:BoundField HeaderText="ServiceNamer" DataField="ServiceName" SortExpression="BannerID" />
                                   ...
                                   <%-- <asp:TemplateField HeaderStyle-Width="16px">
                                    ...
                                    <asp:TemplateField HeaderStyle-Width="16px">
                                        <ItemTemplate>
                                            <asp:Button ID="btnDelete" runat="server" CssClass="btn btn-outline-warning btn-icon-text" Text='<%# Convert.ToBoolean(Eval("IsActive")) == true? "Delete" : "Deactivate" %>'
