...
using System.Data;
using BLL;
public partial class Root_Administrator_Add_linkpdf : System.Web.UI.Page
{
    #region [Properties]
    ...
    private void fillVideo()
    {
        ...
        _list.Add(new ParmList() { name = "@Action", value = "pdf" });
    ...
    protected void gvImage_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        if (e.CommandName == "IsDelete")
        {
            try
            {
               ...
               // Function.MessageBox(" delete Successfull.!");
            }
            catch
            {
