<%@ Page Title="" Language="C#" MasterPageFile="~/Root/Administrator/AdminMaster.master" AutoEventWireup="true"
    CodeFile="Creditcardrequest.aspx.cs" Inherits="Root_Administrator_Creditcardrequest" %>
    ...
    <div id="toPopup">
        ...
        <div id="popup_content" style="height: 250px !important;">
            <asp:UpdatePanel ID="upd" runat="server">
                <ContentTemplate>
                    <h5 style="text-align: center; color: green; text-decoration: underline">Update Credit Card Request</h5>
                    <table width="100%">
                                    ...
                                    <Columns>
                                        <asp:TemplateField HeaderText="Sr. No.">
                                         ...
                                         <asp:TemplateField HeaderText="Delete">
                                                        <ItemTemplate>
                                                            <asp:Button ID="btndelete" runat="server" Text="Delete" CommandArgument='<%#Eval("ITRkid") %>'
                                                                CommandName="deletesuser"    />
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                        <asp:BoundField HeaderText="ITRType" DataField="ITRType" SortExpression="ITRType" />
                                        ...
                                        <asp:TemplateField HeaderText="PAN">
                                            <ItemTemplate>
                                                <a href="../Upload/PanCardRequest/Medium/<%# Eval(" pancardimage") %>" target="_blank">Download
                                                </a>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Aadhar">
                                            <ItemTemplate>
                                                <a href="../Upload/PanCardRequest/Medium/<%# Eval("aadharcardimage") %>" target="_blank">Download
                                                </a>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="BankStatement">
                                            <ItemTemplate>
                                                <a href="../Upload/PanCardRequest/Medium/<%# Eval("bankstmtfyr") %>" target="_blank">Download
                                                </a>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="BankDeatils">
                                            <ItemTemplate>
                                                <a href="../Upload/PanCardRequest/Medium/<%# Eval("bankactdetailifsc") %>" target="_blank">Download
                                                </a>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Form16">
                                            <ItemTemplate>
                                                <a href="../Upload/PanCardRequest/Medium/<%# Eval("form16") %>" target="_blank">Download
                                                </a>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField HeaderText="Client Data">
                                            <ItemTemplate>
                                                <asp:Button ID="btnWord" runat="server" Text="Download" CommandArgument='<%#Eval("ITRkid") %>'
                                                    CommandName="WordDownload" ToolTip="Download Word File" />
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderStyle-Width="30px">
                                            <ItemTemplate>
                                                <asp:Button ID="Approve" runat="server" Text="Approve" CommandArgument='<%#Eval("ITRkid") %>'
                                        ...
                                        <asp:TemplateField HeaderStyle-Width="30px">
                                            <ItemTemplate>
                                                <asp:Button ID="Reject" runat="server" Text="Reject" CommandArgument='<%#Eval("ITRkid") %>'
        ...
        <ContentTemplate>
            <div class="content-wrapper">
                <div class="page-header">
                    <h3 class="page-title">Credit Card Request
                    </h3>
                </div>
                                                    ...
                                                    <td>
                                                        ...
                                                        <ItemTemplate>
                                                            <asp:Button ID="btndelete" runat="server" Text="Delete" CommandArgument='<%#Eval("ITRkid") %>'
                                                             ...
                                                             <asp:BoundField HeaderText="MemberName" DataField="MemberName" SortExpression="NameOnPan" />
                                                                <asp:BoundField HeaderText="MemberID" DataField="MemberID" SortExpression="NameOnPan" />
                                                                <asp:BoundField HeaderText="Name" DataField="NameOnPan" SortExpression="NameOnPan" />
                                                                <asp:BoundField HeaderText="Father Name" DataField="Father" SortExpression="FatherName" />
                                                                <asp:BoundField HeaderText="mother Name" DataField="mother" SortExpression="mother" />
                                                                    <asp:BoundField HeaderText="DOB" DataField="Dateofbirth" SortExpression="mother" />
                                                                <asp:TemplateField HeaderText="Add Date" SortExpression="AddDate">
                                                                    <ItemTemplate>
                                                                        <%#String.Format("{0:dd-MMM-yyyy}", Convert.ToDateTime(Eval("AddDate")))%>
                                                                    </ItemTemplate>
                                                             ...
                                                             <%--   <asp:BoundField HeaderText="Contact No" DataField="Mobieno" SortExpression="Mobieno" />
                                                                ...
                                                                <asp:TemplateField HeaderText="PAN">
                                                                    <ItemTemplate>
                                                                        <a href="../../Uploads/Servicesimage/Medium/<%# Eval(" pancard") %>" target="_blank">Download
                                                                        </a>
                                                                    </ItemTemplate>
                                                                </asp:TemplateField>
                                                                <asp:TemplateField HeaderText="Aadhar">
                                                                    <ItemTemplate>
                                                                        <a href="../../Uploads/Servicesimage/Medium/<%# Eval("aadharcard") %>" target="_blank">Download
                                                                        </a>
                                                                    </ItemTemplate>
                                                                </asp:TemplateField>
                                                                <asp:TemplateField HeaderText="BankStatement">
                                                                    <ItemTemplate>
                                                                        <a href="../../Uploads/Servicesimage/Medium/<%# Eval("bankstatement") %>" target="_blank">Download
                                                                        </a>
                                                                    </ItemTemplate>
                                                                </asp:TemplateField>
                                                                <asp:TemplateField HeaderText="ITR">
                                                                    <ItemTemplate>
                                                                        <a href="../../Uploads/Servicesimage/Medium/<%# Eval("itr") %>" target="_blank">Download
                                                                        </a>
                                                                    </ItemTemplate>
                                                                </asp:TemplateField>
                                                               <%-- <asp:TemplateField HeaderText="Form16">
                                            ...
                                            <ItemTemplate>
                                                <asp:Button ID="btnWord" runat="server" Text="Download" CommandArgument='<%#Eval("ITRkid") %>'
                                                    CommandName="WordDownload" ToolTip="Download Word File" />
                                                                ...
                                                                <asp:TemplateField HeaderStyle-Width="30px">
                                                                    <ItemTemplate>
                                                                        <asp:Button ID="Approve" runat="server" Text="Approve" CommandArgument='<%#Eval("credit_id") %>'
                                                                            CommandName="Approve" Visible='<%# Convert.ToBoolean(Eval("IsEnable")) %>' ToolTip="Approve Request"
                                                                            Enabled='<%# Convert.ToBoolean(Eval("IsEnable")) %>' />
                                                                        <asp:Label ID="lblssdsd" Visible='<%# Convert.ToBoolean(Eval("StatusSwow")) %>' runat="server"
                                                                            Text='<%#Eval("Staussss") %>'></asp:Label>
                                                                ...
                                                                <asp:TemplateField HeaderStyle-Width="30px">
                                                                    <ItemTemplate>
                                                                        <asp:Button ID="Reject" runat="server" Text="Reject" CommandArgument='<%#Eval("credit_id") %>'
                                                                            CommandName="Reject" Visible='<%# Convert.ToBoolean(Eval("IsEnable")) %>' ToolTip="Approve Request"
                                                                            Enabled='<%# Convert.ToBoolean(Eval("IsEnable")) %>' />
                                                                        <asp:Label ID="lbfsdfewrewl" Visible='<%# Convert.ToBoolean(Eval("StatusSwow")) %>'
                                                                            runat="server" Text='<%#Eval("Remarks") %>'></asp:Label>
