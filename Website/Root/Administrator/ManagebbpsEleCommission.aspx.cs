...
public partial class Root_Admin_ManagebbpsEleCommission : System.Web.UI.Page
{
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        #region [Insert]
        Int32 intresult = 0;
        int i = objconnection.delete_data("delete from BBPS_ELE_COM where PackageID=" + Convert.ToInt32(ddlPackage.SelectedValue));
        foreach (GridViewRow row in gvOperator.Rows)
        {
            ...
            intresult = objconnection.insert_data("EXEC PROC_BBPS_ELE_COM @Action='I',@PackageId=" + Convert.ToInt32(ddlPackage.SelectedValue) + ",@ServiceName='" + ServiceName + "',@ServiceKey=" + servicekey + ",@Amount='" + Commission + "',@IsFlat='" + chkFlat.Checked + "'");
        }
        if (intresult > 0)
        {
    ...
    protected void ddlPackage_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        {
            dtOperator = objconnection.select_data_dt("Exec PROC_BBPS_ELE_COM @Action='ADMIN',@PackageId='" + ddlPackage.SelectedItem.Value + "'");
            ...
            {
                dtOperator = objconnection.select_data_dt("Exec PROC_BBPS_ELE_COM @Action='NPKG'");
                gvOperator.DataSource = dtOperator;
                gvOperator.DataBind();
            }
        }
