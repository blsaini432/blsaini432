<%@ Page Title="" Language="C#" MasterPageFile="~/Root/Administrator/AdminMaster.master" AutoEventWireup="true" CodeFile="YesBankDmrReport.aspx.cs" Inherits="Root_Admin_YesBankDmrReport" %>
    ...
    <script>
        ...
        app.controller("myCntrl", function ($scope, $http, $timeout, $filter) {
            ...
            $scope.filldmrreport = function () {
                ...
                var httpreq = {
                    method: 'POST',
                    url: '../Administrator/YesBankDmrReport.aspx/filldmrreport',
                    headers: {
            ...
            $scope.filldmrreportbydate = function (fdate, tdate) {
                ...
                var httpreq = {
                    method: 'POST',
                    url: '../Administrator/YesBankDmrReport.aspx/filldmrreportbydate',
                    headers: {
                        'Content-Type': 'application/json; charset=utf-8',
                        'dataType': 'json'
                    },
            ...
            function ApproveBRequest(id, banksid) {
                ...
                $http({
                    url: '../Administrator/YesBankDmrReport.aspx/ApproveRequest',
                    method: "POST",
                    headers: {
                        'Content-Type': 'application/json; charset=utf-8',
                        'dataType': 'json'
                    },
                    data: { fundid: id, bankid: banksid }
                                                ...
                                                <td>{{x.Createdate}}</td>
                                                 <td>
                                                    ...
                                                    <div ng-if="x.Status!=='Pending'">
                                                        <a href="#" ng-click="ApproveRequest(x.bankrefno,x.SenderMobile)" class="badge badge-danger badge-pill">check Status</a>
                                                    </div>
                                                </td>
