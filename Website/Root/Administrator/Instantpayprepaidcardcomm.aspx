<%@ Page Title="" Language="C#" MasterPageFile="AdminMaster.master" AutoEventWireup="true"
    CodeFile="Instantpayprepaidcardcomm.aspx.cs" Inherits="Root_Admin_Instantpayprepaidcardcomm" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="content-wrapper">
        <div class="page-header">
            <h3 class="page-title">Manage Prepaid Card Commission
            </h3>
        </div>
                                    ...
                                    <asp:GridView ID="gvOperator" runat="server"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Edit">
                                                <ItemTemplate>
                                                    <asp:Button ID="btnedit" runat="server" Text="Edit" CssClass="btn btn-warning btn-icon-text" CommandName="medit" CommandArgument='<%#Container.DataItemIndex+1 %>' />
                                                    <asp:Button ID="btndelete" runat="server" Text="Delete" CommandName="mdelete" CssClass="btn btn-primary btn-icon-text" CommandArgument='<%#Container.DataItemIndex+1 %>' />
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                        </Columns>
                                        <EmptyDataTemplate>
