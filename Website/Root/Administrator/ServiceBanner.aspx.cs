...
public partial class Root_Admin_ServiceBanner : System.Web.UI.Page
{
    #region [Properties]
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            {
                FillData(30);
                lblAddEdit.Text = "Update Service Banner";
            }
            else
            {
                FillData(30);
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        ...
        if (bannerImage != "")
        {
            if (Request.QueryString["id"] == null)
            {
                ...
                _list.Add(new ParmList() { name = "@ServiceName", value = DROPE.SelectedItem.ToString() });
                ...
                dt = Cls.select_data_dtNew("Proc_servicebanner", _list);
                if (dt.Rows.Count > 0)
                {
