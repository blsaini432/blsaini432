...
public partial class Portals_Admin_Managepsasetting : System.Web.UI.Page
{
    ...
    public void package()
    {
        ...
        dd = cls.select_data_dtNew("Sp_ManagePSASetting ", _lstparm);
        if (dd.Rows.Count > 0)
        {
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            cls_connection cls = new cls_connection();
            dt = cls.select_data_dtNew("Sp_ManagePSASetting ", _lstparm);
            if (dt.Rows.Count > 0)
            {
                if (Convert.ToDecimal(txtcomission.Text) > 0)
                {
                    ...
                    cls.select_data_dtNew("Sp_ManagePSASetting ", _lstparms);
