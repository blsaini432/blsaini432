<%@ Page Title="" Language="C#" MasterPageFile="~/Root/Administrator/AdminMaster.master" AutoEventWireup="true" CodeFile="ElectricityTransactions.aspx.cs" Inherits="Root_Admin_ElectricityTransactions" %>
    ...
    <script>
        ...
        app.controller("myCntrl", function ($scope, $http, $timeout, $filter) {
            ...
            function ApproveBRequest(id) {
                ...
                $http({
                    url: '../Administrator/ElectricityTransactions.aspx/ApproveRequest',
                    method: "POST",
                    headers: {
                        'Content-Type': 'application/json; charset=utf-8',
                        'dataType': 'json'
            ...
            function RejectBRequest(id) {
                var ID = id;
                $http({
                    url: '../Administrator/ElectricityTransactions.aspx/RejectRequest',
                    method: "POST",
                    headers: {
                        'Content-Type': 'application/json; charset=utf-8',
                        'dataType': 'json'
                                            ...
                                            <tr dir-paginate="x in bbpsnewreport|filter:search|itemsPerPage:pageSize">
                                               ...
                                               <%-- <td>{{x.adm_com}}</td>
                                                ...
                                                <td>
                                                    ...
                                                    <div ng-if="x.statu==='Pending'">
                                                        <a href="#openModalstatus" ng-click="ApproveRequest(x.agent_id)" class="badge badge-danger badge-pill">Approve</a>
                                                    </div>
                                                </td>
