<%@ Page Title="" Language="C#" MasterPageFile="~/Root/administrator/adminmaster.master" AutoEventWireup="true" CodeFile="FastTagRechargeReport.aspx.cs" Inherits="Root_Admin_FastTagRechargeReport" %>
...
<div id="toPopup">
    ...
    <div class="content-header">
        <h1>
            List FasttagRecharge Request <small>Admin Panel</small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i>Admin</a></li>
            <li class="active">List FasttagRecharge Request</li>
        </ol>
    </div>
                                    ...
                                    <div class="box-content">
                                        <asp:GridView ID="gvBookedBusList" runat="server" CssClass="table table-striped table-bordered bootstrap-datatable datatable responsive SmallText"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:BoundField HeaderText="ezulixtranid" DataField="ezulixtranid" SortExpression="ezulixtranid" />
                                                 <asp:BoundField HeaderText="RechargeAmount" DataField="RechargeAmount" SortExpression="RechargeAmount" />
                                                  <asp:BoundField HeaderText="Mobile" DataField="Mobile" SortExpression="Mobile" />
                                                <asp:BoundField HeaderText="Vehicle" DataField="Vehicle" SortExpression="Vehicle" />
                                                ...
                                                <asp:TemplateField HeaderStyle-Width="30px">
                                                    <ItemTemplate>
                                                        <asp:Button ID="Approve" runat="server" Text="Approve" CommandArgument='<%#Eval("ID") %>' Visible='<%# Convert.ToString(Eval("Status"))=="Pending" ? true : false %>'
                                                            CommandName="Approve" />
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderStyle-Width="30px">
                                                    <ItemTemplate>
                                                        <asp:Button ID="Reject" runat="server" Text="Reject" CommandArgument='<%#Eval("ID") %>' Visible='<%# Convert.ToString(Eval("Status"))=="Pending" ? true : false %>'
                                                            CommandName="Reject"  />
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                            </Columns>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="content-wrapper">
        <div class="page-header">
            <h3 class="page-title">List FasttagRecharge Request
            </h3>
        </div>
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            <ContentTemplate>
