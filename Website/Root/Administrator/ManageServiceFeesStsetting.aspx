<%@ Page Title="" Language="C#" MasterPageFile="AdminMaster.master" AutoEventWireup="true" CodeFile="ManageServiceFeesStsetting.aspx.cs" Inherits="Portals_Admin_ManageServiceFeesStsetting" %>
                ...
                <div class="card">
                    <div class="card-body">
                         ...
                         <div class="form-group row">
                            ...
                            <div class="form-group row">
                            <div class="col-lg-3">
                                <label class="col-form-label">Fees<code>*</code></label>
                            </div>
                            <div class="col-lg-8">
              ...
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title"> Fees</h4>
                     <asp:GridView ID="ddlServices" runat="server" CssClass="table">
                         <EmptyDataTemplate>
                             No Data Available
                         </EmptyDataTemplate>
                     </asp:GridView>
