<%@ Page Title="" Language="C#" MasterPageFile="~/Root/Administrator/AdminMaster.master" AutoEventWireup="true"
    CodeFile="Bus_History.aspx.cs" Inherits="Root_Admin_Bus_History" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script>
        ...
        //Recharge
            ...
            var httpreq = {
                method: 'POST',
                url: '../Administrator/Bus_History.aspx/fillrechargereport',
                headers: {
        ...
        $scope.fillrechargereportbydate = function (fdate, tdate) {
            ...
            var httpreq = {
                method: 'POST',
                url: '../Administrator/Bus_History.aspx/fillrechargereportbydate',
                headers: {
                    'Content-Type': 'application/json; charset=utf-8',
                    'dataType': 'json'
                },
