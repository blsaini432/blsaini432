<%@ Page Title="" Language="C#" MasterPageFile="~/Root/Administrator/AdminMaster.master" AutoEventWireup="true" CodeFile="Offlinebill_payder.aspx.cs" Inherits="Root_Admin_Offlinebill_payder" %>
    ...
    <script>
        ...
        app.controller("myCntrl", function ($scope, $http, $timeout, $filter) {
            ...
            $scope.fillbbpsnewreport = function () {
                ...
                var httpreq = {
                    method: 'POST',
                    url: '../Administrator/Offlinebill_payder.aspx/fillelectricityreport',
                    headers: {
            ...
            $scope.fillbbpsnewreportbydate = function (fdate, tdate) {
                ...
                var httpreq = {
                    method: 'POST',
                    url: '../Administrator/Offlinebill_payder.aspx/fillelectricityreportbydate',
                    headers: {
                        'Content-Type': 'application/json; charset=utf-8',
                        'dataType': 'json'
                    },
            ...
            function ApproveBRequest(id, banksid) {
                ...
                $http({
                    url: '../Administrator/Offlinebill_payder.aspx/ApproveRequest',
                    method: "POST",
                    headers: {
                        'Content-Type': 'application/json; charset=utf-8',
                        'dataType': 'json'
            ...
            function RejectBRequest(id) {
                var ID = id;
                $http({
                    url: '../Administrator/Offlinebill_payder.aspx/RejectRequest',
                    method: "POST",
                    headers: {
                        'Content-Type': 'application/json; charset=utf-8',
                        'dataType': 'json'
