    ...
    if (zIndex == 1) {
        ...
        for (var i = 0; i <= row; i++) {
            ...
            if (rowSelector.length == 0) {
                var rowObj = $('<div/>').attr("id", "udRow" + i).css({"width": "100%", "height": "5%", "margin-top": "2px", "margin-bottom": "2px"});
        ...
        for (var i = 0; i <= row; i++) {
            ...
            if (rowSelector.length == 0) {
                var rowObj = $('<div/>').attr("id", "ldRow" + i).css({"width": "100%", "height": "5%", "margin-top": "2px", "margin-bottom": "2px"});
...
function plotSelectedSeats() {
    ...
    for (var i = 0; i < selectedSeatsArray.length; i++) {
        ...
        $('#seatsContainer').append("<span style='background-color: red;padding-left: 5px;padding-right: 5px; float:left;margin-left: 2px; margin-right: 2px;border-radius: 5px;color:#fff'>" + selectedSeatsArray[i].name + "</span>");
