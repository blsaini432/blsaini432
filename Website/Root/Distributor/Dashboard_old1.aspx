<%@ Page Title="" Language="C#" MasterPageFile="~/Root/Distributor/MemberMaster.master" AutoEventWireup="true" CodeFile="Dashboard_old1.aspx.cs" Inherits="Root_Admin_Dashboard" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="content-wrapper">
        ...
        <asp:Panel ID="pnltransotp" runat="server" CssClass="modalPopup" align="center" Style="display: none; width: 60%; height: 400px">
            <div class="card-body">
                <asp:Repeater runat="server" ID="repeater2">
                    <ItemTemplate>
                        <asp:Image class="mySlidexxs" ImageUrl='<%#"../../Uploads/Company/BackBanner/actual/"+ Eval("BannerImage")%>' runat="server" Width="100%" Height="370px" />
                    </ItemTemplate>
                </asp:Repeater>
            </div>
