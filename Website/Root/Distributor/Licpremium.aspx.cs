...
using System.Xml;
public partial class Root_Distributor_Licpremium : System.Web.UI.Page
{
    #region Access_Class
    ...
    {
        string policenumber = txt_userid.Text;
        ...
        string url = "https://www.mplan.in/api/insurance.php" + "?" + parameter;
        ...
        using (Stream dataStream = response.GetResponseStream())
        {
            ...
            if (ds.Tables["root"].Rows[0]["status"].ToString() == "1")
            {
                ...
                txt_cardname.Text = ds.Tables["records"].Rows[0]["CustomerName"].ToString();
                txt_date.Text = ds.Tables["records"].Rows[0]["Duedatefromto"].ToString();
