<%@ Page Title="" Language="C#" MasterPageFile="~/Root/Distributor/MemberMaster.master" AutoEventWireup="true" CodeFile="XpressPayout_report.aspx.cs" Inherits="Root_Distributor_XpressPayout_report" %>
    ...
    <script>
        ...
        app.controller("distributorCntrl", function ($scope, $http, $timeout) {
            ...
            $scope.filldmrnewreport = function () {
                ...
                var httpreq = {
                    method: 'POST',
                    url: '../Distributor/XpressPayout_report.aspx/filldmrnewreport',
                    headers: {
            ...
            $scope.filldmrnewreportbydate = function (fdate, tdate) {
                ...
                var httpreq = {
                    method: 'POST',
                    url: '../Distributor/XpressPayout_report.aspx/filldmrnewreportbydate',
                    headers: {
                        'Content-Type': 'application/json; charset=utf-8',
                        'dataType': 'json'
                    },
            ...
            function dmrreceipt(id) {
                var ID = id;
                $http({
                    url: '../Distributor/XpressPayout_report.aspx/loaddmrreceipt',
                    method: "POST",
                    data: { txnid: id }
