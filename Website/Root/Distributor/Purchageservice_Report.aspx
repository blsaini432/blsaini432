<%@ Page Title="" Language="C#" MasterPageFile="~/Root/Distributor/MemberMaster.master" AutoEventWireup="true" CodeFile="Purchageservice_Report.aspx.cs" Inherits="Root_Distributor_Purchageservice_Report" %>
    ...
    <script>
        ...
        app.controller("distributorCntrl", function ($scope, $http, $timeout) {
            ...
            $scope.filldmrreport = function () {
                ...
                var httpreq = {
                    method: 'POST',
                    url: '../Distributor/Purchageservice_Report.aspx/filldmrreport',
                    headers: {
            ...
            $scope.filldmrreportbydate = function (fdate, tdate) {
                ...
                var httpreq = {
                    method: 'POST',
                    url: '../Distributor/Purchageservice_Report.aspx/filldmrreportbydate',
                    headers: {
                        'Content-Type': 'application/json; charset=utf-8',
                        'dataType': 'json'
                    },
            ...
            function instantdmrreceipt(id) {
                ...
                var ID = id;
                $http({
                    url: '../Distributor/Purchageservice_Report.aspx/loaddmrreceipt',
                    method: "POST",
                    data: { txnid: id }
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="content-wrapper">
        <div class="page-header">
            <h3 class="page-title">Purchage Services Report
            </h3>
        </div>
                                        ...
                                        <div class="row" ng-repeat="y in instantdmrreceipt">
                                                <table class="table table-responsive ps--scrolling-y">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:Label ID="Label1" runat="server" Font-Bold="True" Font-Size="X-Large" Text="Purchase Services Recepite "></asp:Label>
                                                        </td>
                                                      <td></td>
                                                    </tr>
                                                    <tr>
