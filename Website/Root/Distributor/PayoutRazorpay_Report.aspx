<%@ Page Title="" Language="C#" MasterPageFile="~/Root/Distributor/MemberMaster.master" AutoEventWireup="true" CodeFile="PayoutRazorpay_Report.aspx.cs" Inherits="Root_Distributor_PayoutRazorpay_Report" %>
    ...
    <script>
        ...
        app.controller("distributorCntrl", function ($scope, $http, $timeout) {
            ...
            $scope.filldmrnewreport = function () {
                ...
                var httpreq = {
                    method: 'POST',
                    url: '../Distributor/PayoutRazorpay_Report.aspx/filldmrnewreport',
                    headers: {
            ...
            $scope.filldmrnewreportbydate = function (fdate, tdate) {
                ...
                var httpreq = {
                    method: 'POST',
                    url: '../Distributor/Payout_Razorpay_Report.aspx/filldmrnewreportbydate',
                    headers: {
                        'Content-Type': 'application/json; charset=utf-8',
                        'dataType': 'json'
                    },
            ...
            function dmrreceipt(id) {
                var ID = id;
                $http({
                    url: '../Distributor/Payout_Razorpay_Report.aspx/loaddmrreceipt',
                    method: "POST",
                    data: { txnid: id }
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="content-wrapper">
        <div class="page-header">
            <h3 class="page-title">Payout Report
            </h3>
        </div>
