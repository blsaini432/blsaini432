<%@ Page Title="" Language="C#" MasterPageFile="~/Root/Distributor/MemberMaster.master" AutoEventWireup="true" CodeFile="payout_Razorpay.aspx.cs" Inherits="Root_Distributor_payout_Razorpay" %>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div id="ifsc" runat="server" visible="false">
                                    <div class="form-group row">
                                        <div class="col-lg-3">
                                ...
                                <div id="name" runat="server" visible="false">
                                    <div class="form-group row">
                                        <div class="col-lg-3">
                                ...
                                <div id="mobile" runat="server" visible="false">
                                    <div class="form-group row">
                                        <div class="col-lg-3">
                                ...
                                <div id="mode" runat="server" visible="false">
                                    <div class="form-group row">
                                        <div class="col-lg-3">
                                            <label class="col-form-label">Transaction types<code>*</code></label>
                                        </div>
                                        <div class="col-lg-8">
                                            <asp:DropDownList ID="Transactionlist" runat="server" CssClass="btn btn-outline-dark  dropdown-toggle">
                                ...
                                <div id="amount" runat="server" visible="false">
                                  ...
                                  <div id="submit" runat="server" visible="false">
                                <div class="form-group row">
                                    <div class="col-lg-3">
                                    </div>
                                    <div class="col-lg-8">
                                        <asp:Button ID="btnSubmit" runat="server" Text="Submit"
                                            ValidationGroup="vgBeni" CssClass="btn btn-primary" OnClick="btn_contact_Click" />
                                        <asp:Button ID="btnReset" runat="server" Text="Reset"
                                            CssClass="btn btn-danger" OnClick="btnReset_Click" />
                                    </div>
                                </div>
                                      </div>
                                <div id="Payamount" runat="server" visible="false">
                                    <div class="form-group row">
                                        <div class="col-lg-3">
                                        </div>
                                        <div class="col-lg-8">
                                            <asp:Button ID="btn_pay" runat="server" Text="Submit"
                                                ValidationGroup="vgBeni" CssClass="btn btn-success" OnClick="btn_dmrotp_Click" />
                                            <asp:Button ID="btn_rest" runat="server" Text="Reset"
                                                CssClass="btn btn-danger" OnClick="btnSubmit_Click" />
                                        </div>
                                    </div>
                                </div>
                            </div>
