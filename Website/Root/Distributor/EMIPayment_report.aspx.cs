...
public partial class Root_Distributor_EMIPayment_report : System.Web.UI.Page
{
    ...
    public static List<Customer> filldmrreport()
    {
        ...
        dtEWalletTransaction = cls.select_data_dtNew("sp_emipayment_report", _lstparm);
        foreach (DataRow dtrow in dtEWalletTransaction.Rows)
        {
            ...
            cust.TxnID = dtrow["email"].ToString();
    ...
    protected void btn_export_Click(object sender, EventArgs e)
    {
        ...
        if (fromdate != "" && todate != "")
        {
            ...
            _lstparm.Add(new ParmList() { name = "@datefrom", value = changedatetommddyy(fromdate) });
            _lstparm.Add(new ParmList() { name = "@dateto", value = changedatetommddyy(todate) });
            dtExport = cls.select_data_dtNew("sp_emipayment_report", _lstparm);
