<%@ Page Title="" Language="C#" MasterPageFile="~/Root/Distributor/MemberMaster.master" AutoEventWireup="true" CodeFile="busnew.aspx.cs" Inherits="Root_Distributor_busnew" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <asp:Panel ID="pnlsearchbus" runat="server" CssClass="modal-content">
        <div class="content-wrapper">
            ...
            <div class="row grid-margin">
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <asp:DropDownList ID="ddl_leavingfrom" runat="server" CssClass="form-control">
                                        </asp:DropDownList>
                                    </div>
                                </div>
                            </div>
                ...
                <script>
          $('#<%=ddl_leavingfrom.ClientID%>').chosen();
      </script>
                 <script>
          $('#<%=ddl_goingto.ClientID%>').chosen();
      </script>
            </div>
        </div>
    </asp:Panel>
    ...
    <%--Popup seat layout--%>
    <asp:LinkButton ID="lnkDummssy" runat="server"></asp:LinkButton>
    <ajaxToolkit:ModalPopupExtender ID="ModalPopupseat" runat="server"
        PopupControlID="pnlseatlayout" TargetControlID="lnkDummssy" BackgroundCssClass="modalBackground">
    </ajaxToolkit:ModalPopupExtender>
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            <asp:Panel ID="pnlseatlayout" ClientIDMode="Static" runat="server" Visible="true" Width="70%" Height="600px" CssClass="modal-content" Style="display: none;">
               <div class="col-md-12">
                <div class="model_body">
                 ...
                 <table align="center">
                    <tr>
                        ...
                        <td>
                            <asp:DropDownList ID="dddroppingpoint" runat="server" CssClass="chzn-select"
                                TabIndex="2" Width="313px">
                            </asp:DropDownList>
                ...
                <div id="containers">
                    <div id="upperDeckContainer" runat="server" clientidmode="Static" style="border: 1px solid #000; padding: 2%; border-radius: 5px; width: 80%; height: 53%; display: inline-grid;">
                        <p>
                            Upper
                        </p>
                    </div>
                    <div id="lowerDeckContainer" runat="server" clientidmode="Static" style="border: 1px solid #000; padding: 2%; margin-top: 1%; border-radius: 5px; width: 80%; height: 53%; display: inline-grid;">
                        <p>
                            Lower
                        </p>
                    </div>
                    <%--<img src="images/Seatlayouts.jpg" />--%>
                    <div id="selectedSeatsContainer" runat="server" clientidmode="Static" style="margin-top: 2%; margin-bottom: 2%">
                        <div style="float: left;">
                            <div style="float: left;">
                                Seat(s)
                            </div>

                            <div id="seatsContainer" clientidmode="Static" style="float: left;" runat="server">
                            </div>
                        </div>
                        <div style="float: right;">
                            ...
                            <span id="fareContainer" clientidmode="Static" runat="server" style="float: left; color: green; font-weight: bold; border-width: 0;" enabled="true" width="20px"></span>
                            ...
                            <asp:HiddenField ID="hftotalFare" runat="server" ClientIDMode="Static" />
                            <asp:HiddenField ID="hfselectedseats" runat="server" ClientIDMode="Static" />
                            <asp:HiddenField ID="hfselectedseats1" runat="server" ClientIDMode="Static" />
                            <asp:HiddenField ID="hfselectedseats2" runat="server" ClientIDMode="Static" />
                            <asp:HiddenField ID="hfselectedseats3" runat="server" ClientIDMode="Static" />
                            <asp:HiddenField ID="hfselectedseats4" runat="server" ClientIDMode="Static" />
                            <asp:HiddenField ID="hfselectedseats5" runat="server" ClientIDMode="Static" />
                        </div>
                    ...
                    <div style="float: right;">
                        <asp:Button ID="btnnextseat" runat="server" BackColor="#392C70" Font-Bold="True" ForeColor="White" Height="37px" Text="Next" Width="90px" ValidationGroup="b" OnClick="btnnextseat_Click" />
    ...
    <asp:Panel ID="pnlpassangerlist" runat="server" Visible="true" Width="500px" CssClass="modal-content" Style="display: none; padding: 10px 20px 10px 20px;">
                ...
                <div class="model_body">
                    ...
                    <asp:Panel ID="pnlmain" runat="server" Visible="false">
                        ...
                        <table>
                            ...
                            <tr>
                                <td colspan="2" style="background-color: #1f59e3; padding: 2px 0 2px 10px;">
                            ...
                            <tr>
                                ...
                                <td class="auto-style3">
                                    <asp:Label ID="Label2" runat="server" BackColor="#201f1e" Font-Bold="True"
                    ...
                    <asp:Panel ID="pnlcopsg1" runat="server" Visible="false">
                        <table>
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:Label ID="Label6" runat="server" BackColor="#201f1e" Font-Bold="True"
                                        ForeColor="White" Text="Seat Name:"></asp:Label>
                    ...
                    <asp:Panel ID="pnlcopsg2" runat="server" Visible="false">
                        <table>
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:Label ID="Label10" runat="server" BackColor="#201f1e" Font-Bold="True"
                                        ForeColor="White" Text="Seat Name:"></asp:Label>
                    ...
                    <asp:Panel ID="pnlcopsg3" runat="server" Visible="false">
                        <table>
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:Label ID="Label14" runat="server" BackColor="#201f1e" Font-Bold="True"
                                        ForeColor="White" Text="Seat Name:"></asp:Label>
                    ...
                    <asp:Panel ID="pnlcopsg4" runat="server" Visible="false">
                        <table">
                            <tr>
                                ...
                                <td>
                                    <asp:Label ID="Label18" runat="server" BackColor="#201f1e" Font-Bold="True"
                                        ForeColor="White" Text="Seat Name:"></asp:Label>
                    ...
                    <asp:Panel ID="pnlcopsg5" runat="server" Visible="false">
                        <table">
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:Label ID="Label22" runat="server" BackColor="#201f1e" Font-Bold="True"
                                        ForeColor="White" Text="Seat Name:"></asp:Label>
                    ...
                    <asp:Panel ID="Panel1" runat="server">
                        <table>
                            <tr>
                                <td colspan="2" style="background-color: #1f59e3">
                            ...
                            <tr>
                                ...
                                <td align="right">
                                    <asp:Button ID="btnnextprocess" runat="server" ValidationGroup="vvv"
                                        BackColor="#392C70" Font-Bold="True" ForeColor="White" Height="37px"
    ...
    <asp:Panel ID="pnlbookedsummary" runat="server" Visible="true" Style="display: none; padding: 10px 20px 10px 20px;" Width="35%"
        CssClass="modal-content">
        <div class="row">
            <asp:Button ID="btnhideboarding1" CssClass="modal_close" runat="server"
                OnClick="btnhideboarding0_Click" Text="X" />
            <div class="col-md-12">
                <div class="model_body">
                    ...
                    <div class="box-body">
                        ...
                        <asp:Label ID="Label33" runat="server" Font-Bold="True" ForeColor="Black"
                            Text="Blocked Seats"></asp:Label>
                        <asp:Label ID="lblblockseats1" runat="server" Font-Bold="True"
                            ForeColor="White" BackColor="#499b5a"></asp:Label>
                        <hr>
                        <asp:Button ID="btnpaynow" runat="server" BackColor="#392C70" Font-Bold="True" ForeColor="White" Height="37px" margin-left="313px" Width="120px" ValidationGroup="b" OnClick="btnpaynow_Click" />
                    </div>
                </div>
            </div>
