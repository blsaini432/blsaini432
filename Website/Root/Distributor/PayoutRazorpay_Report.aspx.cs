...
public partial class Root_Distributor_PayoutRazorpay_Report : System.Web.UI.Page
{
    #region Properties
    ...
    public static List<Customer> filldmrnewreport()
    {
        ...
        dtEWalletTransaction = cls.select_data_dtNew("Ezulix_PayOut_Razorpay_Report", _lstparm);
    ...
    protected void btn_export_Click(object sender, EventArgs e)
    {
        ...
        if (fromdate != "" && todate != "")
        {
            ...
            _lstparm.Add(new ParmList() { name = "@datefrom", value = changedatetommddyy(fromdate) });
            _lstparm.Add(new ParmList() { name = "@dateto", value = changedatetommddyy(todate) });
            dtExport = cls.select_data_dtNew("Ezulix_PayOut_Razorpay_Report", _lstparm);
