<%@ Page Title="" Language="C#" MasterPageFile="~/Root/Distributor/MemberMaster.master" AutoEventWireup="true" CodeFile="DmrNewReport.aspx.cs" Inherits="Root_Distributor_DmrNewReport" %>
                                        ...
                                        <div class="row" ng-repeat="y in dmrreceipt">
                                            <div class="col-md-12">
                                                <table class="table table-responsive">
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <asp:Label ID="Label9" runat="server" Text="RRN Number"></asp:Label>
                                                        </td>
                                                        <td>{{y.RRNNO}}</td>
                                                    </tr>
                                                    <tr>
