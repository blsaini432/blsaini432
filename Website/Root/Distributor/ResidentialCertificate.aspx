<%@ Page Title="" Language="C#" MasterPageFile="~/Root/Distributor/MemberMaster.master" AutoEventWireup="true" CodeFile="ResidentialCertificate.aspx.cs" Inherits="Root_Distributor_ResidentialCertificate" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="content-wrapper">
        <div class="page-header">
            <h3 class="page-title">Residential Certificate
            </h3>
        </div>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="form-group row">
                                            <div class="col-lg-3">
                                                <label class="col-form-label">Residential Certificate  Fee<code>*</code></label>
                                            </div>
                                            <div class="col-lg-8">
