<%@ Page Title="" Language="C#" MasterPageFile="~/Root/Distributor/membermaster.master"
    AutoEventWireup="true" CodeFile="AccountOpenings.aspx.cs" Inherits="Root_Distributor_AccountOpenings" %>
    ...
    <script> 
        ...
        app.controller("distributorCntrl", function ($scope, $http, $timeout) {
             ...
             $scope.filldmrreport = function () {
                 ...
                 var httpreq = {
                     method: 'POST',
                     url: '../Distributor/AccountOpenings.aspx/filldmrreport',
                     headers: {
             ...
             $scope.filldmrreportbydate = function (fdate, tdate) {
                 ...
                 var httpreq = {
                     method: 'POST',
                     url: '../Distributor/AccountOpenings.aspx/filldmrreportbydate',
                     headers: {
                         'Content-Type': 'application/json; charset=utf-8',
                         'dataType': 'json'
                     },
             ...
             function instantdmrreceipt(id) {
                 ...
                 var ID = id;
                 $http({
                     url: '../Distributor/AccountOpenings.aspx/loaddmrreceipt',
                     method: "POST",
                     data: { txnid: id }
                                ...
                                <div class="table-responsive">
                                    ...
                                    <table id="tblEwalletsummary" class="table table-bordered table-hover">
                                        <thead>
                                            ...
                                            <td>
                                                  <a ng-href="{{x.NavigateURL}}" target="_blank">Click here</a>
                                            </td>
