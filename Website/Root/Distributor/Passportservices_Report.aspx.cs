...
public partial class Root_Distributor_Passportservices_Report : System.Web.UI.Page
{
    #region Properties
    ...
    [WebMethod]
    public static List<Customer> Passportservices_Report()
    {
    ...
    [WebMethod]
    public static List<Customer> Passportservices_Reportbydate(string fromdate, string todate)
    {
        DataTable dt = (DataTable)HttpContext.Current.Session["dtDistributor"];
        int MsrNo = Convert.ToInt32(dt.Rows[0]["MsrNo"]);
        DataTable dtEWalletTransaction = new DataTable();
    ...
    protected void btn_export_Click(object sender, EventArgs e)
    {
        ...
        if (fromdate != "" && todate != "")
        {
            ...
            {
                Common.Export.ExportToExcel(dtExport, "passport_Report");
            }
            else
            {
