<%@ Page Title="" Language="C#" MasterPageFile="~/Root/Distributor/MemberMaster.master" AutoEventWireup="true" CodeFile="IncomeCertificate.aspx.cs" Inherits="Root_Distributor_IncomeCertificate" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="content-wrapper">
        <div class="page-header">
            <h3 class="page-title">Income Certificate 
            </h3>
        </div>
        <div class="row">
            <div class="col-lg-12">              
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="form-group row">
                                            <div class="col-lg-3">
                                                <label class="col-form-label">Income Certificate  Fee<code>*</code></label>
                                            </div>
                                            <div class="col-lg-8">
