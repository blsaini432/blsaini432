...
using BLL;
public partial class Root_Distributor_icicaepscommi : System.Web.UI.Page
{
    #region [Properties]
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            dtOperator = objconnection.select_data_dt("Exec MM_m_Ezulix_IciciAeps_Surcharge 0,'" + Packageid + "','0',0");
