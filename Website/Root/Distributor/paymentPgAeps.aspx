<%@ Page Title="" Language="C#" MasterPageFile="~/Root/Distributor/MemberMaster.master" AutoEventWireup="true" CodeFile="paymentPgAeps.aspx.cs" Inherits="Root_Distributor_paymentPgAeps" %>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-8">
                                        <label class="col-form-label">Maxmium Amount 12 and minimum Amount 1.5%<code></code></label>
