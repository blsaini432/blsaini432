...
public partial class Root_Distributor_dmr : System.Web.UI.Page
{
    ...
    {
        "Zero",
        "Dear Customer, @v1@ is your OTP to  access DMT Transaction for Rs. @v0@  and Never Share it with anyone. Bank Never calls to verify it."//1
