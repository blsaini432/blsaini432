...
public partial class Root_Distributor_Franchise_report : System.Web.UI.Page
{
    #region Properties
    ...
    public static List<Customer> filldmrreport()
    {
        ...
        dtEWalletTransaction = cls.select_data_dtNew("sp_Franchis_report", _lstparm);
    ...
    protected void btn_export_Click(object sender, EventArgs e)
    {
        ...
        if (fromdate != "" && todate != "")
        {
            ...
            _lstparm.Add(new ParmList() { name = "@datefrom", value = changedatetommddyy(fromdate) });
            _lstparm.Add(new ParmList() { name = "@dateto", value = changedatetommddyy(todate) });
            dtExport = cls.select_data_dtNew("sp_Franchis_report", _lstparm);
            if (dtExport.Rows.Count > 0)
            {
                Common.Export.ExportToExcel(dtExport, "Franchis Report");
            }
            else
            {
