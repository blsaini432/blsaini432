        ...
        if (Session["userid"] != null && Session["Amount"] != null)
        {
            try
            {
               ...
               // body.Add("PaymentMode", payPaymentModeArray);
                ...
                body.Add("mid", "Runfin01656809110447");
                body.Add("websiteName", "DEFAULT");
                body.Add("orderId", orderid);
                body.Add("txnAmount", txnAmount);
                body.Add("userInfo", userInfo);
                body.Add("callbackUrl", "http://localhost:59492/Root/Distributor/Paytmcallback.aspx");
                string paytmChecksum = Checksum.generateSignature(JsonConvert.SerializeObject(body), "nVcHEW860EUcpO2Q");
                head.Add("signature", paytmChecksum);
                requestBody.Add("body", body);
                requestBody.Add("head", head);
                string post_data = JsonConvert.SerializeObject(requestBody);
                //For  Staging
                string url = "https://securegw-stage.paytm.in/theia/api/v1/initiateTransaction?mid=Runfin01656809110447&orderId=" + orderid + "";

                //For  Production 
               //   string  url  = "https://securegw.paytm.in/theia/api/v1/initiateTransaction?mid=Fritwa43748969852592&orderId=" + orderid + "";
