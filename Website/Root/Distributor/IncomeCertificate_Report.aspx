<%@ Page Title="" Language="C#" MasterPageFile="~/Root/Distributor/MemberMaster.master"
    AutoEventWireup="true" CodeFile="IncomeCertificate_Report.aspx.cs" Inherits="Root_Distributor_IncomeCertificate_Report" %>
    ...
    <script>
        ...
        app.controller("distributorCntrl", function ($scope, $http, $timeout) {
            ...
            $scope.fillelectricityreport = function () {
                var httpreq = {
                    method: 'POST',
                    url: '../Distributor/IncomeCertificate_Report.aspx/panreport',
                    headers: {
            ...
            $scope.fillelectricityreportbydate = function (fdate, tdate) {
                ...
                var httpreq = {
                    method: 'POST',
                    url: '../Distributor/IncomeCertificate_Report.aspx/panreportbydate',
                    headers: {
                        'Content-Type': 'application/json; charset=utf-8',
                        'dataType': 'json'
                    },
            ...
            function ReadRecord(id) {
                ...
                var ID = id;
                $http({
                    url: '../Distributor/IncomeCertificate_Report.aspx/loadreceipt',
                    method: "POST",
                    data: { txnid: id }
