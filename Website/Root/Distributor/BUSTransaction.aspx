...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script>
        ...
        //Recharge
            ...
            var httpreq = {
                method: 'POST',
                url: '../Distributor/BUSTransaction.aspx/fillbusreport',
                headers: {
        ...
        $scope.Readinstantdmrreceipt = function (id){
            ...
            var httpreq = {
                method: 'POST',
                url: '../Distributor/BUSTransaction.aspx/loadreceipt',
                headers: {
                    'Content-Type': 'application/json; charset=utf-8',
                    'dataType': 'json'
                },
        ...
        $scope.fillrechargereportbydate = function (fdate, tdate) {
            ...
            var httpreq = {
                method: 'POST',
                url: '../Distributor/BUSTransaction.aspx/fillbusreportbydate',
                headers: {
                    'Content-Type': 'application/json; charset=utf-8',
                    'dataType': 'json'
                },
