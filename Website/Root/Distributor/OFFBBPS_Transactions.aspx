<%@ Page Title="" Language="C#" MasterPageFile="~/Root/Distributor/MemberMaster.master"
    AutoEventWireup="true" CodeFile="OFFBBPS_Transactions.aspx.cs" Inherits="Root_Distributor_OFFBBPS_Transactions" %>
     ...
     <script> 
         ...
         app.controller("DistributorCntrl", function ($scope, $http, $timeout) {
             ...
             $scope.fillelectricityreport = function () {
                 var httpreq = {
                     method: 'POST',
                     url: '../Distributor/OFFBBPS_Transactions.aspx/fillelectricityreport',
                     headers: {
             ...
             $scope.fillelectricityreportbydate = function (fdate, tdate) {
                 ...
                 var httpreq = {
                     method: 'POST',
                     url: '../Distributor/OFFBBPS_Transactions.aspx/fillelectricityreportbydate',
                     headers: {
                         'Content-Type': 'application/json; charset=utf-8',
                         'dataType': 'json'
                     },
             ...
             function ReadRecord(id) {
                 ...
                 var ID = id;
                 $http({
                     url: '../Distributor/OFFBBPS_Transactions.aspx/loadreceipt',
                     method: "POST",
                     data: { txnid: id }
                                    ...
                                    <table id="tblEwalletsummary" class="table table-bordered table-hover">
                                        <thead>
                                            ...
                                            <tr ng-show="ElectrictyReport.length!=0" dir-paginate="x in ElectrictyReport|filter:search|itemsPerPage:pageSize">
                                                ...
                                                <td>{{x.msg}}</td>
                                                <td>{{x.paydate}}</td>
                                               <td><a target="_blank" href="OFFBBPS_Receipt.aspx?refidforreceipt={{x.agent_id}}"  class="badge badge-success badge-pill" title="click to view member detail">View</a></td>
                                            </tr>
                                            <tr>
