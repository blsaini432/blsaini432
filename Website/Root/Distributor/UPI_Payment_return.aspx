<%@ Page Language="C#" AutoEventWireup="true" CodeFile="UPI_Payment_return.aspx.cs" Inherits="Root_Distributor_UPI_Payment_return" %>
...
<body">
    ...
    <script>
        ...
        payment_form.addEventListener("submit", function (e) {
            ...
            $.ajax({
                type: "POST",
                url: "../Distributor/UPI_Payment_return.aspx/getdata",
