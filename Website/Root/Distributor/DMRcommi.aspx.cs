...
public partial class Root_Distributor_DMRcommi : System.Web.UI.Page
{
    #region [Properties]
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            dtOperator = objconnection.select_data_dt("Exec MM_getSurcharge_Ezulix_PayOut 0,'" + Packageid + "','0',0");
