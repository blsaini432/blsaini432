<%@ Page Title="" Language="C#" MasterPageFile="~/Root/Distributor/MemberMaster.master" AutoEventWireup="true" CodeFile="RechargePanel.aspx.cs" Inherits="Root_Distributor_RechargePanel" %>
                                                ...
                                                <asp:UpdatePanel ID="UpdatePanel_Home" runat="server">
                                                    <ContentTemplate>
                                                        <div class="row">
                                                            ...
                                                            <div id="goplan" runat="server" visible="false">
                                                                <asp:Button ID="btn" OnClick="btn_checkoperater" class="btn btn-raised btn-raised btn-primary" Text="view plan" runat="server"></asp:Button>
                                                            </div>
                                                            <div id="operate" runat="server">
                                                                <div class="col-md-6">
                                                            ...
                                                            <div id="oper" runat="server" visible="false">
                                                                <div class="col-md-6">
                                                                    <label class="label-control" for="projectinput6">
                                                                        Operator</label>
                                                                    <asp:TextBox ID="txt_operater" runat="server"  class="form-control" ValidationGroup="vgPrepaid"></asp:TextBox>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            <div id="circle" runat="server">
                                                                <div class="col-md-6">
                                                             ...
                                                             <div id="btncricle" runat="server" visible="false">
                                                                <div class="col-md-6">
                                                                    <label class="label-control" for="projectinput6">
                                                                        Circle</label>
                                                                    <asp:TextBox ID="txt_cricle" runat="server" MaxLength="50" class="form-control" ValidationGroup="vgPrepaid"></asp:TextBox>
                                                                </div>
                                                            </div>
                                                            <div id="Amount" runat="server">
                                                                <div class="col-md-6">
                                                                    <div class="form-group">
                                                        ...
                                                        <div class="row">
                                                            <div id="btn_prepaid" runat="server" visible="false">
                                                                <div class="col-md-6">
                                                                    <div class="form-group">
