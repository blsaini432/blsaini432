...
public partial class Root_Distributor_Certificate : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            img1.ImageUrl = string.IsNullOrEmpty(Convert.ToString(dtMemberMaster.Rows[0]["MemberImage"])) ? "../../Uploads/User/Profile/dummy.png" : "../../Uploads/User/Profile/" + Convert.ToString(dtMemberMaster.Rows[0]["MemberImage"]);
