<%@ Page Title="" Language="C#" MasterPageFile="~/Root/Distributor/MemberMaster.master" AutoEventWireup="true" CodeFile="AepsNewTranscation.aspx.cs" Inherits="Root_Distributor_AepsNewTranscation" %>
    ...
    <style>
      ...
      app.controller("distributorCntrl", function ($scope, $http, $timeout) {
          ...
          function instantdmrreceipt(id) {
              ...
              var ID = id;
              $http({
                  url: '../Distributor/AepsNewTranscation.aspx/loadreceipt',
                  method: "POST",
                  data: { txnid: id }
