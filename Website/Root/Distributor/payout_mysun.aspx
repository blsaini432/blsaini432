<%@ Page Title="" Language="C#" MasterPageFile="~/Root/Distributor/MemberMaster.master" AutoEventWireup="true" CodeFile="payout_mysun.aspx.cs" Inherits="Root_Distributor_payout_mysun" %>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    <div class="col-lg-3">
                                        <label class="col-form-label">bene_name<code>*</code></label>
                                    </div>
                                    <div class="col-lg-8">
                                ...
                                <%--<div class="form-group row">
                                    ...
                                    <div class="col-lg-8">
                                        <asp:TextBox ID="txt_email" CssClass="form-control" runat="server" Enabled="false" Style="text-transform: uppercase"
                                            autocomplete="off" MaxLength="50"></asp:TextBox>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-8">
                                        <asp:DropDownList ID="Transactionlist" runat="server" CssClass="btn btn-outline-dark  dropdown-toggle">
                                            ...
                                            <asp:ListItem Value="NPN">IMPS</asp:ListItem>
                                            <asp:ListItem Value="MPN">RTGS</asp:ListItem>
                                            <asp:ListItem Value="LPN">NEFT</asp:ListItem>
                                        </asp:DropDownList>
                                ...
                                <div class="form-group row">
                                    <div class="col-lg-3">
                                        <label class="col-form-label">Credit Amount<code>*</code></label>
                                    </div>
                                    <div class="col-lg-8">
