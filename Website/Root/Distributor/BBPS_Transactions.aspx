<%@ Page Title="" Language="C#" MasterPageFile="~/Root/Distributor/MemberMaster.master"
    AutoEventWireup="true" CodeFile="BBPS_Transactions.aspx.cs" Inherits="Root_Distributor_BBPS_Transactions" %>
     ...
     <script> 
         ...
         app.controller("DistributorCntrl", function ($scope, $http, $timeout) {
             ...
             $scope.fillelectricityreport = function () {
                 var httpreq = {
                     method: 'POST',
                     url: '../Distributor/BBPS_Transactions.aspx/fillelectricityreport',
                     headers: {
             ...
             $scope.fillelectricityreportbydate = function (fdate, tdate) {
                 ...
                 var httpreq = {
                     method: 'POST',
                     url: '../Distributor/BBPS_Transactions.aspx/fillelectricityreportbydate',
                     headers: {
                         'Content-Type': 'application/json; charset=utf-8',
                         'dataType': 'json'
                     },
             ...
             function ReadRecord(id) {
                 ...
                 var ID = id;
                 $http({
                     url: '../Distributor/BBPS_Transactions.aspx/loadreceipt',
                     method: "POST",
                     data: { txnid: id }
