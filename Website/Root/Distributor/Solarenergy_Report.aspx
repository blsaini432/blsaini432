<%@ Page Title="" Language="C#" MasterPageFile="~/Root/Distributor/MemberMaster.master" AutoEventWireup="true" CodeFile="Solarenergy_Report.aspx.cs" Inherits="Root_Distributor_Solarenergy_Report" %>
       ...
       <script>
           ...
           app.controller("retailerCntrl", function ($scope, $http, $timeout) {
               ...
               function instantdmrreceipt(id) {
                   ...
                   var ID = id;
                   $http({
                       url: '../Distributor/Solarenergy_Report.aspx/loadreceipt',
                       method: "POST",
                       data: { txnid: id }
               ...
               $scope.fillaepstransaction = function () {
                   ...
                   var httpreq = {
                       method: 'POST',
                       url: '../Distributor/Solarenergy_Report.aspx/fillaepstransactions',
                       headers: {
               ...
               $scope.fillaepstransactionbydate = function (fdate, tdate) {
                   ...
                   var httpreq = {
                       method: 'POST',
                       url: '../Distributor/Solarenergy_Report.aspx/fillaepstransactionsbydate',
                       headers: {
                           'Content-Type': 'application/json; charset=utf-8',
                           'dataType': 'json'
                       },
...
<asp:Content ID="Content4" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
       <div class="content-wrapper">
        <div class="page-header">
            <h3 class="page-title">Solar energy Report 
            </h3>
        </div>
