<%@ Page Title="" Language="C#" MasterPageFile="~/Root/Distributor/MemberMaster.master" AutoEventWireup="true" CodeFile="yesbankdmr.aspx.cs" Inherits="Root_Distributor_yesbankdmr" %>
           ...
           <div class="row" id="divhome" runat="server">
                      ...
                      <ul class="nav nav-tabs nav-tabs-vertical" role="tablist">
                        ...
                        <li class="nav-item">
                          ...
                          <i class="fa fa-user text-danger ml-2"></i>
                           ...
                           <li class="nav-item">
                          <a class="nav-link" id="profile-tab-verticaly" data-toggle="tab" href="#profile-5" role="tab" aria-controls="profile-5" aria-selected="false">
                          Customer Verify
                          <i class="fa fa-user text-danger ml-2"></i>
                          </a>
                        </li>
                ...
                <div class="card">
                    <div class="card-body">
                            ...
                            <div class="col">
                             <asp:TextBox ID="txt_Name" autocomplete="off" MaxLength="30" CssClass="form-control" placeholder="Enter Customer Name"
                                            ...
                                            <asp:RequiredFieldValidator ID="rfv_name" runat="server" CssClass="rfv" ControlToValidate="txt_Name"
                                                ErrorMessage="Please Enter Customer Name !" ValidationGroup="vg_reg" SetFocusOnError="true"></asp:RequiredFieldValidator>
                                      ...
                                      <div class="form-group row">
                            <div class="col-lg-3">
                                <label class="col-form-label">Beneficiary Name<code>*</code></label>
                            </div>
                            <div class="col">
                           <asp:TextBox ID="txt_SurName" autocomplete="off" MaxLength="30" CssClass="form-control"
                                                placeholder="Enter Beneficiary Name" TabIndex="1" runat="server"></asp:TextBox>
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" CssClass="rfv"
                                                ControlToValidate="txt_SurName" ErrorMessage="Please Enter beneficiary Name!" ValidationGroup="vg_reg"
                                  ...
                                  <div class="form-group row">
                            <div class="col-lg-3">
                                <label class="col-form-label">Customer Mobile<code>*</code></label>
                            </div>
                            <div class="col">
                            <asp:TextBox ID="txt_Mobile" CssClass="form-control" MaxLength="10" autocomplete="off"
                                            ...
                                            <asp:RequiredFieldValidator ID="rfv_Mobile" runat="server" CssClass="rfv" ControlToValidate="txt_Mobile"
                                                ErrorMessage="Please Enter Customer Mobile No. !" ValidationGroup="vg_reg" SetFocusOnError="true"></asp:RequiredFieldValidator>
                         ...
                         <div class="form-group row">
                            <div class="col-lg-3">
                                <label class="col-form-label">Bank Account No.<code>*</code></label>
                            </div>
                            <div class="col">
                            <asp:TextBox ID="txt_account" autocomplete="off" MaxLength="20" CssClass="form-control" placeholder="Enter Bank Account No."
                                                TabIndex="3" runat="server"></asp:TextBox>
                                            <asp:RequiredFieldValidator ID="rfv_Pin" runat="server" CssClass="rfv" ControlToValidate="txt_account"
                                                ErrorMessage="Please Enter Bank Account No. !" ValidationGroup="vg_reg" SetFocusOnError="true"></asp:RequiredFieldValidator>
                                            <cc1:FilteredTextBoxExtender ID="FilteredTextBoxExtender_Pin" runat="server" TargetControlID="txt_account"
                                                ValidChars="0123456789">
                                            </cc1:FilteredTextBoxExtender>
                            </div>
                  </div>
                        <div class="form-group row">
                            <div class="col-lg-3">
                                <label class="col-form-label">Bank IFSC Code<code>*</code></label>
                            </div>
                            <div class="col">
                            <asp:TextBox ID="txt_ifsc" autocomplete="off" MaxLength="20" CssClass="form-control" placeholder="Enter Bank IFSC Code"
                                                TabIndex="3" runat="server"></asp:TextBox>
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" CssClass="rfv" ControlToValidate="txt_ifsc"
                                                ErrorMessage="Please Enter Bank IFSC Code !" ValidationGroup="vg_reg" SetFocusOnError="true"></asp:RequiredFieldValidator>
                        ...
                        <div class="form-group row">
                         ...
                         <asp:Button ID="btn_login" ValidationGroup="vglogin" runat="server" Text="Continue" class="btn btn-primary btn-lg btn-block" OnClientClick="if (!Page_ClientValidate('vglogin')){ return false; } this.disabled = true; this.value = 'Submitting...Please Wait';" OnClick="btn_login_Click1" UseSubmitBehavior="false" /> 
                          ...
                          <asp:PostBackTrigger ControlID="btn_login" />
                           ...
                           <div class="tab-pane fade" id="profile-5" role="tabpanel" aria-labelledby="profile-tab-verticaly">
                     <div class="row grid-margin" id="divcusverify" runat="server" visible="true">
                                       <div class="col-12">
                <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                    ...
                    <div class="card-body">
                        <div class="form-group row">
                            ...
                            <div class="col">
                                <asp:TextBox ID="txt_verifycus" runat="server"  placeholder="Customer Mobile Number" autocomplete="off" CssClass="form-control" MaxLength="10"></asp:TextBox>
                               <asp:RequiredFieldValidator ID="RequiredFieldValidator8" runat="server" ControlToValidate="txt_verifycus"
                                                    SetFocusOnError="True" Display="Dynamic" ErrorMessage="Invalid Customer Mobile Number"
                                                    ValidationGroup="vgrlogin"></asp:RequiredFieldValidator>
                                   <cc1:FilteredTextBoxExtender ID="FilteredTextBoxExtender7" runat="server" ValidChars="0123456789"
                                                    TargetControlID="txt_verifycus">
                                                </cc1:FilteredTextBoxExtender>
                            </div>
                  </div>
                              <div class="form-group row">
                            ...
                            <div class="col-lg-8">
                                 <asp:HiddenField ID="hidStatusss" runat="server" Value="0" />
                         <asp:Button ID="btn_cusverify" ValidationGroup="vgrlogin" runat="server" Text="Continue" class="btn btn-primary btn-lg btn-block" OnClientClick="if (!Page_ClientValidate('vgrlogin')){ return false; } this.disabled = true; this.value = 'Submitting...Please Wait';" onclick="btn_customer_verify" UseSubmitBehavior="false" /> 
                          ...
                          <asp:PostBackTrigger ControlID="btn_cusverify" />
                    </Triggers></asp:UpdatePanel></div>
                           </div>
                        </div>
                             <%-----ModalPopupBeneOTP-----%>  
        <input type="button" value="OpenModalPopup" id="openid" runat="server" style="display: none;" />
        <input type="button" value="CloseModalPopup" id="btncl" runat="server" style="display: none;" />
                 <cc1:ModalPopupExtender ID="btncusverify" runat="server" PopupControlID="Panel_gDel" TargetControlID="openid"
            CancelControlID="btncl" BackgroundCssClass="modalBackground">
        </cc1:ModalPopupExtender>
                 <asp:Panel ID="Panel_gDel" runat="server" CssClass="modalPopup" align="center" Style="display: none">
                       <div>
                            ...
                            <div class="col">
                                    ...
                                    <asp:TextBox ID="txt_cusotp" runat="server" CssClass="form-control" MaxLength="6"></asp:TextBox>
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator9" runat="server" ControlToValidate="txt_cusotp"
                            ErrorMessage="*" ValidationGroup="vgOtp"><img src="../../images/warning.png" /></asp:RequiredFieldValidator>
                                             <cc1:FilteredTextBoxExtender ID="FilteredTextBoxExtender8" runat="server" ValidChars="0123456789"
                                                    TargetControlID="txt_cusotp">
                                                </cc1:FilteredTextBoxExtender>
                            </div>
                  </div>
                                                    <div class="form-group row">
                         <asp:Button ID="btn_if" runat="server" Text="Submit"  CssClass="btn btn-primary btn-lg btn-block" ValidationGroup="vgOtp" OnClick="btn_customer_verifyotp" OnClientClick="if (!Page_ClientValidate('vgOtp')){ return false; } this.disabled = true; this.value = 'Validating OTP...';"  UseSubmitBehavior="false"/>
                                                    </div>
                                                </div>
                                            </div>
              ...
              <div class="col-lg-6 col-xs-6">
                <div class="row">
                  <div class="col-md-12" align="left">
                       <td><a href="#openModal" class="btn btn-warning btn-icon-text" title="click to view member detail">Change Remitter<i class="fas fa-pencil-alt btn-icon-append"></i></a></td>
                  </div>
                </div>
                <div class="row">
                  <div class="col-md-12" align="left">
                  ...
                  <div class="row">
                   <strong>Remaining</strong>
                      ...
                      <div class="row">
                            ...
                            <div class="col-lg-9">
                                  <asp:DropDownList ID="ddl_choosebank" runat="server" CssClass="btn btn-outline-dark  dropdown-toggle" style="width:100%;"
  ...
  <div class="col-lg-6">
      <asp:TextBox ID="txt_dmrotp" runat="server" MaxLength="6" CssClass="form-control"></asp:TextBox>
                ...
                <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="txt_dmrotp" ErrorMessage="Enter OTP" ForeColor="Red" ValidationGroup="v"></asp:RequiredFieldValidator>
                           ...
                           <div class="form-group row" id="divremotp" runat="server" visible="false">
                          <div class="col-lg-3">
                              <label class="col-form-label">Enter OTP</label>
                              </div>
  <div class="col-lg-6">
      <asp:TextBox ID="txt_remotp" runat="server" MaxLength="6" CssClass="form-control"></asp:TextBox>
                <cc1:FilteredTextBoxExtender ID="FilteredTextBoxExtender6" runat="server" TargetControlID="txt_remotp"
                                                ValidChars="0123456789">
                                            </cc1:FilteredTextBoxExtender>
                <asp:RequiredFieldValidator ID="RequiredFieldValidator7" runat="server" ControlToValidate="txt_remotp" ErrorMessage="Enter OTP" ForeColor="Red" ValidationGroup="v"></asp:RequiredFieldValidator>
                            ...
                            <div class="col-lg-9">
                                ...
                                <asp:Button ID="btn_dmrotp" Visible="false" CssClass="btn btn-primary btn-lg btn-block" runat="server" Text="Proceed" UseSubmitBehavior="false" OnClick="btn_dmrotp_Click" OnClientClick="if (!Page_ClientValidate('v')){ return false; } this.disabled = true; this.value = 'Verifying OTP...';" ValidationGroup="v"/>
                                   <asp:Button ID="btn_remterotp" Visible="false" CssClass="btn btn-primary btn-lg btn-block" runat="server" Text="Proceed" UseSubmitBehavior="false" OnClick="btn_remterotp_Click" OnClientClick="if (!Page_ClientValidate('v')){ return false; } this.disabled = true; this.value = 'Verifying OTP...';" ValidationGroup="v"/>
                            </div>
                        </div>
                    ...
                    <div id="openModal" class="modalDialog">
                            ...
                            <div class="col">
                                ...
                                <asp:TextBox ID="txt_changerem" runat="server"  placeholder="Remitter Mobile Number" autocomplete="off" CssClass="form-control" MaxLength="10"></asp:TextBox>
                           
                                             <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txt_changerem"
                                                    SetFocusOnError="True" Display="Dynamic" ErrorMessage="Invalid Remitter Mobile Number"
                                                    ValidationGroup="vglogin"></asp:RequiredFieldValidator>
                                             <cc1:FilteredTextBoxExtender ID="FilteredTextBoxExtender3" runat="server" ValidChars="0123456789"
                                                    TargetControlID="txt_changerem">
                                                </cc1:FilteredTextBoxExtender>
                            </div>
                  </div>
                                                    <div class="form-group row">
                                                                                 <asp:Button ID="btn_loginnew" ValidationGroup="vglogin" runat="server" Text="Continue" class="btn btn-primary btn-lg btn-block" OnClientClick="if (!Page_ClientValidate('vglogin')){ return false; } this.disabled = true; this.value = 'Submitting...Please Wait';" OnClick="btn_loginnew_customer" UseSubmitBehavior="false" />  
                                                    </div>
        ...
        <ProgressTemplate>
            ...
            <div> <strong>Please Wait.. While We are Verifying Your Details</strong></div>
                                ...
                                <div class="row">
                  <div class="col-md-12" align="left">
                      <asp:Button ID="btnaddbenecheck" runat="server" CssClass="btn btn-info btn-icon-text" Text="Add New Benificiary" OnClick="btnaddbenecheck_Click" />
                ...
                <asp:UpdatePanel ID="UpdatePanel_BeneficiaryDetails" runat="server">
                    ...
                    <asp:Repeater ID="rpt_benificiary" runat="server" OnItemCommand ="gv_Benificerydetails_RowCommand">
                        <ItemTemplate>
                <div class="form-group row">
                     <div class="col-lg-6 col-xs-6"><div><strong style="font-size:12px;"><%# Eval("BENE_NAME") %></strong></div><div style="color:#666;font-size:11px; line-height:1.5">A/c: <%# Eval("BANK_ACCOUNTNO") %></div><div style="color:#666;font-size:11px; line-height:1.5; margin-bottom:6px;">IFSC:&nbsp;<%# Eval("BANKIFSC_CODE") %></div></div>
                       <div class="col-lg-6 col-xs-6" align="right"> 
                             <asp:Button ID="Button1" runat="server" Text="Transfer" CssClass="btn btn-success" CommandName="imps" CommandArgument='<%#Eval("BENE_ID")%>' ToolTip="Click to transfer to Benificery" />   
                           <asp:Button ID="btn_Delete" runat="server" Text="Delete" CssClass="btn btn-danger " CommandName="del" CommandArgument='<%#Eval("BENE_ID")%>' ToolTip="Click to delete to Benificery" />   
                     </div>
               </div>
