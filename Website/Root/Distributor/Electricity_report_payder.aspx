<%@ Page Title="" Language="C#" MasterPageFile="~/Root/Distributor/MemberMaster.master"
    AutoEventWireup="true" CodeFile="Electricity_report_payder.aspx.cs" Inherits="Root_Distributor_Electricity_report_payder" %>
    ...
    <script>
        ...
        app.controller("distributorCntrl", function ($scope, $http, $timeout) {
            ...
            $scope.fillelectricityreport = function () {
                var httpreq = {
                    method: 'POST',
                    url: '../Distributor/Electricity_report_payder.aspx/fillelectricityreport',
                    headers: {
            ...
            $scope.fillelectricityreportbydate = function (fdate, tdate) {
                ...
                var httpreq = {
                    method: 'POST',
                    url: '../Distributor/Electricity_report_payder.aspx/fillelectricityreportbydate',
                    headers: {
                        'Content-Type': 'application/json; charset=utf-8',
                        'dataType': 'json'
                    },
            ...
            function ReadRecord(id) {
                ...
                var ID = id;
                $http({
                    url: '../Distributor/Electricity_report_payder.aspx/loadreceipt',
                    method: "POST",
                    data: { txnid: id }
