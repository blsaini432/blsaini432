<%@ Page Title="" Language="C#" MasterPageFile="~/Root/Distributor/MemberMaster.master"
    AutoEventWireup="true" CodeFile="Electricitytranscation.aspx.cs" Inherits="Root_Distributor_Electricitytranscation" %>
                                    ...
                                    <table id="tblEwalletsummary" class="table table-bordered table-hover">
                                        <thead>
                                            ...
                                            <tr ng-show="ElectrictyReport.length!=0" dir-paginate="x in ElectrictyReport|filter:search|itemsPerPage:pageSize">
                                                ...
                                                <td>{{x.paydate}}</td>
                                                 <td>
                                                 <a href="../../Uploads/Servicesimage/Actual/{{x.receipt}}"  target="_blank"><img alt="{{x.receipt}}" ng-src="../../Uploads/Servicesimage/Actual/{{x.receipt}}"  style="height:100px;width:100px" /></a> 
                                                    ...
                                                    <div class="col-md-12">
                                                        <table class="table table-responsive">
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <img src="../../Uploads/Company/actual/bbps.png" /></td>
                                                            </tr>
                                                            <tr>
                                                                <td>
