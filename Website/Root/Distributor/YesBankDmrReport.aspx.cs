...
public partial class Root_Distributor_YesBankDmrReport : System.Web.UI.Page
{
    ...
    public static List<Customer> filldmrreport()
    {
        ...
        dtEWalletTransaction = cls.select_data_dtNew("yesbank_DMR_transaction", _lstparm);
    ...
    protected void btn_export_Click(object sender, EventArgs e)
    {
        ...
        if (fromdate != "" && todate != "")
        {
            ...
            _lstparm.Add(new ParmList() { name = "@datefrom", value = changedatetommddyy(fromdate) });
            _lstparm.Add(new ParmList() { name = "@dateto", value = changedatetommddyy(todate) });
            dtExport = cls.select_data_dtNew("yesbank_DMR_transaction", _lstparm);
            if (dtExport.Rows.Count > 0)
            {
                Common.Export.ExportToExcel(dtExport, "YesbankDmrreport_Report");
            }
            else
            {
