<%@ Page Title="" Language="C#" MasterPageFile="~/Root/Distributor/MemberMaster.master"
    AutoEventWireup="true" CodeFile="BBPS_Transactions_New.aspx.cs" Inherits="Root_Distributor_BBPS_Transactions_New" %>
     ...
     <script> 
         ...
         app.controller("DistributorCntrl", function ($scope, $http, $timeout) {
             ...
             $scope.fillelectricityreport = function () {
                 var httpreq = {
                     method: 'POST',
                     url: '../Distributor/BBPS_Transactions_New.aspx/fillelectricityreport',
                     headers: {
             ...
             $scope.fillelectricityreportbydate = function (fdate, tdate) {
                 ...
                 var httpreq = {
                     method: 'POST',
                     url: '../Distributor/BBPS_Transactions_New.aspx/fillelectricityreportbydate',
                     headers: {
                         'Content-Type': 'application/json; charset=utf-8',
                         'dataType': 'json'
                     },
             ...
             function ReadRecord(id) {
                 ...
                 var ID = id;
                 $http({
                     url: '../Distributor/BBPS_Transactions_New.aspx/loadreceipt',
                     method: "POST",
                     data: { txnid: id }
