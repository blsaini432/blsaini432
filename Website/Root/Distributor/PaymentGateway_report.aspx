<%@ Page Title="" Language="C#" MasterPageFile="~/Root/Distributor/MemberMaster.master" AutoEventWireup="true" CodeFile="PaymentGateway_report.aspx.cs" Inherits="Root_Distributor_PaymentGateway_report" %>
    ...
    <script>
        ...
        app.controller("distributorCntrl", function ($scope, $http, $timeout) {
            ...
            $scope.filldmrreport = function () {
                ...
                var httpreq = {
                    method: 'POST',
                    url: '../Distributor/PaymentGateway_report.aspx/filldmrreport',
                    headers: {
            ...
            $scope.filldmrreportbydate = function (fdate, tdate) {
                ...
                var httpreq = {
                    method: 'POST',
                    url: '../Distributor/PaymentGateway_report.aspx/filldmrreportbydate',
                    headers: {
                        'Content-Type': 'application/json; charset=utf-8',
                        'dataType': 'json'
                    },
            ...
            function instantdmrreceipt(id) {
                ...
                var ID = id;
                $http({
                    url: '../Distributor/PaymentGateway_report.aspx/loaddmrreceipt',
                    method: "POST",
                    data: { txnid: id }
                                        ...
                                        <thead>
                                            ...
                                            <tr ng-show="dmrreport.length!=0" dir-paginate="x in dmrreport|filter:search|itemsPerPage:pageSize">
                                               ...
                                               <td>{{x.orderid}}</td>
                                                ...
                                                <td>{{x.Status}}</td>
                                                <td>{{x.Createdate}}</td>
                                                 <td><a href="#openModal" ng-click="Readinstantdmrreceipt(x.orderid)" class="badge badge-success badge-pill" title="click to view member detail">View</a></td>
                                            </tr>
                                            <tr>
                                    ...
                                    <div class="modal-body">
                                        <div class="row" ng-repeat="y in instantdmrreceipt">
                                                <table class="table table-responsive ps--scrolling-y">
                                                    <tr>
                                                        <td>
                                                                 <img src="../../Uploads/Company/actual/logo.png"" class="navbar-brand brand-logo" style="height:100px; width:270px;border-radius:0%"/>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:Label ID="Label1" runat="server" Font-Bold="True" Font-Size="X-Large" Text="Payment Gateway Recepite "></asp:Label>
                                                        </td>
                                                      <td></td>
                                                    </tr>
                                                    <tr>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <asp:Label ID="Label33" runat="server" Text="PaY ID"></asp:Label>
                                                        </td>
                                                        <td>{{y.payid}}</td>
                                                    </tr>
                                                    <tr>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <asp:Label ID="Label2" runat="server" Text="Add Wallet Amount"></asp:Label>
                                                        </td>
                                                        <td>Rs. {{y.totalamount}}</td>
                                                    </tr>
                                                    <tr>
                                                        <td>
                                                            <asp:Label ID="Label9" runat="server" Text="Fee Rate"></asp:Label>
                                                        </td>
                                                        <td>Rs. {{y.feerate}}</td>
                                                    </tr>
                                                     ...
                                                     <tr>
                                                         <td>
                                                          <asp:Label ID="Label7" runat="server" Font-Bold="True"  Text="Note: This is a system-generated receipt by paydeer and not require any signature."></asp:Label>
                                                       </td>
                                                         <td></td>
                                                    </tr>  
                                                    <tr>
