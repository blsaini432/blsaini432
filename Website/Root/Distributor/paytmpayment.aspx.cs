...
public partial class paytmpayment : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Session["userid"] != null && Session["Amount"] != null)
        {
            try
            {
                string callbackurl = "http://localhost:59492/Root/Distributor/Paytmcallback.aspx";
                //string callbackurl = adminurl + "Root/Distributor/Paytmcallback.aspx";
                ...
                string paytmChecksum = Checksum.generateSignature(JsonConvert.SerializeObject(body), "orgb5tMr4BOjTdZ#");
                head.Add("signature", paytmChecksum);
                requestBody.Add("body", body);
                requestBody.Add("head", head);
                string post_data = JsonConvert.SerializeObject(requestBody);
                //For  Staging
                 string url = "https://securegw-stage.paytm.in/theia/api/v1/initiateTransaction?mid=TKINFO51656919140206&orderId=" + orderid + "";
