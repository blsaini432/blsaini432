<%@ Page Title="" Language="C#" MasterPageFile="~/Root/Distributor/MemberMaster.master" AutoEventWireup="true" CodeFile="FlightTicket_List.aspx.cs" Inherits="FlightTicket_List" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="content-header">
        <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i>Flight Ticket</a></li>
                                        ...
                                        <div class="box-content">
                                            <asp:GridView ID="gv_Transaction" runat="server" CssClass="table table-bordered table-striped dtable"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField ItemStyle-HorizontalAlign="Center" HeaderText="Cancel">
                                                        <ItemTemplate>
