...
using System.Xml;
public partial class Root_Distributor_AepsPayOut : System.Web.UI.Page
{
    #region Properties
    ...
    public static void SendWithVarpan(string Mobile, int Template, string[] ValueArray)
    {
        try
        {
            ...
            string baseurl = "http://api.msg91.com/api/sendhttp.php?authkey=198296AFda5tMRgn5a854e41&route=4&sender=EZXDMT&DLT_TE_ID=1207160975838963274&mobiles=" + Mobile + "& message=" + smsMessage + "";
