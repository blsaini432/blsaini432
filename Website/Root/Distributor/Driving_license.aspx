<%@ Page Title="" Language="C#" MasterPageFile="~/Root/Distributor/MemberMaster.master" AutoEventWireup="true" CodeFile="Driving_license.aspx.cs" Inherits="Root_Distributor_Driving_license" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="content-wrapper">
        <div class="page-header">
            <h3 class="page-title">Driving License
            </h3>
        </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="col-lg-3">
                                    <label class="col-form-label" style="color: green">Amount For Drving License :--</label>
                                ...
                                <div class="form-group row">
                                 ...
                                 <div class="form-group row">
                                    <div class="col-lg-3">
                                         <label class="col-form-label">PAN/MARKSHEET<code>*</code></label>
                                    </div>
                                    <div class="col-lg-8">
