<%@ Page Title="" Language="C#" MasterPageFile="~/Root/Distributor/MemberMaster.master" AutoEventWireup="true" CodeFile="IciciAEPSTransactions.aspx.cs" Inherits="Root_Distributor_IciciAEPSTransactions" %>
      ...
      app.controller("distributorCntrl", function ($scope, $http, $timeout) {
          ...
          //pagination end
               ...
               function instantdmrreceipt(id) {
                   ...
                   var ID = id;
                   $http({
                       url: '../Distributor/IciciAEPSTransactions.aspx/loadreceipt',
                       method: "POST",
                       data: { txnid: id }
               ...
               $scope.fillaepstransaction = function () {
                   ...
                   var httpreq = {
                       method: 'POST',
                       url: '../Distributor/IciciAEPSTransactions.aspx/fillaepstransactions',
                       headers: {
               ...
               $scope.fillaepstransactionbydate = function (fdate, tdate) {
                   ...
                   var httpreq = {
                       method: 'POST',
                       url: '../Distributor/IciciAEPSTransactions.aspx/fillaepstransactionsbydate',
                       headers: {
                           'Content-Type': 'application/json; charset=utf-8',
                           'dataType': 'json'
                       },
                                    ...
                                    <div class="modal-body">
                                        <div class="row" ng-repeat="y in instantdmrreceipt">
                                                <table class="table table-responsive ps--scrolling-y">
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <asp:Label ID="Label33" runat="server" Text="type"></asp:Label>
                                                        </td>
                                                        <td>{{y.BANK_NAME}}</td>
                                                    </tr>
                                                    <tr>
