<%@ Page Title="" Language="C#" MasterPageFile="~/Root/Distributor/MemberMaster.master" AutoEventWireup="true" CodeFile="BBPS_Receipt.aspx.cs" Inherits="Root_Distributor_BBPS_Receipt" %>
                        ...
                        <div class="row d-flex align-items-center">
                            <div class="col-md-12">
                                <div class="customer-bar top-m">
                                    <h6 class="text-center"><span class="font-weight-bold ">Electricity Bill Payment </span></h6>
                            ...
                            <div class="col-md-9">
                                <div class="customer-bar top-m">
                                    ...
                                    <div class="customer-bar">
                                        ...
                                        <h6>BBPS Reference Number : <span class="font-weight-bold">
