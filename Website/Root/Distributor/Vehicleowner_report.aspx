<%@ Page Title="" Language="C#" MasterPageFile="~/Root/Distributor/MemberMaster.master" AutoEventWireup="true" CodeFile="Vehicleowner_report.aspx.cs" Inherits="Root_Distributor_Vehicleowner_report" %>
       ...
       <script>
           ...
           app.controller("retailerCntrl", function ($scope, $http, $timeout) {
               ...
               $scope.fillaepstransaction = function () {
                   ...
                   var httpreq = {
                       method: 'POST',
                       url: '../Distributor/Drivinglicense_report.aspx/fillaepstransactions',
                       headers: {
               ...
               $scope.fillaepstransactionbydate = function (fdate, tdate) {
                   ...
                   var httpreq = {
                       method: 'POST',
                       url: '../Distributor/Drivinglicense_report.aspx/fillaepstransactionsbydate',
                       headers: {
                           'Content-Type': 'application/json; charset=utf-8',
                           'dataType': 'json'
                       },
