...
public partial class Root_Distributor_OFFBBPS_Transactions : System.Web.UI.Page
{
    #region Properties
    ...
    public static List<Customer> fillelectricityreport()
    {
        ...
        dtEWalletTransaction = cls.select_data_dtNew("Set_Ezulix_Ele_report_paytm_OFF", _lstparm);
    ...
    protected void btn_export_Click(object sender, EventArgs e)
    {
        ...
        if (fromdate != "" && todate != "")
        {
            ...
            _lstparm.Add(new ParmList() { name = "@datefrom", value = changedatetommddyy(fromdate) });
            _lstparm.Add(new ParmList() { name = "@dateto", value = changedatetommddyy(todate) });
            dtExport = cls.select_data_dtNew("Set_Ezulix_Ele_report_paytm_OFF", _lstparm);
