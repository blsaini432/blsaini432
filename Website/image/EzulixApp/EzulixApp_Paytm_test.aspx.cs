...
public partial class EzulixApp_Paytm_test : System.Web.UI.Page
{
    ...
    {
        if (Request.Form["operationnam"] != null)
        {
            string OperationName = Request.Form["operationnam"].ToString();
            if (OperationName == "paytmchecksum")
            {
                ...
                if (Request.Form["AMOUNT"] != null && Request.Form["USER_ID"] != null)
                {
                    ...
                    string callbackurl = adminurl + "EzulixApp/EzulixApp_Paytmcallback_test.aspx";
                    ...
                    body.Add("mid", "ShreeS01122097143205");
                    ...
                    string paytmChecksum = Checksum.generateSignature(JsonConvert.SerializeObject(body), "cnu8Fw@UJWHjIHtZ");
                    head.Add("signature", paytmChecksum);
                    requestBody.Add("body", body);
                    requestBody.Add("head", head);
                    string post_data = JsonConvert.SerializeObject(requestBody);
                    //For  Staging
                   // string url = "https://securegw-stage.paytm.in/theia/api/v1/initiateTransaction?mid=mugjrS38321579120164&orderId=" + orderid + "";

                    //For  Production 
                    string url = "https://securegw.paytm.in/theia/api/v1/initiateTransaction?mid=ShreeS01122097143205&orderId=" + orderid + "";
