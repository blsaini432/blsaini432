<%@ Page Title="" Language="C#" MasterPageFile="~/Front.master" AutoEventWireup="true"
    CodeFile="Franchise.aspx.cs" Inherits="Franchise" %>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                 ...
                                 <div class="form-group row">
                                    <div class="col-lg-3">
                                        <label class="col-form-label">Country Name <code>*</code></label>
                                    </div>
                                    <div class="col-lg-8">
                                ...
                                <div class="form-group row">
                                 ...
                                 <div class="form-group row">
                                    <div class="col-lg-3">
                                        <label class="col-form-label">City Name <code>*</code></label>
                                    </div>
                                    <div class="col-lg-8">
