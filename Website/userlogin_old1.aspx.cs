    ...
    protected void btn_sendforgetpin_Click(object sender, EventArgs e)
    {
        if (txt_forgetpin.Text != "")
        {
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                string baseurl = "http://api.msg91.com/api/sendhttp.php?authkey=354413Ar5r42mhRSS602bc15cP1&route=4&sender=AQUAPE&DLT_TE_ID=1207162166369094634&mobiles=919166396947&message=" + mobile + "&message=" + sms + "";
    ...
    protected void btn_forgot_Click(object sender, EventArgs e)
    {
        ...
        if (txt_email.Text != "")
        {
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                HttpContext.Current.Response.Cache.SetCacheability(HttpCacheability.NoCache);
                WebClient client = new WebClient();
                string baseurl = "http://api.msg91.com/api/sendhttp.php?authkey=354413Ar5r42mhRSS602bc15cP1&route=4&sender=AQUAPE&DLT_TE_ID=1207162166357727467&mobiles=919166396947&message=" + mobile + "&message=" + sms + "";
                Stream data = client.OpenRead(baseurl);
                StreamReader reader = new StreamReader(data);
                string s = reader.ReadToEnd();
                data.Close();
