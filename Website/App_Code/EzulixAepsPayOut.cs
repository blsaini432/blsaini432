...
/// </summary>
public class EzulixAepsPayOut
{
    private static string M_Uri = "https://ezulix.in/";
    //  private static string M_Uri = "http://localhost:49530/";
    ...
    public string Check_Staus(string AgentOrderId, string Amount)
    {
        ...
        string Text = MemberId + "|" + Amount + "|" + AgentOrderId;
        string Result = ChkSum.HmacSha512Digest_CheckSum(Text, ApiKey);
        return HTTP_POST(M_Uri + "payout/checkstaus", Request_Json, Result);
    }
    #endregion
    #endregion
}