...
/// </summary>
public class cls_myMember_mim_new
{
    ...
    //public int Wallet_MakeTransaction_uid(string memberid, decimal amount, string Factor, string narr)
    //{
    //    clsMLM_EWalletTransaction objEWalletTransaction = new clsMLM_EWalletTransaction();
    //    objEWalletTransaction.EWalletTransaction(memberid, amount, Factor, narr);
    //    return 1;
    //}
    ...
    public int Cyrus_ChkEwalletBalance_BeforeTransaction_uid(Decimal Amount, int msrno)
    {
        int mybal = 0;
        dtEWalletBalance = objEWalletBalance.ManageEWalletBalance("RGetBalanceByMsrNo", msrno);
