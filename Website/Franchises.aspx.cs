...
public partial class Franchises : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            if (Request.QueryString["id"] != null)
            {
                ...
                {
                   // lblAddEdit.Text = "Franchise Apply";
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            _list.Add(new ParmList() { name = "@statename", value = ddlStateName.SelectedItem.ToString() });
             _list.Add(new ParmList() { name = "@cityname", value = ddlCityName.SelectedItem.ToString() });
