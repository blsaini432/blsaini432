<%@ Page Title="" Language="C#" MasterPageFile="~/Front.master" AutoEventWireup="true" EnableEventValidation="false" CodeFile="Signup.aspx.cs" Inherits="MemberSignup" %>
                                                ...
                                                <p>
                                                    <table class="table table-bordered table-hover ">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="td3">
                                                                <asp:DropDownList ID="ddlCountryName" runat="server" AutoPostBack="True" 
                                                                    CssClass="form-control"  Height="42px"
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <asp:DropDownList ID="ddlCityName" runat="server" CssClass="form-control"  Height="42px">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                <asp:Button ID="btnNext" runat="server" class="btn btn-primary mybtnr" 
                                                                    onclick="btnNext_Click" Text="Next" ValidationGroup="v0" />
                                                                <br />
                                                                <br />
                                            ...
                                            <div>
                                                ...
                                                <p>
                                                    <table class="table table-bordered table-hover ">
                                                        <tr>
                                                            ...
                                                            <td>
                                                               <asp:DropDownList ID="DropDownList1" runat="server" AutoPostBack="true" OnSelectedIndexChanged="DropDownList1_SelectedIndexChanged">
                                                                 ...
                                                                 <asp:ListItem Value="21">Retailer</asp:ListItem>
                                                                 <asp:ListItem Value="999">Distributor</asp:ListItem>
                                                                 <asp:ListItem Value="4999">Master Distributor</asp:ListItem>
                                                                 <%--   <asp:ListItem Value="7499">Super Distributor</asp:ListItem>--%>
                                                               </asp:DropDownList>
                                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="DropDownList1" ValidationGroup="v11" ErrorMessage="Please Select" InitialValue="0"></asp:RequiredFieldValidator>
                                                                <asp:Label ID="lblpayamount" runat="server" Text="" Font-Bold="true" ForeColor="Green"></asp:Label>                                                            
                                                        ...
                                                        <tr>
                                                            <td>  Refeal Code </td>
                                                            <td>  <asp:TextBox ID="txt_refeal" runat="server" CssClass="form-control" 
                                                                    MaxLength="50" placeholder="Refeal Code"></asp:TextBox>    </td>
                                                        </tr>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <asp:Button ID="Button1" runat="server" class="btn btn-primary mybtnr" 
                                                                    Text="submit" ValidationGroup="v11" OnClick="btnSubmit1_Click" />
                                                            </td>
                                                            <td>
                                                                <br />
                                                                <br />
