<%@ Page Language="C#" AutoEventWireup="true" CodeFile="userlogin_old.aspx.cs" Inherits="userlogin" %>
                        ...
                        <div class="col-lg-6 d-flex align-items-center justify-content-center">
                            <div class="auth-form-transparent text-left p-3">
                                ...
                                <div id="divlogin" runat="server">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <asp:TextBox ID="txt_userpassword" runat="server" MaxLength="50" class="form-control form-control-lg border-left-0" placeholder="Password" autocomplete="off" TextMode="Password"></asp:TextBox>
                                        </div>
                                    </div>
                                    ...
                                    <div class="my-3">
                                        <a href="http://onebreeze.in/signup.aspx" class="btn btn-block btn-info btn-lg font-weight-medium auth-form-btn">SignUp</a>
                                    </div>
                                </div>
                                ...
                                <div id="div_forgotpin" runat="server" visible="false">
                                    ...
                                    <div class="my-3">
                                        <asp:Button ID="btn_sendforgetpin" runat="server" Text="Send" CssClass="btn btn-block btn-primary btn-lg font-weight-medium auth-form-btn" OnClick="btn_sendforgetpin_Click" />
