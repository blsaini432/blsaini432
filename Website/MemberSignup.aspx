<%@ Page Title="" Language="C#" MasterPageFile="~/Front.master" AutoEventWireup="true" EnableEventValidation="false" CodeFile="MemberSignup.aspx.cs" Inherits="MemberSignup" %>
                                ...
                                <asp:MultiView ID="mv" runat="server">
                                                ...
                                                <p>
                                                    <table class="table table-bordered table-hover ">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="td3">
                                                                <asp:DropDownList ID="ddlCountryName" runat="server" AutoPostBack="True" 
                                                                    CssClass="form-control"  Height="60px"
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <asp:DropDownList ID="ddlCityName" runat="server" CssClass="form-control"  Height="60px">
                                                        ...
                                                        <tr style="display:none;">
                                                            ...
                                                            <td>
                                                                ...
                                                                <span style=" font-size:12px; color:#00BBF2; float:right;">&quot;digitalminicash.com will 
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                &amp; Conditions</a> of shubhmoneypay.com
                                            ...
                                            ClientValidationFunction="ValidateCheckBox1" ValidationGroup="v0"><img src="images/warning.png" style=" width:16px;"/></asp:CustomValidator>--%>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                <asp:Button ID="btnNext" runat="server" formnovalidate class="btn btn-primary mybtnr" 
                                                                    onclick="btnSubmit1_Click" Text="Next" ValidationGroup="v0" />
                                                                <br />
                                                                <br />
                                    ...
                                    <asp:View ID="View1" runat="server">
                                                        ...
                                                        <tr>
                                                                    ...
                                                                    <tr>
                                                                        <td align="center">
                                                                            ...
                                                                            <asp:Label ID="Label10" runat="server" Font-Bold="True" Font-Size="Medium" 
                                                                                ...
                                                                                Text="Enter OTP" Visible="False"></asp:Label>
                                                                            <br />
                                                                        </td>
                                                                        <td>
                                                            ...
                                                            <td>
                                                               <asp:TextBox ID="txt_otp" runat="server"></asp:TextBox>
                                                                ...
                                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txt_otp" ErrorMessage="*"></asp:RequiredFieldValidator>
                                      ...
                                      <asp:View ID="View2" runat="server">
                                        <asp:Panel ID="Panel2" runat="server" DefaultButton="s">
                                            <div>
                                                <h2 class="StepTitle">
                                                    Procced for payment </h2>
                                                <p>
                                                    ...
                                                    <table class="table table-bordered table-hover ">
                                                        <tr>
                                                                    ...
                                                                    <tr>
                                                                        <td align="center">
                                                                            ...
                                                                            <asp:Label ID="Label2" runat="server" Font-Bold="True" Font-Size="Medium" 
                                                                                Font-Underline="True" ForeColor="Black" 
                                                                                Text="What do you want to be" Visible="true"></asp:Label>
                                                                            <br />
                                                                        </td>
                                                                        <td>
                                                                        </td>
                                                            ...
                                                            <td>
                                                               <asp:DropDownList ID="DropDownList1" runat="server" AutoPostBack="true" OnSelectedIndexChanged="DropDownList1_SelectedIndexChanged">
                                                                 ...
                                                                 <asp:ListItem Value="999">Retailer</asp:ListItem>
                                                                 <asp:ListItem Value="2999">Distributor</asp:ListItem>
                                                                 <asp:ListItem Value="4999">Master Distributor</asp:ListItem>
                                                               </asp:DropDownList>
                                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="DropDownList1" ErrorMessage="Please Select" InitialValue="0"></asp:RequiredFieldValidator>
                                                                <asp:Label ID="lblpayamount" runat="server" Text="" Font-Bold="true" ForeColor="Green"></asp:Label>                                                            </td>
                                                        </tr>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <asp:Button ID="Button1" runat="server" class="btn btn-primary mybtnr" 
                                                                    Text="Procced for payment and submit" ValidationGroup="v1" OnClick="btnSubmit1_Click" />
                                                            </td>
                                                             <td>
                                                                <asp:Button ID="Button2" runat="server" class="btn btn-info mybtnr" 
                                                                    Text="Procced for payment Razorpay and submit" ValidationGroup="v1" OnClick="btnSubmit1_razorpay" />
                                                            </td>
                                                            <td>
                                                                <br />
                                                                <br />
