...
public partial class Reversalapi : System.Web.UI.Page
{
    #region Access_Class
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            {
                string utiitsl_id = lines[1].ToString();
                Session["utiitsl_id"] = utiitsl_id; ;
                string reversal_txn_no = lines[3].ToString();
                Session["reversal_txn_no"] = reversal_txn_no;
                string utiitsl_txn = lines[5].ToString();
                Session["utiitsl_txn"] = utiitsl_txn;
                string utiitsl_txn_datetime = lines[7].ToString();
                Session["utiitsl_txn_datetime"] = utiitsl_txn_datetime;
                string utiitsl_reference = lines[9].ToString();
    ...
    public class xml
    {
        ...
        public string reversal_reference { get; set; }
       public  string reversal_response { get; set; }
