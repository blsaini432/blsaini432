<%@ Page Title="" Language="C#" MasterPageFile="~/Front.master" AutoEventWireup="true" EnableEventValidation="false" CodeFile="MemberSignup_oo.aspx.cs" Inherits="MemberSignup" %>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                               <asp:DropDownList ID="DropDownList1" runat="server" AutoPostBack="true" OnSelectedIndexChanged="DropDownList1_SelectedIndexChanged">
                                                                 ...
                                                                 <asp:ListItem Value="199">Retailer</asp:ListItem>
                                                                 <asp:ListItem Value="499">Distributor</asp:ListItem>                                                            
                                                                  <asp:ListItem Value="999">Super Distributor</asp:ListItem>
                                                                    <asp:ListItem Value="4999">State Head</asp:ListItem>
                                                               </asp:DropDownList>
